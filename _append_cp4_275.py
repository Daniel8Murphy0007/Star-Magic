"""
CP4 Appender for PAPER_691 â€” NBodySimulation3D (CP4 #275)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NBodySimulation3D"
    if marker in content:
        print(f"SKIP: NBodySimulation3D already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NBodySimulation3D (PAPER_691, CP4 #275)")
