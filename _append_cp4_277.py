"""
CP4 Appender for PAPER_693 â€” SombreroGalaxyM104NGC4594 (CP4 #277)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class SombreroGalaxyM104NGC4594"
    if marker in content:
        print(f"SKIP: SombreroGalaxyM104NGC4594 already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended SombreroGalaxyM104NGC4594 (PAPER_693, CP4 #277)")
