"""
CP4 Appender for PAPER_713 -- UQFFKnowledgeBaseKB19 (CP4 #297)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class UQFFKnowledgeBaseKB19"
    if marker in content:
        print(f"SKIP: UQFFKnowledgeBaseKB19 already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended UQFFKnowledgeBaseKB19 (PAPER_713, CP4 #297)")
