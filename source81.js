// source81.js - NGC 346 UQFF Module
// JavaScript implementation maintaining all dynamics from source81.cpp
...
class NGC346UQFFModule {
    ...
    getEquationText() {
        return `g_NGC346(r, t) = (G * M(t) / r(t)^2) * (1 + H(t, z)) * (1 - B(t) / B_crit) * (1 + F_env(t)) + Σ U_gi + U_i + U_m + (Lambda * c^2 / 3) + (hbar / sqrt(Δx * Δp)) * ∫ ψ_total * H * ψ_total dV) * (2π / t_Hubble) + ρ_gas * V * g + (M_visible + M_DM) * (δρ/ρ + 3 G M / r^3)
