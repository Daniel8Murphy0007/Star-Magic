...
M_R = M_P_GeV * (F_TRZ ** D_phys)
print(f"   M_R  =  M_P * F_TRZ^D_phys")
print(f"        =  M_P * 10^-4")
print(f"        =  {M_R:.3e}  GeV")
print()
print(" CORRECTION (Daniel T. Murphy, May 2026): seesaw scale anchored")
print(" to D_phys (= 4 spacetime dims) rather than (N_ch+1).  This places")
print(" M_R at the natural GUT scale ~10^15 GeV and yields sub-eV neutrino")
print(" masses without arbitrary Yukawa suppression.")
print()
...
print()
print(" Additional half-spinor pairing prefactor Phi_res applied uniformly,")
print(" then generation ladder Phi_res^k (k=0,1,2 for gen 3,2,1).")
print()
m_nu_eV *= Phi_res   # locked correction: half-spinor pairing prefactor
print(f"   m_nu_top (corrected) = Phi_res * v^2/M_R * 1e9 = {m_nu_eV:.4f}  eV")
print()
...
print()
print("="*72)
print(f" S316 COMPLETE.  M_R = M_P*F_TRZ^D_phys = {M_R:.2e} GeV;")
print(f" Sum m_nu = {sigma_m_nu:.4f} eV (< 0.12 eV Planck cap); normal hierarchy; Majorana.")
print("="*72)
