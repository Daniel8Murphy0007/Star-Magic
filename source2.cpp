...
private slots:
    ...
    void showApiKeyConfig() {
        ...
        msgBox.setText(QString(
            ...
            "<p style='color: #000000;'>Sign up for xAI access at: <a href='https://x.ai'>https://x.ai</a></p>"
            "<p style='color: #000000;'>Navigate to API settings and generate your API key</p>"
            
            "<h4>Step 2: Set Environment Variable</h4>"
            "<p style='color: #000000;'><b>Windows (PowerShell):</b></p>"
            "<p style='color: #000000;'><code>$env:XAI_API_KEY = \"your-api-key-here\"</code></p>"
            "<p style='color: #000000;'><i>For permanent:</i> System Properties → Environment Variables → New</p>"
            
            "<p style='color: #000000;'><b>macOS/Linux (Terminal):</b></p>"
            "<p style='color: #000000;'><code>export XAI_API_KEY=\"your-api-key-here\"</code></p>"
            "<p style='color: #000000;'><i>For permanent:</i> Add to ~/.bashrc or ~/.zshrc</p>"
            
            "<h4>Step 3: Restart Source2.exe</h4>"
            "<p style='color: #000000;'>Close and reopen Source2.exe to load the new environment variable</p>"
            
            "<h4>Step 4: Verify API Key</h4>"
            "<p style='color: #000000;'>Check current API key status:</p>"
            "<p style='background:#F0F0F0; color:#000000; padding:8px; border-radius:5px;'>"
            "<b>Current Status:</b> %1"
            "</p>"
            
            "<hr>"
            "<p style='color: #000000;'><b>API Key from APIFetch.py:</b></p>"
            "<p style='color: #000000;'>This widget uses the same XAI_API_KEY as APIFetch.py Grok fallback</p>"
            "<p style='color: #000000;'><b>Cost:</b> Check xAI pricing at <a href='https://x.ai/api'>https://x.ai/api</a></p>"
            
            "<p style='color: #000000;'><b>Models Available (Official xAI Names):</b></p>"
            ...
            "</ul>"
            "<p style='background:#FFF9C4; color:#000000; padding:8px; border-radius:5px;'>"
    ...
    void displayWelcomeMessage() {
        chatDisplay->setHtml(
            "<div style='background-color: #E1F5FE; color: #000000; padding: 15px; margin: 10px; border-radius: 10px; border: 2px solid #03A9F4;'>"
            "<h3 style='color: #01579B; margin-top: 0;'>🧠 Welcome to SuperGrok4</h3>"
            "<p style='color: #000000;'><b>Expert Physics & Research Assistant powered by Grok xAI</b></p>"
            ...
            "<tr style='background: #B3E5FC; color: #000000;'>"
            "<th style='border: 1px solid #01579B; padding: 8px; color: #000000;'>Feature</th>"
            "<th style='border: 1px solid #01579B; padding: 8px; color: #000000;'>SuperGrok4 (Tab 7)</th>"
            "<th style='border: 1px solid #01579B; padding: 8px; color: #000000;'>CoAnQi_bot (Tab 6)</th>"
            "</tr>"
            "<tr><td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'><b>Platform</b></td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Grok xAI (Cloud)</td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Ollama (Local)</td></tr>"
            "<tr><td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'><b>Model Size</b></td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>~300B params</td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>3-7B params</td></tr>"
            "<tr><td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'><b>Reasoning</b></td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Advanced (Grok-2)</td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Basic-Moderate</td></tr>"
            "<tr><td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'><b>Vision</b></td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>✅ Yes (grok-vision)</td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>❌ No</td></tr>"
            "<tr><td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'><b>Cost</b></td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Paid API</td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Free (local)</td></tr>"
            "<tr><td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'><b>Privacy</b></td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Cloud-based</td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>100% Local</td></tr>"
            "<tr><td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'><b>Best For</b></td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Research, complex derivations</td>"
            "<td style='border: 1px solid #01579B; padding: 5px; background: #FFFFFF; color: #000000;'>Quick code help</td></tr>"
            "</table>"
            
            "<hr>"
            "<h4 style='color: #0277BD;'>🤔 About Model Names:</h4>"
            "<p style='background:#FFF9C4; color:#000000; padding:10px; border-left: 4px solid #FBC02D;'>"
            ...
            "<p style='color: #000000;'>Click '🔑 Configure API Key' button for setup instructions</p>"
            "</div>"
        );
    }
