"""
CP4 Appender for PAPER_712 -- PillarsOfCreationM16v2UQFF (CP4 #296)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class PillarsOfCreationM16v2UQFF"
    if marker in content:
        print(f"SKIP: PillarsOfCreationM16v2UQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended PillarsOfCreationM16v2UQFF (PAPER_712, CP4 #296)")
