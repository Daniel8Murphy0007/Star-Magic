"""
_append_cp4_246.py  —  Session 172
Appends CP4 entry #246: UQFFHawkingDerivationCalculator
Paper: PAPER_662
...
DIVIDER = (
    "\n\n# " + "=" * 74 + "\n"
    "# CP4 #246 \x97 UQFFHawkingDerivationCalculator\n"
...
def main():
    ...
    with open(CP4, "ab") as f:
        f.write(encoded)
    print(f"CP4 #246 appended: UQFFHawkingDerivationCalculator")
    # Verify
    with open(CP4, "rb") as f:
        tail = f.read()[-800:]
    if b"UQFFHawkingDerivationCalculator" in tail:
