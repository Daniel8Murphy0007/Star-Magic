# PAPER_1250 — Axis of Evil CMB via DPM-Pair Axis Orientation at t_decoupling

**Author:** Daniel T. Murphy
**Framework:** UQFF (Unified Quantum Field Framework) — Star-Magic v5.27+
**Tier:** B — Cosmology Observational Anomaly
**Date:** June 2026
**Status:** Authored and wired into uqff_pure_calculator.py
**Calculator surface:** `calculate_paradox({"paradox": "axis_of_evil_cmb"})`
**Closure helper:** `_l96_uqff_axiom_axis_of_evil_cmb_closure()`

## Abstract

This paper presents the UQFF derivation of the Axis of Evil CMB problem using only the locked canonical primitives of the UQFF framework. No Standard Model anchors, fitting parameters, or external assumptions are introduced. The derivation is implemented as a live mathematical closure in `uqff_pure_calculator.py` and dispatches through the `calculate_paradox` public surface.
...
DPM-Pair Axis Orientation at t_decoupling

The closure helper `_l96_uqff_axiom_axis_of_evil_cmb_closure()` evaluates this derivation. Output dict carries:
...
result = u.calculate_paradox({"paradox": "axis_of_evil_cmb"})['value']
```
...
- Closure location: `uqff_pure_calculator.py` → `_l96_uqff_axiom_axis_of_evil_cmb_closure`
- Dispatch: `PARADOX_TO_CLOSURE["axis_of_evil_cmb"]`
