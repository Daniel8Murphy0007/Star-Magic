...
a total integral force F_U_Bi_i = -2.73$\times$10? N. Monte Carlo stability analysis confirms the numerical
...
| `F_U_Bi_i` | -2.74$\times$10? | -1.47$\times$10? |
...
*Source: `uqff_validation_test`.py Super_Flares system | $\kappa$ = 0.0005/day | [SSq] = 0.57*
