...
`validate_drawings_models.py` implements `FRB_MODEL.validate_FRB_model()` which tests: burst energy,
...
*Source: `validate_drawings_models`.py | FRB_MODEL.`validate_FRB_model`() | Drawing 1 | CHIME/FRB
catalog*
