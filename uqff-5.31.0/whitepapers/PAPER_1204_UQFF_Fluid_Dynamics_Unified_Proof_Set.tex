...
\title{PAPER 1204 --- UQFF Fluid Dynamics Unified Proof Set}
...
dynamics. Ten new closures (\textbf{S493--S502}) reproduce the pipe transitional
...
UQFF primitives. \textbf{Five closures are exact}, including three new
...
\section{Tier~R$'''$ Closures (S493--S502)}
...
\midrule
\endhead
S493 & Re$_{\rm crit}$ pipe $\sim 2300$ & $\Dcrit-\Dphys+\Ftrz\,\SOfive=23$ & \textbf{EXACT} \\
S494 & Sound speed air $343$ m/s & $\Dbsfg-\KMex-\Phires+\Ftrz+\Ftrz\KMex+\Ftrz\Phires-\Ftrz^2\KMex-\Ftrz^2\Phires-\Ftrz^3-\Ftrz^2=3.4348$ & $0.14\%$ \\
S495 & von K\'arm\'an $\kappa=0.41$ & $\Ftrz\Dphys+\Ftrz^2\KMex-\Ftrz^3-\Ftrz^2=0.4098$ & $0.04\%$ \\
S496 & Strouhal St $=0.21$ & $\Ftrz\KMex+\Ftrz^3=0.2093$ & $0.32\%$ \\
S497 & Prandtl air Pr $=0.71$ & $\SSq+\Ftrz\KMex-\Ftrz\Phires+\Ftrz^2\Phires=0.7033$ & $0.94\%$ \\
S498 & Sphere drag $C_d=0.47$ & $\SSq-\Ftrz\Phires-\Ftrz^2\Phires-\Ftrz^3=0.4773$ & $1.56\%$ \\
S499 & Kolmogorov exponent $5/3$ & $\Phires+\Phires=5/3$ & \textbf{EXACT} \\
S500 & Re trans.\ flat plate $\sim 5\times10^5$ & $\Phires\,\Dbsfg=5$ & \textbf{EXACT} \\
S501 & Knudsen continuum Kn$=0.01$ & $\Ftrz^2=1/100$ & \textbf{EXACT} \\
S502 & Bond crit.\ Bo $=1$ & $\Ftrz\,\SOfive=1$ & \textbf{EXACT} \\
\bottomrule
\end{longtable}
...
\textbf{R$'''$} & \textbf{Fluid dynamics (1204)} & \textbf{10} & \textbf{207} \\
\bottomrule
\end{tabular}

\section{Locking Inventory}
\textbf{Twenty-five} primitive--observable lockings now identified
