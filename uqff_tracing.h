...
private:
    ...
    string spanTypeToString(SpanType type) const {
        switch (type) {
            case SpanType::SYSTEM_CALCULATION: return "SYSTEM_CALC";
            case SpanType::PHYSICS_TERM_EVAL: return "PHYSICS_TERM";
            case SpanType::MODULE_INIT: return "MODULE_INIT";
            case SpanType::WOLFRAM_CALL: return "WOLFRAM_CALL";
            case SpanType::OPTIMIZATION: return "OPTIMIZATION";
            case SpanType::VALIDATION: return "VALIDATION";
            case SpanType::CROSS_MODULE_COMM: return "CROSS_MODULE";
            case SpanType::SIMULATION_STEP: return "SIMULATION";
            case SpanType::STATISTICAL_ANALYSIS: return "STATISTICS";
...
public:
    ...
    void logEvent(const string& message, TraceLevel level = TraceLevel::TRACE_INFO) {
        ...
        if (traceFile.is_open()) {
            ...
            string levelStr;
            switch (level) {
                case TraceLevel::TRACE_DEBUG: levelStr = "DEBUG"; break;
                case TraceLevel::TRACE_INFO: levelStr = "INFO"; break;
                case TraceLevel::TRACE_WARN: levelStr = "WARN"; break;
                case TraceLevel::TRACE_ERROR: levelStr = "ERROR"; break;
                case TraceLevel::TRACE_FATAL: levelStr = "FATAL"; break;
            }
