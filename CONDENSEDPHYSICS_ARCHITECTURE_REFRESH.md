...
**Verification:** 35/35 harness PASS + all 6 Range-5 modes registered and asserted, equations/falsifiables/citations from whitepapers/1064-1079, integrate hook, this subsection, thin dispatch. dpm untouched, cross-venv, 6-pair, missing/new only all hold. Synthesis complete per directive.
