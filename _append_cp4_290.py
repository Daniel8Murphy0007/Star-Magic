"""
CP4 Appender for PAPER_706 -- NGC3603StarClusterPrimaryUQFF (CP4 #290)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NGC3603StarClusterPrimaryUQFF"
    if marker in content:
        print(f"SKIP: NGC3603StarClusterPrimaryUQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NGC3603StarClusterPrimaryUQFF (PAPER_706, CP4 #290)")
