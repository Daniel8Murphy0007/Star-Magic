"""
CP4 Appender for PAPER_710 -- NGC2014NGC2020StarformingUQFF (CP4 #294)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NGC2014NGC2020StarformingUQFF"
    if marker in content:
        print(f"SKIP: NGC2014NGC2020StarformingUQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NGC2014NGC2020StarformingUQFF (PAPER_710, CP4 #294)")
