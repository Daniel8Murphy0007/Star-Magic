...
**G_aether(E) = κ ×  (E / E_ref)^$\kappa$_aether**
...
| Energy Range | GR Index γ | UQFF Index γ | Difference ?? |
|-------------|-----------|-------------|---------------|
...
**s_TRZ,aniso = s_TRZ,iso  (1 + A_TRZ cos²θ)**

where θ is the angle to the nearest large-scale TRZ filament (aligned with Centaurus A
supercluster).
...
**G_aether(E, Z) = κ ×  Z^(1/3)  (E/A / E_ref)^$\kappa$_aether**
...
|------------|---------------|-----------------|---------------------|------------|
| GZK cutoff energy | 5 $\times$ 10�8  eV | 4.8 $\times$ 10�8  eV | ~5 $\times$ 10�8  eV | 2.60 |
...
| GRAND (200,000 km) | Detect aether pile-up at 2 $\times$ 10-8  eV | 20302035 |
