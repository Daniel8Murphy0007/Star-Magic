"""
_append_cp4_257.py  —  Session 172
Appends CP4 entry #257: UQFFAdvancementsAndTHzHolesCalculator
Paper: PAPER_673
...
DIVIDER = (
    "\n\n# " + "=" * 74 + "\n"
    "# CP4 #257 \x97 UQFFAdvancementsAndTHzHolesCalculator\n"
...
def main():
    ...
    with open(CP4, "ab") as f:
        f.write(encoded)
    print(f"CP4 #257 appended: UQFFAdvancementsAndTHzHolesCalculator")
    # Verify
    with open(CP4, "rb") as f:
        tail = f.read()[-800:]
    if b"UQFFAdvancementsAndTHzHolesCalculator" in tail:
