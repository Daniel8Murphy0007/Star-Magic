# Paper #21: Gravitational Lensing Corrections from UQFF Vacuum Density
...
**ρ_vac,UQFF = ρ_aether + ρ_TRZ + ρ_string**
...
- Same constants explain GW damping (Papers #1–#18), PTA amplification (Paper #19), and UHECR anomalies (Paper #20)
