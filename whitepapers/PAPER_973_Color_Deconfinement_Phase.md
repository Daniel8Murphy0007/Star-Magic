...
We map the QCD phase diagram in the $(T, \mu_B)$ plane using the UQFF framework. The critical line $T_c(\mu_B) = T_{c0}(1 - (\mu_B/\mu_\text{crit})^2)$ separates the hadron phase from the quark-gluon plasma, with $S_{26}^{(k)}$ modulation of vacuum density across both phases.
...
|---------------|-------------|
| PAPER_970 | $\rho_\text{QGP}$ density at $(T,\mu_B)$ |
...
| $\mu_\text{crit}$ | — | 1200 MeV | Critical baryon chemical potential |
| $[SSq]$ | — | 0.57 | String coupling |
| $\Lambda_\text{QCD}$ | — | 217 MeV | QCD scale |
...
### §A.2 Core Equation
$$\boxed{T_c(\mu_B) = T_{c0} \cdot \left(1 - \left(\frac{\mu_B}{\mu_\text{crit}}\right)^2\right)}$$
