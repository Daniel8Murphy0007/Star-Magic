...
**Date:** 2026-04-11
**Session:** 211
**Source:** SCm phonon gap implementation (scm_{phonon\_resonance}.py)
...
- scm_{phonon\_resonance}.py: 6-class standalone module
- et_{phonon\_resonance}.py: ResonanceAccelerationTerm (Section 4b)
