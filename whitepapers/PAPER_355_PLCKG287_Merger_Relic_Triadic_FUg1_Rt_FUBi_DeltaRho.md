...
-2.29$\times$10-4 N represents the MUGE Compressed Mode prediction for relic propagation, and (3) FU_Bi_i
...
| `FU_Bi_i` | Full UQFF | -8.32$\times$107 N |
...
contrast between R(t)  -2.29$\times$10-4 N and FU_Bi_i  -8.32$\times$107 N spans 58 orders of magnitude,
