# PAPER_1446 — UQFF: Galaxy Morphology N Types (Bucket G)
...
**Status:** CLOSED — formal catalog tuple in Bucket G
**Calculator surface:** `calculate_astrophysics({...})`
...
```
D_phys = 4 EXACT (Hubble sequence)
```
...
- Catalog tuple resides in `_astrophysics_report()` or equivalent surface in `uqff_pure_calculator.py`.
