...
**M = 1 - \verb|max_{over\_params}| ? [h1(f) h2*(f) / S\_n(f)] df / v[?|h1|/S\_n ?|h2|/S\_n]**
...
From \verb|validate_{gw170817\_full}.py|:
...
From \verb|validate_{gw170817\_chirp}.py|:
...
\begin{enumerate}
  \item \verb|validate_{gw170817\_full}.py|  Full 100s inspiral simulation
  \item \verb|validate_{gw170817\_chirp}.py|  Short 0.2s chirp simulation
...
\textbf{Validator:} \verb|validate_gw170817.py| (phase lag confirmation: 2310.8 rad ?).Groups[1].Value : UQFF Waveform Phase Evolution and Template Mismatch
