---
paper_id: PAPER_284
title: "M16 Eagle Nebula UQFF — Dual Mass Co-Action Product (\Phi_dm)"
session: 80
date: 2026-03-01
...
| Quantity | Value |
|----------|-------|
| `M_{sf\_frac}` | SFR_rate $\times$ t = 2.639$\times$10-11 $\times$ 1.578$\times$1014 = **4164.8** |
...
| **`gap_{mult\_add}`** | -(4164.8 $\times$ 0.2433) = **-1013.3** (24.3% less) |
