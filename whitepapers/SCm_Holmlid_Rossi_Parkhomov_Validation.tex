...
\title{SCm Validation: Holmlid Cluster Dynamics, Rossi E-Cat Insight, and Parkhomov Replication}
...
\section{Holmlid Cluster Dynamics (Expanded)}
...
\section{Rossi E-Cat LENR Insight}
...
\section{Parkhomov Excess Heat Derivation}

Parkhomov replicated Ni–H excess heat ($\sim$100–300 W from $\sim$10–20 W input). SCm derivation:
\[
...
\section{Revised Reactor Validation Section}
...
\section{SymPy LaTeX Export Tutorial (for VS Code)}

Add this function to \texttt{scm_vacuum_manifold.py}:
