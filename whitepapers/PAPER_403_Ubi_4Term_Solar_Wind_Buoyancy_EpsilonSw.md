---
paper_id: PAPER_403
title: "Ubi: 4-Term Solar Wind Buoyancy Decomposition with \epsilon_sw"
session: 108
date: 2025-01-01
...
# PAPER_403 — Ubi: 4-Term Solar Wind Buoyancy Decomposition with $\varepsilon$_sw
**Author:** Daniel T. Murphy
**Date:** 2025
...
This paper presents a UQFF analysis of Ubi: 4-Term Solar Wind Buoyancy Decomposition with $\varepsilon$_sw,
...
| $\rho_{sw}$ | $8\times10^{-21}$ kg/m3 | Solar wind plasma density at 1 AU |
...
### 4.1 Solar Wind Buoyancy Modulation (1 + $\varepsilon$_sw $\cdot$ $\rho$_sw)
...
can increase by 6-8 orders: $\rho_{sw,\text{CME}} \sim 10^{-13}$ kg/m3.
...
the dominant buoyancy contribution, while $U_{g4}$ (scale-invariant at $4.219\times10^{-10}$ m/s2)
...
| Condition | $\rho_{sw}$ (kg/m3) | $(1 + \varepsilon_{sw} \cdot \rho_{sw})$ |
|-----------|---------------------|------------------------------------------|
...
| PAPER_403 | 4-term $U_{bi}$ with $\varepsilon_{sw}$ solar wind | **NEW — FIRST $\varepsilon$_sw solar wind buoyancy** |
