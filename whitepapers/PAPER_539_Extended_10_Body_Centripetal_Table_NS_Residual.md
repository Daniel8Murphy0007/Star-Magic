...
| Moon$\to$Earth | $7.34\times10^{22}$ | $3.84\times10^8$ | $1020$ | $2.01\times10^{20}$ | 20.3 |
| Earth$\to$Sun | $5.97\times10^{24}$ | $1.50\times10^{11}$ | $29\,783$ | $3.54\times10^{22}$ | 22.5 |
| Mars$\to$Sun | $6.42\times10^{23}$ | $2.28\times10^{11}$ | $24\,077$ | $1.63\times10^{21}$ | 21.2 |
| Jupiter$\to$Sun | $1.90\times10^{27}$ | $7.78\times10^{11}$ | $13\,069$ | $4.19\times10^{23}$ | 23.6 |
| ISS$\to$Earth | $4.19\times10^5$ | $6.78\times10^6$ | $7\,660$ | $3.62\times10^6$ | 6.6 |
| Geosync Sat$\to$Earth | $5.0\times10^3$ | $4.22\times10^7$ | $3\,075$ | $1.13\times10^3$ | 3.1 |
| NS matter ring | $10^{20}$ | $10^4$ | $c/3$ | $9.0\times10^{29}$ | 29.5 |
| Titan$\to$Saturn | $1.34\times10^{23}$ | $1.22\times10^9$ | $5\,570$ | $3.41\times10^{20}$ | 20.5 |
| Pluto$\to$Sun | $1.31\times10^{22}$ | $5.91\times10^{12}$ | $4\,743$ | $4.98\times10^{17}$ | 17.7 |
...
# result['force_range_decades']   — \log_{10} range of F_c across 10 bodies
...
$$p_{\mathrm{DVP}} = 113, \quad n_{\mathrm{channel}} = 20/26$$
