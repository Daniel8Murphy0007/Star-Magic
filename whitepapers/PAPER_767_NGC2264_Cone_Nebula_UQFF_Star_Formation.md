...
$$
\begin{aligned}
  & g_NGC2264(r, t) = (G \times M) / r2 \times (1 + H(z)\times t) \times (1 + M_sf) \times (1 - E_rad) \times (1 + f_TRZ) \\
  & + a_EM
\end{aligned}
$$
...
```
E_rad = (L_region \times t) / (M \times c2)
L_region = 100,000 LM_sun = 3.826e31 W (O-star dominated HII region)
E_rad = (3.826e31 \times 9.468e13) / (1.989e33 \times (3e8)2)
