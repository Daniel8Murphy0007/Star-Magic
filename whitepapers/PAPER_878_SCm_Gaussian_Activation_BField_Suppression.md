...
The standalone module `scm_activation_function.py` implements this in:
...
```bash
python scm_activation_function.py        # Full report
python scm_activation_function.py —json  # Machine-readable
```
