...
$$S_{\rm UQFF}(t) = \minleft[S_{\rm thermal}(t), \; S_{\rm BH}(t) + \sum_{k=25}^{26} I_k (1 - e^{-\kappa t})\right]$$
...
*Source: `MAIN_1_CoAnQi`.cpp Batch 21 (InformationParadoxModule) | $\kappa$ = 0.0005/day | [SSq] = 0.57*
