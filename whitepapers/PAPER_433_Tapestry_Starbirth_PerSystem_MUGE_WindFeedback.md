...
| Tapestry Star Formation luminosity Radio 1.4 GHz + IR | UQFF MUGE g_total $\to$ L_X via Stefan-Boltzmann + buoyancy flux: L_X $\approx$ g_total $\times$ M_env | L_X SFR ~ 10 `M_M_sun`/yr | ALMA / Spitzer | PASS Consistent order of magnitude |
