...
where:
- (1 + H₀t) = Hubble expansion factor over bubble age t (~10⁵ yr)
...
For positive E_t, the vacuum energy is *enhanced* within the expanding bubble interior (less dense than the ambient cloud), and ρ_SCm > ρ_UA locally.
...
|----------|---------|-------|
| v_wind | Spectroscopic | 1.8×10⁶ m/s |
| E_t sign | Expansion | POSITIVE |
| g_bubble | GM/r²·(1+H₀t)·SC_m·(1+E_t) | Enhanced |
| (1+H₀t) | 10⁵ yr age | 1.0000023 |
...
The positive E_t bubble form establishes the UQFF taxonomy for expanding media: ANY expanding volume of gas/plasma where internal density is less than ambient will have ρ_SCm > ρ_UA locally (relative to the ambient), producing E_t > 0. This applies to: supernova remnants, stellar winds, HII regions, AGN feedback bubbles, and cosmic voids. The Bubble Nebula, being well-studied (Herschel, Hubble Space Telescope, multi-wavelength), provides the calibration standard for all positive-E_t UQFF calculations.
