...
1.8$\times$106 m/s) into the surrounding molecular cloud. UQFF introduces a POSITIVE expansion energy term
...
g_bubble = $\mu$_s$\nabla$(M_s/r)(1+H0t)SC_m(1+E_t). This provides the canonical example of the positive-E(t) UQFF
class.
...
$$g_{\mathrm{bubble}} = \frac{GM_\star}{r^2} \cdot (1 + H_0 t) \cdot {\mathrm{SC}}_m \cdot (1 + E_t)$$
...
$$E_t = E_0 \cdot f_{\mathrm{TRZ}} \cdot t \cdot \frac{\rho_{\mathrm{SCm}}}{\rho_{\mathrm{UA}}}$$
...
|----------|---------|-------|
| v_wind | Spectroscopic | 1.8$\times$106 m/s |
| E_t sign | Expansion | POSITIVE |
| g_bubble | $\mu$_s$\nabla$(M_s/r)(1+H0t)SC_m(1+E_t) | Enhanced |
