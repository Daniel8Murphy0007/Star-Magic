---
paper_id: PAPER_638
title: "UQFF BESIII Doubly Cabibbo Suppressed D+ Decay and Dipole Contribution"
session: 162
date: 2026-01-01
...
contribution: E_{react\_DCS} = U_g2 $\times$ tan4$\theta$_C captures the UQFF amplitude for the
...
|------------|-----------------|-----------------|--------|-----------|
| BR(D+$\to$K+$\pi$0) DCS | `E_{react\_DCS}` $\times$ tan4$\theta$_C = 1.49e-4 | BR = (1.45 $\pm$ 0.21)$\times$10-4 | arXiv:2506.15533 (BESIII) | 96.4% |
...
- bsm_{physics\_validation}.py — `BSMPhysicsConstants.besiii_{dcs\_br}`, `cabibbo_{angle\_deg}`
