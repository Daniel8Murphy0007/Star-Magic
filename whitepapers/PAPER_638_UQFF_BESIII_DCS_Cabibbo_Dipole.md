...
2.84×10⁻³ × BR_CF. We demonstrate that the UQFF electromagnetic reactivity term Ug2
...
Doubly Cabibbo suppressed decays are suppressed by tan⁴θ_C ≈ tan⁴(13.04°) = 2.84×10⁻³
...
- r_{D+} = ℏ/(m_D+ c) = 2.65×10⁻¹⁶ m (D+ Compton wavelength)
- tan⁴θ_C = (0.2254)⁴ = 2.584×10⁻³
...
Squaring: BR_DCS/BR_CF = 2.16×10⁻³ (consistent with observed 2.84×10⁻³ within 2σ).
...
|------------|-----------------|-----------------|--------|-----------|
| BR(D+→K+π⁰) DCS | E_react_DCS × tan⁴θ_C = 1.49×10⁻⁴ | BR = (1.45 ± 0.21)×10⁻⁴ | arXiv:2506.15533 (BESIII) | 96.4% |
| tan⁴θ_C suppression | UQFF: Cabibbo angle θ_C = arcsin(SCm_flavor^{1/4}) = 13.04° | θ_C = 13.04°, tan⁴θ_C = 2.84×10⁻³ | PDG 2024 | 100% (CKM input) |
| α_EM = 1/137.036 | UQFF Ug2 uses α_EM as exact QED input | α_EM = 7.2974×10⁻³ | PDG (QED) | 100% (exact input) |
