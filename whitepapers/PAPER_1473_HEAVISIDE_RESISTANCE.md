# PAPER_1473 — UQFF: Heaviside Reactor Resistance R_t = 7 ohms (Bucket K)
...
**Status:** CLOSED — R_t = N_CH minus 2 = 7 ohms EXACT
...
```
R_t = N_CH - 2 = 9 - 2 = 7 ohms EXACT, where N_CH is the canonical UQFF channel count.
```
...
The 7-ohm resistance encodes the SCm-channel minus 2-pole subtraction. Equivalent form D_BSFG + 1 = 7. Both identities coincide because D_BSFG = N_CH - 3.
