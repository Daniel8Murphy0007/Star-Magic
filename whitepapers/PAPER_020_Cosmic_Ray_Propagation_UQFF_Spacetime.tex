...
\midrule
Pierre Auger & 10$^{18}$--10$^{20}$ eV & GZK suppression confirmed, Cen A anisotropy \tabularnewline
Telescope Array & 10$^{18}$--10$^{20}$ eV & Hotspot at l \textasciitilde{} 177$^\circ$, b \textasciitilde{} 48$^\circ$ \tabularnewline
HiRes & 10$^{18}$--10$^{20}$ eV & GZK feature at 6 $\times$ 10$^{19}$ eV \tabularnewline
IceCube & 10$^{15}$--10$^{18}$ eV & Diffuse neutrino flux correlated with CRs \tabularnewline
\bottomrule
\end{tabularx}
\end{table}
...
\begin{enumerate}
  ...
  \item \textbf{Composition:} Transition from light (proton) to heavy (iron) at ankle (3 $\times$ 10$^{18}$ eV)
  \item \textbf{Secondary feature:} Possible spectral break at 8 $\times$ 10$^{19}$ eV
\end{enumerate}
...
\begin{enumerate}
  ...
  \item CMB pair production (Bethe-Heitler, E > 10$^{18}$ eV)
...
\begin{itemize}
  ...
  \item \textbf{E\_ref = 10$^{18}$ eV (ankle energy)}
...
\begin{itemize}
  \item \textbf{G\_aether = 0.0005 $\times$ (10$^{20}$/10$^{18}$)$^{0.37}$ = 0.0005 $\times$ 5.36 = 2.68 $\times$ 10$^{-3}$/day}
...
\begin{itemize}
  ...
  \item \textbf{E\_TRZ = 8 $\times$ 10$^{19}$ eV} (TRZ resonance energy)
...
\textbf{Key result:} TRZ scattering peaks at E\_TRZ = 8 $\times$ 10$^{19}$ eV, producing a secondary spectral feature.
...
At UHECR energies (E << E\_Planck = 1.22 $\times$ 10$^{28}$ eV), string exchange is negligible:
...
\textbf{Feature 1 -- TRZ Secondary Break at E \textasciitilde{} 8 $\times$ 10$^{19}$ eV:}
...
\midrule
10$^{18}$--3 $\times$ 10$^{18}$ eV & 3.30 & 3.28 & -0.02 \tabularnewline
3 $\times$ 10$^{18}$--8 $\times$ 10$^{19}$ eV & 2.60 & 2.58 & -0.02 \tabularnewline
...
\begin{itemize}
  \item Required intergalactic B field: \textbf{B \textasciitilde{} 3$\times$10$^{-12}$ G} (vs < 1 nG required by GR)
...
\midrule
10$^{18}$ & 1.5 & 1.6 & 1.5--2.0 \tabularnewline
3 $\times$ 10$^{18}$ & 2.0 & 2.2 & 2.0--2.5 \tabularnewline
10$^{19}$ & 2.5 & 2.8 & 2.5--3.0 \tabularnewline
10$^{20}$ & 3.0 & 3.2 & 3.0--3.5 \tabularnewline
\bottomrule
\end{tabularx}
\end{table}
...
\midrule
Auger upgrade (AugerPrime) & Confirm TRZ break at 8 $\times$ 10$^{19}$ eV & 2026--2028 \tabularnewline
Telescope Array 4 & Resolve Cen A hotspot angular structure & 2027--2030 \tabularnewline
GRAND (200,000 km) & Detect aether pile-up at 2 $\times$ 10$^{19}$ eV & 2030--2035 \tabularnewline
IceCube-Gen2 & Correlated neutrino flux from TRZ interactions & 2030--2035 \tabularnewline
\bottomrule
\end{tabularx}
\end{table}
...
All results derived from pre-calibrated constants $\kappa$ = 0.0005/day and [SSq] = 0.57. A new prediction -- TRZ secondary spectral break at E \textasciitilde{} 8 $\times$ 10$^{19}$ eV with $\Delta\gamma$ \textasciitilde{} +0.3 is testable by AugerPrime within 23 years.
...
\bibitem{cite7} UQFF Calibration: $\kappa$ = 0.0005/day, [SSq] = 0.57 : Cosmic Ray Propagation in UQFF
\end{thebibliography}
