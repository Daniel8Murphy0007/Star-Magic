---
paper_id: PAPER_360
title: "J1610+1811 High-z Quasar Jet at z=6.5: Relativistic Lorentz Factor k_rel Coupling"
session: 97
date: 2025-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [quasar, Hubble, vacuum, jet, F_{U\_Bi\_i}, buoyancy, UQFF]
...
Lorentz factor $\Gamma$ $\approx$ 4.5. UQFF introduces a relativistic coupling constant k_rel = $\Gamma$2 = k_{rel\_0} $\times$
20.25 (Lorentz factor squared) to scale the vacuum buoyancy force in the jet frame. The Friedmann
Hubble parameter H(z = 6.5) is computed from H(z) = H0$\sqrt{}$[0.3(1+z)3 + 0.7], and F_{U\_Bi\_i} $\approx$ -8.32$\times$10217
...
$$k_{\mathrm{rel}} = \Gamma^2 = k_{\mathrm{rel,0}} \times \Gamma^2 = k_{\mathrm{rel,0}} \times (4.5)^2 = 20.25 \cdot k_{\mathrm{rel,0}}$$

The Lorentz factor squared enhancement represents the relativistic Doppler amplification of the
vacuum buoyancy force in the jet frame.
...
### 2.3 Relativistic F_{U\_Bi\_i}

$$F_{U\_Bi\_i}^{\mathrm{relativistic}} = F_{U\_Bi\_i}^{\mathrm{standard}} \cdot k_{\mathrm{rel}} = -8.32\times 10^{217} \times 20.25 \approx -1.69 \times 10^{219}\ \mathrm{N}$$

(in the jet co-moving frame; observer-frame is un-boosted)

### 2.4 Lookback Time at z = 6.5

$$t_{\mathrm{lookback}} \approx 12.9\ \mathrm{Gyr}$$
...
| `F_{U\_Bi\_i}` (obs frame) | Standard | -8.32$\times$10217 N |
| `F_{U\_Bi\_i}` (jet frame) | $\times$k_rel | -1.69$\times$10219 N |
...
massive black holes — addressing the "first quasar" problem.
...
$$p_{\mathrm{DVP}} = 2, \quad n_{\mathrm{channel}} = 23/26$$
...
5. Riess, A.G. et al. (2022). *A Comprehensive Measurement of the Local Value of the Hubble Constant with 1 km/s/Mpc Uncertainty from the Hubble Space Telescope.* ApJL **934**, L7 — arXiv:2112.04510 — doi:10.3847/2041-8213/ac5c5b
...
7. Verde, L., Treu, T. & Riess, A.G. (2019). *Tensions between the Early and Late Universe.* Nature Astron. **3**, 891 — arXiv:1907.10625 — doi:10.1038/s41550-019-0902-0
