---
paper_id: PAPER_757
title: "Pillars of Creation M16 — UQFF Photo-Erosion Framework"
session: 181
date: 2026-01-01
...
$$
\begin{aligned}
  & g_Pillars(r, t) = [G\cdot M(t) / r2] \times (1 + H(t,z)) \times (1 - B/B_crit) \times (1 - E(t)) \\
  & + q\cdot(v_wind \times B) \times A_aeth \times A_scale \times (1 - E(t)) \\
  & + \rho_ISM\cdot v_wind2 / r \\
...
| `ErosionLagrangianEulerLagrangeCalc` | 470 | PAPER_886 | $L_{\mathrm{erosion}} = E^-(t) \cdot V \cdot S_{26}$ for pillar decay |
...
The Pillars' exponential decay `E(t) = E_0\cdotexp(-t/tau_erode)` is the
photo-erosion limit of the general E-(t) master equation:

$$
\begin{aligned}
  & Pillars:   E(t) = E_0\cdot\exp(-t/tau_erode)    [UV-driven mass loss] \\
