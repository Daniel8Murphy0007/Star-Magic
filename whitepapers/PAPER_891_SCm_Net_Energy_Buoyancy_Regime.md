...
**Significance:** E_net,SCm is the energy-density formulation of the buoyancy ratio classification. It connects the microscopic SCm vacuum to macroscopic cosmological dynamics — every nebula, filament, and galaxy can be classified by its R value into expansion or erosion regime.
...
This paper maps to **SCm-net-energy sector** of the 9-sector UQFF Lagrangian (see `uqff_lagrangian_derivation.py`).
...
| DVP prime | $p_k \in$ {2,3,...,113} | $p_{\rm DVP} = 47$ | ✓ Super-threshold |
