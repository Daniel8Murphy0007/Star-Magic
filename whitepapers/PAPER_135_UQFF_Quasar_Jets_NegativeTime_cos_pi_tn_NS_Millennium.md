#  "PAPER_{0:D3}" -f [int]# PAPER #135 — UQFF Quasar Jets: Negative Time cos(πt_n) Asymmetry and Navier-Stokes Millennium
...
.Groups[1].Value  — UQFF Quasar Jets: Negative Time cos(πt_n) Asymmetry and Navier-Stokes Millennium
