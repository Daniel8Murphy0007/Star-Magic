...
- Information recovery timescale: `\tau_info ~ (M/M_{M\_sun}) \times 10^7 yr`
...
Buoyant (F_{U\_Bi} atomic scale), MasterBuoyant (F_{U\_Bi\_i} cosmic scale), Resonant (aDPM + 13 frequency
