...
gravitational effect: a velocity-dependent gravitational force not present in standard Newtonian
...
Newtonian gravity per unit mass is `g = G M / r2`. The vacuum drag acceleration is:
...
gravitational force** — the first such force in the UQFF framework, absent from standard Newtonian
gravity and GR.
