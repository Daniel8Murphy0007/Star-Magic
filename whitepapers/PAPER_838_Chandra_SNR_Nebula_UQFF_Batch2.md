...
status: production
cvw: "v2.0.0"
tags: [DPM, pulsar, UQFF, F_U_Bi_i, buoyancy, Chandra, LENR, nebula]
...
## Abstract
Seven supernova remnants and planetary nebulae are analyzed using the UQFF Master F_U_Bi_i Buoyancy
...
Iax white dwarf collision remnant), and NGC 6543 (Cat's Eye). F_U_Bi spans 10^207–10^210 N across
the batch, with Vela Pulsar yielding the highest value (2.11×10^210 N) due to its extended spatial
scale (r=6.17×10^17 m). SNR 1181 is notable as a rare Type Iax remnant with neon-rich filaments.
...
\begin{aligned}
  ...
  & F_LENR    = 10^-10 × (2π×1.25×10^12 / ω_0)2 \\
...
$$
\begin{aligned}
  & Compressed system: g(r,t) ≈ -1.07 × 10^16 J/m3 \\
  & \text{F\_U\_Bi} = -1.83×10^71 + (9.11×10^-31 × (3×10^8)2/(6.17×10^16)2) × 0.93 × 0.707 \\
  & + (6.6743×10^-11 × 1.989×10^31/(6.17×10^16)2) × 1 + \text{F\_U\_Bi\_i} \\
  & F_LENR = 10^-10 × (2π×1.25×10^12/10^-12)2 = 1.56 × 10^36 N \\
  & DPM_resonance = (2 × 9.274×10^-24 × 10^-5)/(1.0546×10^-34 × 10^-12) = 1.76 × 10^3 \\
  & \text{F\_U\_Bi\_i} integrand ≈ 1.56 × 10^36 N \\
  & a = (μ_s∇(M_s/r)) ≈ 3.49 × 10^-59 \\
  & x_2 ≈ -1.35 × 10^172 m \\
  & \text{F\_U\_Bi\_i} = 1.56×10^36 × (-1.35×10^172) ≈ 2.11 × 10^208 N
\end{aligned}
$$
...
\begin{aligned}
  ...
  & a = (μ_s∇(M_s/r)) = 6.6743×10^-11 × 1.989×10^31/(3.09×10^16)2 ≈ 1.39 × 10^-58 \\
  & x_2 ≈ -3.40 × 10^172 m \\
  & \text{F\_U\_Bi\_i} = 1.56×10^36 × (-3.40×10^172) ≈ 5.30 × 10^208 N
\end{aligned}
$$
...
\begin{aligned}
  ...
  & F_LENR = 1.56 × 10^36 N  (ω_0=10^-12) \\
  & a = (μ_s∇(M_s/r)) = 6.6743×10^-11 × 1.989×10^31/(6.17×10^17)2 ≈ 3.49 × 10^-61 \\
  & x_2 ≈ -1.35 × 10^174 m  (100× larger) \\
  & \text{F\_U\_Bi\_i} ≈ 2.11 × 10^210 N
\end{aligned}
$$
...
\begin{aligned}
  ...
  & F_LENR = 1.56 × 10^36 N  (ω_0=10^-12) \\
  & a = 6.6743×10^-11 × 1.989×10^30/(7.71×10^15)2 ≈ 2.23 × 10^-57 \\
  & x_2 ≈ -6.73 × 10^171 m \\
  & \text{F\_U\_Bi\_i} ≈ 1.05 × 10^208 N
\end{aligned}
$$
...
\begin{aligned}
  ...
  & F_LENR = 1.56 × 10^36 N  (ω_0=10^-12) \\
  & a = 6.6743×10^-11 × 3.978×10^30/(3.09×10^16)2 ≈ 2.78 × 10^-58 \\
  & x_2 ≈ -1.70 × 10^172 m \\
  & \text{F\_U\_Bi\_i} = 1.56×10^36 × 1.70×10^172 ≈ 2.65 × 10^208 N
\end{aligned}
$$
...
\begin{aligned}
  ...
  & F_LENR = 1.56 × 10^36 N  (ω_0=10^-12) \\
  & a = 6.6743×10^-11 × 1.989×10^30/(3.09×10^15)2 ≈ 1.39 × 10^-55 \\
  & x_2 ≈ -6.73 × 10^170 m \\
  & \text{F\_U\_Bi\_i} ≈ 1.05 × 10^207 N
\end{aligned}
$$
...
**F_neutrino contribution:** +1 N in each system — below detection threshold for F_U_Bi_i
