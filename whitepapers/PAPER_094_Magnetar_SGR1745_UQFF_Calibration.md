---
paper_id: PAPER_094
title: "SGR1745-2900 Magnetar UQFF Calibration: Determining κ = 0.0005/day and [SSq] = 0.57 from
Magnetar Physics"
session: 0
date: 2026-03-07
...
# PAPER_094: SGR1745-2900 Magnetar UQFF Calibration: Determining κ = 0.0005/day and [SSq] = 0.57 from Magnetar Physics
**Session:** 0
...
**Date:** March 7, 2026  
**Source Data:** validate_uqff_muge.py (Magnetar system), source4.cpp (sgr1745_SOURCE4), ?
...
× 10-4 T (2.3  B_crit) and spin-down rate ?P^{-1} provide the observational anchors for calibrating
two fundamental UQFF constants: κ = 0.0005/day (temporal decay parameter) and [SSq] = 0.57
(squared-state density term). Batch 23 of MAIN_1_CoAnQi.cpp implements the ? calibration procedure.
...
$$
\text{B\_CRIT\_MAGNETAR}: 4.4 × 10 T  (= 0 m?c/(e?))
$$
...
For SGR1745 2013 outburst: N_burst  600 bursts over 1200 days active ? ? = 600/1200 × 10? =
**0.0005/day** ?
