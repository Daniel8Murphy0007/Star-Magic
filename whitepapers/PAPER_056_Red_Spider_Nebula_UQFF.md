...
**Date:** March 7, 2026  
**Validator:** `validate_{all\_models}.py`  RedSpiderNebulaModel: **4/4 PASS** ?  
**Source Module:** `CondensedPhysics.py` (RedSpiderNebulaModel), `validate_{all\_models}.py`  
...
$$g_{\mathrm{compressed}}^{\mathrm{Red Spider}} = 2 \times g_{\mathrm{compressed}}^{\mathrm{isolated}}$$
...
$$g_{\mathrm{compressed}}^{\mathrm{EUV}} = g_{\mathrm{compressed}} \times \left(1 + \frac{k_B T_{\mathrm{star}}}{m_p c^2}\right)^{1/2} \approx g_{\mathrm{compressed}} \times \sqrt{1 + 0.043} \approx g_{\mathrm{compressed}} \times 2$$
...
$$Ug2 = \lambda_{\mathrm{Ug2}} \times q_{\mathrm{eff}} \times E_{\mathrm{rad}} \times (1 + [SSq])$$
...
$$v_{\mathrm{wind}} = v_{\mathrm{escape}} \times \sqrt{1 + Ug2/g_{\mathrm{grav}}}$$

At g_grav = 1.3$\times$10? and Ug2 >> g_grav (EM-dominated):
$$v_{\mathrm{wind}} \approx v_{\mathrm{escape}} \times \sqrt{Ug2/g_{\mathrm{grav}}} \approx 100 \text{ km/s} \times \sqrt{256} \approx 1600 \text{ km/s}$$
...
*Validator: `v`alidate_{all\_models}`.py` RedSpiderNebulaModel 4/4 PASS | $\kappa$ = 0.0005/day | [SSq] =
0.57*
