...
**Index Slot:** §1.7 arXiv Cross-Validation Framework, Paper #56  
...
| Wind velocity | ~1,600 km/s (L_wind ~ 10³⁸ W) |
...
At T_eff = 400,000 K: k_B T / m_p c² = 1.38×10⁻²³ × 4×10⁵ / (1.67×10⁻²⁷ × 9×10¹⁶) ≈ 4.1×10⁻² ≈ 0.04 << 1, so the exact formula uses a different coupling. The UQFF identifies this as the [SCm] compression factor in the high-radiation environment calibrated to 2.0× at the Red Spider's wind velocity regime.
...
*Validator: `validate_all_models.py` RedSpiderNebulaModel 4/4 PASS ✓ | κ = 0.0005/day | [SSq] = 0.57*
