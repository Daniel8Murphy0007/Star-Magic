---
paper_id: PAPER_553
title: "F_{U\_Bi\_i} with 26th-Order Gaussian Polynomial — Truncated Exponential Anti-Collapse Proof"
session: 147
date: 2026-03-27
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [F_{U\_Bi\_i}, BEC, buoyancy, FUBi, UQFF]
sm_anchor: "CVW v2.0.0 — G6 SM Anchor Gate compliant"
---

# PAPER_553: F_{U\_Bi\_i} with 26th-Order Gaussian Polynomial — Truncated Exponential Anti-Collapse Proof

**Author:** Daniel T. Murphy — Star Magic / UQFF Framework  
**Session:** 147 | **Source:** `grok_{share\_b08cc4e3684}`.txt (item 4, completed from first principles) 
**CP4 Class:** `FUBi26thGaussianTruncatedPolynomialBoundCalculator` (#148)  
**Date:** 2026-03-27  

> **Source note:** Grok's item 4 in `grok_{share\_b08cc4e3684}.txt` stated only: *"Expand exp in FUB_i to degree 26: exp(-z2) $\approx$ $\Sigma$_{k=0}^{26} (-1)^k z^{2k}/k! (truncates for proof). Proof: Integrates to bounded erf, supporting dynamics."* This paper completes that statement with the full step-by-step derivation matching the level of items 1–3 in the same source.
...
## §2 The Gaussian Foundation of F_{U\_Bi\_i}
...
**Impact on companion papers PAPER_550–552:** Items 1–3 of the source (`grok_{share\_b08cc4e3684}.txt`)
