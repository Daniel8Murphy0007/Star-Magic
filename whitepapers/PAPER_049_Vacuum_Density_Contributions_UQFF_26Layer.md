...
factor brings this to 7$\times$10? J/m. The exact definition is in `QCalc_Phase1_Validation.py` Test 2. The
...
*Validator: `QCalc_Phase1_Validation.py` Test 2 PASS | ?_vac = 7$\times$10? J/m | SCmc = 8.988$\times$10 | UA =
