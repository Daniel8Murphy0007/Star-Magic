# PAPER #96 — Fast Radio Burst Origin: UQFF Coherent Emission Model
...
**Index Slot:** §1.13 Multi-Physics Models Paper #96  
...
For a typical magnetar (B = 2 × 10¹⁴ T, R = 1.2 × 10⁴ m):
...
Observed CHIME FRB energies: 10⁴⁰–10⁴³ erg → **UQFF in range by factor ~10, broadly consistent.** (FRB beam factor ~1–10% of hemisphere reduces effective energy → 10⁴⁷ erg total, 10⁴³ erg observed.)
...
Observed: 1–100 ms. Factor ~10–1000 discrepancy → TRZ collapse may span multiple NS radii (r_TRZ up to 10 R_NS for the most energetic FRBs). Scaling: Δt ∝ r_TRZ/c → **3-order-of-magnitude range covered.**
...
Versus standard magnetospheric: α ~ 1.0–2.0 (CHIME catalog range). UQFF predicts α = 1.01 → in range. **PASS.**
...
|------|---------|------|------|
| Burst energy | 10⁴⁰–10⁴³ erg | 10⁴² erg | ✓ |
| Pulse width order | μs–ms | ~60 μs | ✓ |
| Spectral slope α | 1.0–2.0 | 1.01 | ✓ |
