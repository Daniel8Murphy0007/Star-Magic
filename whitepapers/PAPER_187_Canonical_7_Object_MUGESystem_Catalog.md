...
extracted from the grok_share_381a8f source file. These values are authoritative and constitute the
...
{"Magnetar SGR 1745-2900",
 1e21,           // I [kg·m2]
 3.142e8,        // A [m2] (≈ cylinder area of NS, R~10 km)
...
{"Sagittarius A*",
 1e23,           // I [kg·m2]
 2.813e30,       // A [m2] (event horizon area ≈ 4π R_s2)
...
{"Pillars of Creation",
 1e21,           // I [kg·m2]
 2.813e32,       // A [m2] (pillar cross-section ~1 pc × 3 pc)
 1e-3,           // omega1 [rad/s]
 -1e-3,          // omega2 [rad/s]
...
{"Rings of Relativity",
 ...
 1.989e36,       // M [kg] (≈ 106 M_sun lens galaxy fraction)
...
{"Student's Guide Universe",
 1e24,           // I [kg·m2] (universe-scale tensor)
...
The full UQFF field adds a buoyancy correction $U_{b\_i}$ on top of each MUGE result:

$$F_U^{(k)} = g_{\text{MUGE}}^{(k)} + \sum_{i=1}^{4} U_{gi}^{(k)} + U_m^{(k)} + U_A^{(k)} - U_{b\_i}^{(k)}$$
...
The UQFF $U_{b\_i}$ correction of $5.7\times10^{14}$ is sub-dominant at this radius.
