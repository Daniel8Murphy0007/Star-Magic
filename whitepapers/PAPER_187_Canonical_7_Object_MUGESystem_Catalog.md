...
namespace CoAnQi::MUGE {
    struct MUGESystem {
        ...
        double delta_{rho\_rho}; // relative density perturbation [dimensionless]
    };
}
```
...
{"Magnetar SGR 1745-2900",
 ...
 1e-5}           // delta_{rho\_rho} (density perturbation)
```
...
{"Student's Guide Universe",
 ...
 1e-6}           // delta_{rho\_rho} (primordial perturbation amplitude ~10-5)
```
