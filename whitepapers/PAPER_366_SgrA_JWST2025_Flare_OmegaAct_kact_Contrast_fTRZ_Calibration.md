---
paper_id: PAPER_366
title: "Sgr A* JWST 2025 NIR Flare: \omega_act Derivation from k_act Contrast Amplitude"
session: 97
date: 2025-01-01
...
$$\omega_{\mathrm{act}} = 2\pi f_{\mathrm{flare}} = 2\pi \times 5.56 \times 10^{-4}\ \mathrm{Hz} = 3.49 \times 10^{-3}\ \mathrm{rad/s}$$
...
$$T_{\mathrm{flare}} = \frac{1}{f_{\mathrm{flare}}} = \frac{1}{5.56\times 10^{-4}} = 1798\ \mathrm{s} \approx 30\ \mathrm{min}$$
...
$$k_{\mathrm{act}} = \frac{F_{\mathrm{flare}}}{F_{\mathrm{quiescent}}} - 1$$

The UQFF activation amplitude is related to k_act by:
$$\omega_{\mathrm{act}} = \omega_0 \cdot (1 + k_{\mathrm{act}})$$
...
$$\omega_{\mathrm{act}} = 2\pi \times 5.56\times 10^{-4} = 3.495\times 10^{-3}\ \mathrm{rad/s} \checkmark$$
...
$$p_{\mathrm{DVP}} = 17, \quad n_{\mathrm{channel}} = 3/26$$
