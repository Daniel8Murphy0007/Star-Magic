---
paper_id: PAPER_637
title: "UQFF and ALICE Run 3 √s=13.6 TeV Multiplicity Vacuum Density Ratio"
session: 162
date: 2026-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [ALICE, vacuum, SCm, buoyancy, UQFF]
...
$\rho$_vac_ratio = [SSq] $\times$ ($\sqrt{s}$/$\sqrt{s}$_0) at the Run 3 energy reproduces this measurement:
...
At $\sqrt{s}$ = 13.6 TeV, $\sqrt{s}$_0 = 13 TeV (reference), $\Lambda$_QCD = 0.217 GeV:
...
This maps to $\sqrt{s}$_resonance = 13.0 $\times$ 1.070 = 13.91 TeV — within 2.3% of ALICE 13.6 TeV.
...
| UQFF resonance $\sqrt{s}$ | [SSq]/$\beta$_i = 1.070 $\to$ $\sqrt{s}$_res = 13.91 TeV | $\sqrt{s}$_ALICE = 13.6 TeV (2.3% offset) | ALICE Run 3 | PASS Near resonance |
...
| ALICE Pb-Pb dN/d$\eta$ prediction | UQFF $\rho$_vac_ratio scales by A^{1/3}: predicts PbPb 5.5 TeV dN/d$\eta$ $\approx$ 1870 | ALICE PbPb $\sqrt{s}$_NN = 5.5 TeV upcoming | ALICE Run 3+ | Testable UQFF prediction |
...
- bsm_{physics\_validation}.py — `BSMPhysicsConstants.alice_{run3\_energy\_tev}`, `dNdeta_alice`
