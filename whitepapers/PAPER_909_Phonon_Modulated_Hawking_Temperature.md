...
$$p_{\mathrm{DVP}} = 131, \quad n_{\mathrm{channel}} = 24/26$$
...
|-----------|----------------|------------|--------|
| VDS ratio | $\rho_{\mathrm{SCm}}/\rho_{\mathrm{UA}} = 1.894$ | Local sub-ratio = 0.04 | PASS Consistent |
| DVP prime | $p_k \in$ {2,3,...,113} | $p_{\mathrm{DVP}} = 131$ | PASS Lattice-consistent |
