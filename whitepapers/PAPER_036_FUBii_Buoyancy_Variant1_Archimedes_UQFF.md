...
*Validator: `BuoyancyProofVariants.py` → All 17 F_UBii variants operational ✓ | κ = 0.0005/day | [SSq] = 0.57*
.Groups[1].Value  — F_UBii Buoyancy Force: Proof Variant 1 (Archimedes-UQFF)
...
**Variant:** virx (Virial X-ray Cluster Buoyancy)  
**Index Slot:** §1.5 Buoyancy Proofs,  
    $n = [int]#  "PAPER_{0:D3}" -f [int]# PAPER #36 — F_UBii Buoyancy Force: Proof Variant 1 (Archimedes-UQFF)
...
**Validator:** `BuoyancyProofVariants.py` — All 17 variants operational ✓  
**Variant:** virx (Virial X-ray Cluster Buoyancy)  
**Index Slot:** §1.5 Buoyancy Proofs,  "PAPER_{0:D3}" -f [int]# PAPER #36 — F_UBii Buoyancy Force: Proof Variant 1 (Archimedes-UQFF)
