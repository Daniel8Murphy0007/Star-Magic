#  "PAPER_{0:D3}" -f [int]# PAPER #119 — UQFF 7-System Equation Reference: Complete Variable Tables
...
6. IceCube Collaboration (2022). *Science.* Diffuse neutrino SED (ß_i=0.61 anchor).  
