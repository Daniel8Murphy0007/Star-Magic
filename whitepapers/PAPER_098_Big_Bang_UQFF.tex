...
\section{Â\S{}v5.78 Closure â€'' Calibration Constants Now Derived (Cosmology / Bucket-A, T-Î›)}
...
$H_0 \approx 67.4$ km/s/Mpc (Planck 2018) & Reproduced from ledger + Î¾-lock projection & PAPER\_1170 + PAPER\_1171/1173 \tabularnewline
...
\textbf{Non-applicability note:} P6 sub-mm Yukawa (PAPER\_1173) probes $L_{KK}^{*}$ at the 20â€``90 Âµm scale, downstream of the pre-inflationary Quantum Egg; P10 Cherenkov spectral cutoff is a high-energy-astrophysics signature; LENR-scale closures (Holmlid 630 eV / Kozima PAPER\_840) are out of scope. None of these directly test the pre-inflationary configuration described here.
