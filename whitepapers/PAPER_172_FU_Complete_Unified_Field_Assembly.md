...
$$
U_b_i(r,t) = \rho_{\text{vac}}\,V_{\text{eff}}\,g_{\text{loc}}\cdot[SSq]\,e^{-\kappa t}, \quad
...
- `compute_compressed_MUGE(SGR1745)` †’ expected ‰ˆ 1.782e39
- `compute_resonance_MUGE(SGR1745)` †’ expected ‰ˆ 1.773e-9
