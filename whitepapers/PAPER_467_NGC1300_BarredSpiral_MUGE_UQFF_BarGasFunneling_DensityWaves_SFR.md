...
**Computed Result:** $g_{\rm NGC1300} \approx 2 \times 10^{36}\ \mathrm{m/s}^2$ — env/fluid dominant; repulsive Ug2 and $\Lambda$ terms establish equilibrium in the bar-spiral transition region.
