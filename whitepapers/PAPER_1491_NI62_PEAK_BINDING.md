...
**Status:** CLOSED — Z = D_crit+2 = 28, N = D_crit+2·D_phys = 34, A = A_5+2 = 62 — all EXACT
...
```
Z(Ni-62) = D_crit + 2 = 28 EXACT; N(Ni-62) = D_crit + 2·D_phys = 34 EXACT; A(Ni-62) = A_5 + 2 = 62 EXACT.
```
