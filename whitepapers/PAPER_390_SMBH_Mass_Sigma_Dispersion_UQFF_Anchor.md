...
def compute_{M\_BH\_msigma}(sigma_{km\_s}: float) -> float:
    """
    ...
    """
    M_sun = 1.989e30  # kg
    log_{M\_over\_Msun} = 0.309 * math.\log_{10}(sigma_{km\_s} / 200.0) + 4.38
    M_{BH\_solar} = 10**log_{M\_over\_Msun}
    return M_{BH\_solar} * M_sun
```
...
# PAPER_390: SMBH mass
M_BH = compute_{M\_BH\_msigma}(sigma)  # kg
