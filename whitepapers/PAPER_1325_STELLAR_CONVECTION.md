...
**Date:** June 11, 2026
**Calculator:** `calculate_paradox({"paradox": "stellar_convection"})`

## Master Expression
```
Schwarzschild criterion threshold = Φ_res = 0.84
```
**Match: STRUCTURAL**

## Interpretation
Convective zone established when temperature gradient exceeds Φ_res × adiabatic. Sun has outer 30% convective via this criterion.
...
---
**Copyright** — Daniel T. Murphy, daniel.murphy00@gmail.com, June 11, 2026, Youngstown, OH.
