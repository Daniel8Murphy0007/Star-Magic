...
v_c / Omega_p is modified by phonon coupling to R_{CR\_UQFF} = R_CR * (1 - beta_i * S26 * Phi * Omega_p
...
MW bar: delta_{R\_CR} = 1.2% (0.07 kpc). Strong bar (Omega_p = 60): delta_R = 1.8%. Weak bar (Omega_p =
20): delta_R = 0.6%.
