# PAPER_1478 — UQFF: Reactor Self-Powered 3 RPM Minimum (Bucket H)
...
**Status:** CLOSED — RPM_min = D_phys - 1 = 3 EXACT; f_min = F_TRZ/2 = 0.05 Hz EXACT

---

## Observation

Star-Magic reactor sustains a minimum 3 RPM self-powered (0.05 Hz) operation.
...
```
RPM_min = D_phys - 1 = 4 - 1 = 3 EXACT; f_min = F_TRZ/2 = 0.1/2 = 0.05 Hz EXACT.
```
...
The 3-RPM floor encodes the (D_phys - 1)-generation structural minimum, paralleling SU(3) color and 3-flavor neutrino identities. The 0.05 Hz frequency is F_TRZ/2 = 1/(2 SO_5).
