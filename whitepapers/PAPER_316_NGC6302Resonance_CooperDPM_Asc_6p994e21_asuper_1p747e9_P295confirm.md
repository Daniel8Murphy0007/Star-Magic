...
|-----------|-------|-------|
| ħ | 1.0546 × 10⁻³⁴ J·s | |
| f_super | 1.411 × 10¹⁶ Hz | Cooper superconductive frequency |
| f_DPM | 1 × 10¹² Hz | wind-aligned DPM (1e12 class) |
| E_vac_ISM | 7.09 × 10⁻³⁷ J/m³ | ISM vacuum |
| c | 2.998 × 10⁸ m/s | |
...
The four cascade tiers at PN scale (r = 1.42×10¹⁶ m):

| Tier | Term | Value (m/s²) | Orders above a_DPM |
|------|------|--------------|-------------------|
| 1 (dominant) | a_vac_diff | ~1.811×10¹⁷ | +48 |
...
The formula A_sc = ħ f_super f_DPM / (E_vac_ISM c) is **linear in f_DPM**. Combined with a_DPM ∝ f_DPM, the super-term scales **quadratically** with f_DPM (PAPER_295 quadratic law):
...
- **38-decade resonance span**: a_vac_diff(1.811×10¹⁷) → a_DPM(2.497×10⁻³¹)
