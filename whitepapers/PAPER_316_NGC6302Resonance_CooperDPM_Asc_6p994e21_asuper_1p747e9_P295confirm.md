---
paper_id: PAPER_316
title: "NGC6302 Cooper-DPM f_DPM=10 Hz Class Confirmation: A_sc=6.994\times10, a_super=1.747\times10?? m/s"
session: 0
date: 2026-03-17
...
**WOLFRAM_TERM:** NGC6302_{RES\_COOPER\_SC}  
...
| `E_{vac\_ISM}` | 7.09 $\times$ 10?7 J/m | ISM vacuum |
...
PAPER_295 (Session 83, COMPRESSED_{RESONANCE\_UQFF24\_MODULE}) predicted:
...
|------|------|--------------|-------------------|
| 1 (dominant) | `a_{vac\_diff}` | ~1.811$\times$10-7 | +48 |
...
The formula A_sc = h f_super f_DPM / (E_{vac\_ISM} c) is **linear in f_DPM**. Combined with a_DPM ?
...
- **38-decade resonance span**: a_{vac\_diff}(1.811$\times$10-7) ? a_DPM(2.497$\times$10?)
...
$$p_{\mathrm{DVP}} = 59, \quad n_{\mathrm{channel}} = 5/26$$
