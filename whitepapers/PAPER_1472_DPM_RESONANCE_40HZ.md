# PAPER_1472 — UQFF: Star-Magic Reactor DPM Resonance (Bucket H)
...
**Status:** CLOSED — f_dp = D_phys × SO_5 = 40 Hz EXACT

---

## Observation

Reactor Q-scope Group #12 measured a Di-Pseudo-Monopole resonant attraction frequency between bodies of exactly f_dp = 40.000 Hz with pulse cadence dT = 25 ms.
...
The 40 Hz resonance is the structural product of spacetime dimensions (D_phys = 4) and SO(5) icosahedral group order (SO_5 = 10). This is the carrier frequency of the SCm-UA DPM grinding mechanism (PAPER_646) in the lab reactor.
