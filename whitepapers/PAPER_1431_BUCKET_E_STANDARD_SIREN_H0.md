# PAPER_1431 — UQFF: Standard Siren H_0 (Bucket E)
...
**Status:** CLOSED — formal catalog tuple in Bucket E
**Calculator surface:** `calculate_gw_events({...})`
...
```
67.4 × (1+Λβ_iΦ_res/D_phys) km/s/Mpc
```
