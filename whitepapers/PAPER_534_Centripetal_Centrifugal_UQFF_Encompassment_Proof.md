...
result = calc.compute()
# result['F_{centripetal\_N}']       — F_c (N)
# result['F_{centrifugal\_N}']       — F_cf = -F_c (N)
# result['delta_{res\_analytic}']    — 0.0 (exact)
# result['encompassed']           — True if delta_{res\_analytic} == 0
# result['HulseTaylor_{delta\_dPdt}']— UQFF correction to binary pulsar decay
```
