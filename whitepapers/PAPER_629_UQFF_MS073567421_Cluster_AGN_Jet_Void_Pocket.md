...
| Eddington luminosity ceiling | L_Edd = 4$\pi$GMm_pc/$\sigma$_T; M_BH ~ 3$\times$100`M_{M\_sun}` | MS 0735 BH mass: ~1010`M_{M\_sun}`; L_Edd ~ 106\mu W | PDG / Chandra | UQFF jet power within Eddington limit |
