...
\begin{enumerate}
  \item \verb|validate_gw170817.py|, \verb|validate_gw190425.py|, \verb|validate_ligo_comparison.py|  Validation scripts
...
\textbf{Validator:} \verb|validate_gw170817.py|, \verb|validate_gw190425.py|, \verb|validate_ligo_comparison.py|  all channels PASSED.Groups[1].Value : Damping Mechanism Decomposition in UQFF Framework
