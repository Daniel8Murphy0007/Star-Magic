---
paper_id: PAPER_327
title: "Q_{wave\_47} Non-Parametric Distribution Survey"
session: 94
date: 2025-09-01
...
# PAPER_327 — Q_{wave\_47} Non-Parametric Distribution Survey  
**Author:** Daniel T. Murphy
**Date:** September 2025
...
The complete Q_{wave\_47} array (J/m3):

```python
Q_{wave\_all} = [8.13e-10, 1.11e5, 4.65e-5, 1.11e5, 4.65e-5, 1.11e-4, 2.11e5, 2.11e5,
...
Both tests independently confirm: **Q_{wave\_47} is non-Gaussian with heavy positive tails**.
...
gok_{share\_31b5c807a4}.txt (Grok 4 analysis, September 14, 2025).
