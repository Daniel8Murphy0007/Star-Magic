---
paper_id: PAPER_581
title: "UQFF \cdot LQG \cdot \Lambda_CDM: Simultaneous Three-System Quantum Gravity Comparison"
session: 156
date: 2025-01-01
...
|-----------|----------------|------------|--------|
| VDS ratio | $\rho_{\mathrm{SCm}}/\rho_{\mathrm{UA}} = 1.894$ | Local sub-ratio = 0.152 | PASS Threshold-consistent |
