...
Standard gravity (Newtonian + GR) provides a single field value g = GM/r + GR corrections. UQFF
...
Compressed mode predictions within 7% (vs. 12% for pure Newtonian with dark matter halo).
