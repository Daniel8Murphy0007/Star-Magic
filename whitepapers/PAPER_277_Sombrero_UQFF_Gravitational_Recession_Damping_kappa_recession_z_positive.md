---
paper_id: PAPER_277
title: "UQFF Gravitational Recession Damping Factor \kappa_recession for Positive Redshift"
session: 77
date: 2026-03-01
...
With g_base = G$\cdot$M/r2 = 2.382$\times$10-10 m/s2 and pre_{sum\_Ug} $\approx$ 52$\cdot$g_base $\approx$ 1.238$\times$10-8 m/s2:
...
```cpp
// PAPER_277 — SOMBRERO_{UQFF\_MODULE}.cpp, updateCache()
