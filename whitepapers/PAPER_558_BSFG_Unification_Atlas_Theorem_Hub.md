...
From PAPER_554: $R_{\rm scalar} \approx 3\varepsilon''/(A_{00}) + \varepsilon''/(A_{rr})$. With $\varepsilon'' = 12\etacos(\pi t_n)\,C_{\rm num}/r^5$:
...
| **Curvature** | $R^r{}_{0r0} = 6\etacos(\pi t_n)C_{\rm num}/r^5$ | PAPER_554 |
