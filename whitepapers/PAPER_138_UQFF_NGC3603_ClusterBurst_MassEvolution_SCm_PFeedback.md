...
starburst. Pre-UQFF models treat cluster formation as a purely Newtonian gravitational collapse with
...
$$+ \rho_{fluid} V g_{eff} + (M_{vis} + M_{DM})\left(\frac{\deltarho}{\rho} + \frac{3GM}{r^3}\right) + \rho v_{wind}^2$$
