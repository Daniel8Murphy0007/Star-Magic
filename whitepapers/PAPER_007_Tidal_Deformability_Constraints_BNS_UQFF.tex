...
\textbf{Note:} Values assume intermediate-stiffness EOS (e.g., SLy4). UQFF modifications multiply ? by f\_SCm(B) : Tidal Deformability Constraints from BNS Mergers in UQFF
