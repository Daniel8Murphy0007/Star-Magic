...
**Date:** March 7, 2026  
**Source Data:** SOURCE4 canonical systems (sagA_SOURCE4), observational_{systems\_config}.h,
`uqff_{validation\_test}.py` LENR framework  
**Index Slot:** §1.9 Automated 121-System Validation,  

## Abstract

Active Galactic Nuclei (AGN) host supermassive black holes (SMBH) ranging from 4$\times$106 M_sun (Sgr A*)
to 6.5$\times$10? M_sun (M87*). In the UQFF, the Ug4 term provides a cosmological vacuum concentration
...
|-----|----------|-------------|---------|--------|--------------|
| Sgr A* | 4.0$\times$106 | 2.62$\times$10 | 10-4 | 10 | SOURCE4 canonical |
| M87* | 6.5$\times$10? | 1.60$\times$10 | 10-8 | 1$\times$10? | EHT imaged |
| Centaurus A | 5.5$\times$107 | 6.17$\times$10 | 2$\times$10-4 | 1$\times$10-6 | Nearest radio galaxy |
| NGC 1365 | 2$\times$107 | 9.46$\times$10 | 10-6 | 1$\times$10?? | Barred Seyfert 1.5 |

---

## 2. Ug4 Vacuum BH Coupling

$$Ug_4 = k_4 \cdot \rho_{\mathrm{vac,[SCm]}} \cdot \frac{M_{\mathrm{BH}}}{d_g} \cdot e^{-\kappa t} \cdot \cos(\pi t_n) \cdot (1 + f_{\mathrm{fb}})$$

Where:
- k4 = 10? (coupling constant)
- ?_vac,[SCm] = 7.09$\times$10?7 J/m
- f_fb = 0.05 (AGN feedback factor)
- $\kappa$ = 0.0005/day (cosmic decay rate)

### Ug4 Values at t = 0

| AGN | M_BH/d_g (kg/m) | Ug4 (J/m) |
|-----|----------------|-----------|
| Sgr A* | (4$\times$106§1.989e30)/2.62e20 = 3.04$\times$10-6 | 10?  7.09e-37 $\times$ 3.04e16 $\times$ 1.05 = **2.27$\times$10-5** |
| M87* | (6.5$\times$10?§1.989e30)/1.60e23 = 8.09$\times$10-6 | 10?  7.09e-37 $\times$ 8.09e16 $\times$ 1.05 = **6.03$\times$10-5** |
| Centaurus A | (5.5$\times$107§1.989e30)/6.17e23 = 1.77$\times$10-4 | 10?  7.09e-37 $\times$ 1.77e14 $\times$ 1.05 = **1.32$\times$10-5** |
| NGC 1365 | (2$\times$107§1.989e30)/9.46e23 = 4.21$\times$10 | 10?  7.09e-37 $\times$ 4.21e13 $\times$ 1.05 = **3.14$\times$10-5** |
...
Sgr A* is one of the seven canonical SOURCE4 systems (`sagA_SOURCE4`) in MAIN_{1\_CoAnQi}.cpp:
...
The LENR resonance for Sgr A* uses ?0 $\times$ 2p/(16 yr) = 1.25$\times$10-8 rad/s (S2 star orbit):
...
M87*'s shadow radius was measured by EHT in 2019: r_shadow = 6.5$\times$10 m (6M/c).

UQFF Compressed gravity at r_shadow:
$$g_C = \frac{M_{M87}}{r_{\mathrm{shadow}}} \times 10^{-10} = \frac{6.5 \times 10^9 \times 1.989 \times 10^{30}}{6.5 \times 10^{10}} \times 10^{-10}$$
...
- UQFF Compressed at r_ph deviates from GR by ~0.01% (?-decay: e^{-?$\cdot$t_age}  e^{-0.00055e10} ? 0 deviation at this scale)

### M87 Jet UQFF Analysis

Centaurus A (nearest radio galaxy, d = 3.8-4.0 Mpc, L_X = 2$\times$10-4 W):
- Jet length  11 kpc (r_jet = 3.4$\times$10 m)
- Um field along jet: Um = ($\kappa$_j/r_jet)  (1-exp(-?$\cdot$t_age))  E_react = (3.38e20/3.4e20)  ~1 $\times$ 1046 = 9.94$\times$1045 J/m
...
The resonant mode cos(?_maser  t)  10-5 at ?_22GHz = 2p  22.235$\times$10? = 1.397$\times$10 rad/s:
$$g_{\mathrm{Resonant,maser}} = \cos(\omega_{\mathrm{maser}} \times t) \times 10^{-5} = 10^{-5} \text{ (maximum)}$$

Background gravity at r = 0.1 pc = 3.086$\times$10-5 m:
$$g_{
m DPM} = \underbrace{\frac{GM}{r^2}}_{\mu_s\nabla(M_s/r)} = \frac{6.674e-11 \times 2e7 \times 1.989e30}{(3.086e15)^2} = 2.79 \times 10^{-4} \text{ m/s}^2$$

Ratio: g_Resonant/g_DPM = 10?5/2.79$\times$10-4 $\times$ 0.036 (3.6% maser enhancement above DPM-seeded)  
...
|-----|-------------|-----------|----------|-----------------|-------------|
| Sgr A* | 3.04$\times$106 | cos(?_S2)10?5 | ?_vac1055 | E_react10? | Ug4 coupling |
| M87* | 1.29$\times$10 | cos(?_jet)10?5 | ?_vac1055 | E_react10? | Compressed |
| Cen A | 1.77$\times$10-4 | cos(?_jet)10?5 | ?_vac1055 | E_react10? | Resonant (jet) |
| NGC 1365 | 4.21$\times$10 | cos(?_maser)10?5 | ?_vac1055 | E_react10? | Resonant (maser) |

*Source: SOURCE4 sagA_SOURCE4, `observational_{systems\_config}`.h, `uqff_{validation\_test}`.py | $\kappa$ =
0.0005/day | [SSq] = 0.57*
