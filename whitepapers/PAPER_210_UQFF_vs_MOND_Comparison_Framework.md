...
\begin{aligned}
  ...
  & DPM-seeded: g_N = µ_s?(M_s/r)  decreases as 1/r2 \\
...
\begin{aligned}
  ...
  & k_UA·?_vac,[UA]/M × r_trans = µ_s?(M_s/r) \\
...
\begin{aligned}
  ...
  & DPM-seeded:  x>>1 ? µ˜1 ? g_MOND ˜ g_N (recovers Newton) \\
  ...
  & At r < r_trans: Ug1 << g_N ? µ_UQFF ˜ 1 (DPM-seeded) \\
