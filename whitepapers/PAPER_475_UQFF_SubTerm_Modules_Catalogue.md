...
within MAIN_{1\_CoAnQi}.cpp and CondensedPhysics.py.

---

## 1. Introduction

The 44 sub-term modules were extracted from `grok_{share\_b0a3dc1d}.txt` (10,420 lines) and represent
...
class SubTermCalculator:
    def compute_{aether\_vacuum\_density}(self) -> dict:
...
are ready for integration as `PhysicsTerm` subclasses in MAIN_{1\_CoAnQi}.cpp or as Python calculator
...
**Source:** `grok_{share\_b0a3dc1d}.txt` L1502–9356 (44 class definitions)  
**Header index:** `modules/subterms/sub_{terms\_index}.h`  
