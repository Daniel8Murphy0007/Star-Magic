---
paper_id: PAPER_063
title: "The F_U_Bi_i Integral: Master Buoyant Force Derivation, Ensemble Statistics, and KAPPA_MCMC
...
**Title:** The F_U_Bi_i Integral: Master Buoyant Force Derivation, Ensemble Statistics, and
...
This represents the second root of the cosmic F_U_Bi_i field equation  the scale at which the net
...
$$\kappa_{\rm MCMC} = \argmin_{\kappa} \sum_{k=1}^{47} \left[ F_{U,Bi,i}^{\rm obs}(k) - F_{U,Bi,i}^{\rm UQFF}(k, \kappa) \right]^2$$
