...
calibration formula for the galactic angular frequency input `\omega_s_galactic`:
...
The MUGE resonance tier `term_Ub_i = -\beta_i \times ug1 \times \omega_s \times (M/r) \times U_UA \times cos(\pi\cdot t)` then
...
Photometric measurement: R_bulge (HST/ELT effective radius)
         ↓
Formula: \omega_s_galactic = (\sigma \times 103) / R_bulge
         ↓
