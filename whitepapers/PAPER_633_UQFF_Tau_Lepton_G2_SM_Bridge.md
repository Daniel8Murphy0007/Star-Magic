---
paper_id: PAPER_633
title: "UQFF Tau Lepton Anomalous Magnetic Moment as Standard Model Dipole Bridge"
session: 162
date: 2026-01-01
...
- $\mu$_$\tau$ = $g_{\tau}$ $\times$ e/(2$m_{\tau}$) (tau magnetic moment)
...
- bsm_{physics\_validation}.py — `BSMPhysicsConstants.tau_{g\_minus\_2\_SM}`
