...
$$
\beta_app = v\cdot\sin(\phi) / (c - v\cdot\cos(\phi))
$$
...
| Black hole mass (M87 BH) | BH26 pocket shell at r_S = 2GM/c2; M_M87 = 6.5e9 `M_{M\_sun}` | EHT shadow: M_M87 = 6.5$\pm$0.2e9 `M_{M\_sun}` | EHT 2019 | Shared input |
...
- grok_{share\_6322ac199}.txt — BigBang Hypergraph Theory (Session 161, Topic D15)
...
- BH26 oscillation modes: session_{161\_vds\_dvp\_bh26\_references}.md §4
