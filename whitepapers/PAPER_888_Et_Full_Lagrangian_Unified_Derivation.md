...
**Significance:** This paper provides the apex of the E(t) variational formulation. The full Lagrangian unifies L_expansion + L_erosion and links to the observed cosmological constant — providing the complete field-theoretic foundation for UQFF cosmological dynamics.
...
This paper maps to **unified-Lagrangian sector** of the 9-sector UQFF Lagrangian (see `uqff_lagrangian_derivation.py`).
...
| DVP prime | $p_k \in$ {2,3,...,113} | $p_{\rm DVP} = 37$ | ✓ Super-threshold |
