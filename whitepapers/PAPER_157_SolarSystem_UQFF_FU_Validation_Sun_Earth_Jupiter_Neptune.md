...
- **CP3 (`CondensedPhysics3.py`):** Add `FU_{SolarSystem\_Sun\_Calculator}`, `FU_{SolarSystem\_Earth\_Calculator}` using per-body $\omega$_c
- **SOURCE4 (MAIN_{1\_CoAnQi}.cpp):** Solar System bodies can be added as 4 new CelestialBody instances in the menu
...
- test_{compute\_Ug1\_sun} ✅
- test_{compute\_Ug2\_earth} ✅
- test_{compute\_Ug3\_jupiter} ✅
- test_{compute\_Ug4\_global} ✅
- test_{compute\_FU\_neptune} ✅
- test_{compute\_Ubi\_sun} ✅
- test_{omega\_c\_solar\_11yr} ✅
- [21 additional tests ✅]
