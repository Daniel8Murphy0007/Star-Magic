...
$$F_{U,Bi,i} = \int_{\mathcal{M}} \left[\sum_{k=1}^{4} U_{g\_k}(r,t) + U_m(r) + U_{bi}(r,t) + \kappa(t) \cdot [{\rm SSq}] \right] dV$$
...
$$F_{\rm MB}(r,t) = F_{\rm Buoy}(r,t) + \sum_k U_{g\_k}^{\rm disk}(r_{\rm disk}) \cdot A_{\rm AGN}(t)$$
