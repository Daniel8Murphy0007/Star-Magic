...
resonance components: R_{U\_g1}, R_{U\_g2}, R_{U\_g3}, and R_{U\_g4i} per each of the 26 states.
...
- Each term carries amplitude R_{U\_gX},i ~ f_X $\times$ A_X(state)
...
|--------|----------|------------------|
| Vela/Crab (compact) | -1.12$\times$10-42 | `R_{U\_g3}` THz (f_THz=1012 blob velocities 0.3-0.7c) |
| NGC 1365/ESO 137-001 | -2.29$\times$10-41 | `R_{U\_g1}` magnetic dipole (Seyfert AGN) |
| Jupiter/Lagoon | -1.12$\times$10-42 | `R_{U\_g2}` charge-reactivity (H3+/ionized plasma) |
