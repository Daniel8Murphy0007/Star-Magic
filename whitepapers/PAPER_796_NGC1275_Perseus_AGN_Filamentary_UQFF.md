...
$$
\begin{aligned}
  & g_NGC1275(r,t) = (G\cdot M)/r2 \cdot (1 + H(z)\cdot t) \cdot (1 – F_BH(t)) \cdot (1 + f_TRZ) \\
  & + a_fil \\
...
$$
\begin{aligned}
  & G\cdot M / r2     = 6.6743e-11 \times 6.763e41 / (9.46e20)2 \\
  & = 4.513e31 / 8.949e41 = 5.043e-11 m/s2 \\
  & H(z = 0.018): Hz = H0\cdot\sqrt{}(0.3\cdot(1.018)3 + 0.7) = 2.272e-18 \\
  & (1 + Hz\cdot t) = 1 + 2.272e-18 \times 1.578e17 = 1.359 \\
