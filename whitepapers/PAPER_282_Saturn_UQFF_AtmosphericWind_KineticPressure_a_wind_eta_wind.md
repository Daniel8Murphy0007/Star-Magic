---
paper_id: PAPER_282
title: "Saturn UQFF Atmospheric Wind Kinetic Pressure Term — a_wind, \eta_wind"
session: 78
date: 2025-01-01
...
|---|---|---|
| `g_{Sun\_tidal}` (PAPER_280) | G$\times$M_Sun/r_orbit2 | Constant |
| `F_{ring\_tidal}` (PAPER_281) | g_ring $\times$ cos($\omega$$\times$t) | Oscillatory |
