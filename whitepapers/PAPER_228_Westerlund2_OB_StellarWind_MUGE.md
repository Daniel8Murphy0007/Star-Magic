...
Nameg_\text{UQFF}(r) = g_\text{MUGE}(r)\cdotBigl(1 - [SSq]\cdot U_{b\_i}\,/\,F_U(r,t)\Bigr), \quad
[SSq] = 0.57Name
...
**UQFF computed:** MUGE buoyancy ratio U_bi/F_U = [SSq]×?×r2/GM = 5.7e-1×5.0e-4 = 2.85e-4;
