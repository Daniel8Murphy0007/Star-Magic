...
| $M_dot_factor$ | $M_{gas}/M_{init} = 3.33$ |
| $r$ | $10$ ly |
| $B$ | $10\ \mu$T |
...
Nameg_\text{UQFF}(r) = g_\text{MUGE}(r)\cdot\Bigl(1 - [SSq]\cdot U_b_i\,/\,F_U(r,t)\Bigr), \quad
[SSq] = 0.57Name

With $M_dot_factor = 3.33$ (vs 41.7 for Tapestry): smaller fractional gas reservoir relative to the massive cluster.
