---
paper_id: PAPER_343
title: "SGR J1745-2900: SC_m Mass-Modified Luminosity and Doubled f_react (June 2013)"
session: 96
date: 2013-06-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [AGN, vacuum, SCm, magnetar, UQFF]
...
**Classification:** FIRST UQFF treatment of magnetar SC_m mass modification with L_X = ?_vacf_resV  
**Author:** Daniel T. Murphy  
...
A novel UQFF form for the superconductive modifier SC_m of SGR J1745-2900 is derived as a
...
$${\mathrm{SC}}_m = M \cdot \left(1 - \frac{B}{B_{\mathrm{crit}}}\right)$$
...
$$L_X = \rho_{\mathrm{vac}} \cdot f_{\mathrm{res}} \cdot V_{\mathrm{mag}}$$
...
$$f_{\mathrm{react}}^{\mathrm{post}} = 2 \cdot f_{\mathrm{react}}^{\mathrm{pre}}$$

The doubling of the reactance frequency at outburst onset corresponds to:
$$\Delta L_X = \rho_{\mathrm{vac}} \cdot \Delta f_{\mathrm{res}} \cdot V_{\mathrm{mag}} = \rho_{\mathrm{vac}} \cdot f_{\mathrm{react}}^{\mathrm{pre}} \cdot V_{\mathrm{mag}}$$

### 2.4 Surface Temperature

From Stefan-Boltzmann balance of magnetospheric luminosity:
$$T_{\mathrm{surf}} = \left(\frac{L_X}{4\pi R_{\mathrm{NS}}^2 \sigma_{\mathrm{SB}}}\right)^{1/4} = 1.16 \times 10^7\ \mathrm{K}$$
...
SGR J1745-2900 is the only magnetar within 0.3 pc of Sgr A*, making it the unique test-bed for UQFF
near the Galactic Center supermassive black hole. The SC_m = M(1-B/B_crit) form establishes that
even strongly magnetized neutron stars maintain near-unity superconductive coupling due to B –
B_crit. The L_X = ?_vacf_resV form is a direct observable prediction: doubling f_res (as seen in
June 2013) should produce a factor of 2 luminosity jump, consistent with the 2013 XMM-Newton
observations.
...
- **vs. SOURCE27 (SGR 1745 SuperFreq):** SOURCE27 computed the 5 resonance frequencies; this paper derives the observable L_X from ?_vacf_resV.
...
8. Kaspi, V.M. & Beloborodov, A.M. (2017). *Magnetars.* ARA&A **55**, 261 — arXiv:1703.00068 — doi:10.1146/annurev-astro-081915-023329
9. Olausen, S.A. & Kaspi, V.M. (2014). *The McGill Magnetar Catalog.* ApJS **212**, 6 — arXiv:1309.4167 — doi:10.1088/0067-0049/212/1/6
10. Thompson, C. & Duncan, R.C. (1993). *Magnetar formation through a convective dynamo in protoneutron stars.* ApJ **408**, 194 — doi:10.1086/172580
