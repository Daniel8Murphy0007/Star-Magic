...
|--------|---------|-------|-------------|
| $k_{\rm vac}$ | $6.67\times10^{-11}$ | m3/(kg$\cdot$s2) | Vacuum coupling constant (gravitational analogy) |
...
- DE comparison: PAPER_237 ($F_{\rm DE}$ as $\Lambda$$\cdot$c2/3$\cdot$r term in $F_{U\_Bi\_i}$)
