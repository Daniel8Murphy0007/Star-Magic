...
\begin{itemize}
  \item \textbf{P6} sub-mm Yukawa at $L_{KK}^{*}\in[20,90]$ Âµm (PAPER\_1173): directly probes the radii of the outermost DPM centers ($r_{20}=4.64\times10^{-22}$ m through $r_{26}=4.64\times10^{-17}$ m fall well below P6 reach, but the same KK tower constraint governs the energy normalization of every center).
