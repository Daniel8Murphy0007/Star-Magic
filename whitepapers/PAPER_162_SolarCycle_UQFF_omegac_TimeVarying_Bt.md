---
paper_id: PAPER_162
title: "Solar Cycle UQFF: omega_c = 2\pi/(11yr), Time-Varying B(t), delta_def Defect Factor"
session: 47
date: 2026-01-01
...
double compute_{B\_t}(const CelestialBody& body, double t) {
...
**CP2 update:** `UQFFSolarCycleCalculator` — add `omega_c` parameter, `compute_{B\_t}()`,
...
$$p_{\mathrm{DVP}} = 41, \quad n_{\mathrm{channel}} = 7/26$$
