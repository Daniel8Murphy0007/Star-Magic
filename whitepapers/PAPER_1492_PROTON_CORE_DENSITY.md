...
**Status:** CLOSED — ρ_p_core = ρ_SCm × K_MEX × S_26 = 2.146 × 10⁻³⁶ J/m³
...
```
ρ_p_core = ρ_SCm × K_MEX × S_26 × f_DPM(26, β_i); base term (without f_DPM) = 2.146 × 10⁻³⁶ J/m³. Dimensionless coupling K_MEX × S_26 = 3.027.
```
...
The proton core is the SCm vacuum density peak amplified by the Mexican-hat coefficient and the 26-level Ramanujan factor. f_DPM(26, β_i) is the DPM-folding modulation; the product captures the 26-layer hierarchical structure that supports the proton as a localized SCm condensate.
