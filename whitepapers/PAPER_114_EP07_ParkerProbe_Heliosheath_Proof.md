...
The `atomic_{uqff\_framework}.py` module implements UQFF for Z = 1 (hydrogen) which
...
7. `SolarWindHeliosheathCalculator`, `atomic_{uqff\_framework}.py`  Star-Magic codebase.
