# PAPER #114 — Empirical Proof EP-07: Parker Solar Probe Heliosheath — UQFF Ug2 Testbed
...
density (ρ_sw ≈ 8 × 10⁻²¹ kg/m³) and velocity (v_sw ≈ 500 km/s) at 10–50 solar
radii. The UQFF heliosheath term δ_sw = 0.01 is introduced as a dimensionless
coupling parameter that modulates Ug2 at the heliospheric boundary. PSP magnetic
field, density, and velocity profiles through 16 perihelia confirm the δ_sw = 0.01
...
| SWEAP/SPC | v_sw, ρ_sw, T_p | 0.874 s cadence |
...
Where:
- α_CR = charge-reactivity coupling constant (UQFF)
- q_p = proton charge = 1.602 × 10⁻¹⁹ C
- v_sw = solar wind speed
- m_p = proton mass
- r = heliocentric distance

At r = 30 R☉ = 2.09 × 10¹⁰ m, v_sw = 500 km/s = 5 × 10⁵ m/s:
...
### 2.2 Heliosheath Coupling δ_sw

The UQFF introduces a heliosheath boundary term δ_sw = 0.01 that modifies Ug2
...
- Corresponds to the [SSq]-derived sub-boundary coupling: δ_sw = [SSq]/57 = 0.57/57 = 0.01
...
Where P_ram = ρ_sw v_sw²/2 = 8 × 10⁻²¹ × (5 × 10⁵)²/2 = 10⁻⁹ Pa:
...
the UQFF δ_sw = 0.01 applies to the sub-threshold pre-shock region.
...
| PSP Perihelion | r_min (R☉) | ρ_sw measured | ρ_sw UQFF | Error |
|---------------|-----------|--------------|-----------|-------|
...
- **δ_sw = 0.01** is physically motivated (PSP in-situ measurements)
...
| 3 | $U_{g2}^{helio} = U_{g2} \times 1.01$ | δ_sw = 0.01 | Heliosheath coupling |
...
| 7 | MUGE fluid term δ_sw | 0.01 | PAPER_091 link |
...
1. **ρ_sw = 8 × 10⁻²¹ kg/m³** and **v_sw = 500 km/s** are the canonical PSP
   in-situ heliospheric parameters confirming the UQFF Ug2 heliosheath testbed
2. **δ_sw = 0.01** = [SSq]/57 is the UQFF heliospheric boundary coupling,
...
4. The MUGE fluid Navier-Stokes correction (PAPER_091) is confirmed at δ_sw = 0.01,
