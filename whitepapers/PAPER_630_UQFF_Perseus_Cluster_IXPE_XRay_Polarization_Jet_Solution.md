...
$$
\begin{aligned}
  & \log_{10}(U_m) \approx \log_{10}(\kappa\cdot2) + 26\cdot\log_{10}(1/\nabla UA) \\
...
$$
\begin{aligned}
  & U_b(\nabla UA_eq) = g \cdot (1 - 1/\nabla UA_eq) = 10-3 \cdot (1 - 1010) \approx -107  N \\
  & U_g(\nabla UA_eq) = g \cdot \nabla UA_eq = 10-3 \cdot 10-10 = 10-13  N
\end{aligned}
$$
...
- DVP polarization coupling: session_{161\_vds\_dvp\_bh26\_references}.md §3
