---
paper_id: PAPER_175
title: "26 Quantum Energy Levels and Vacuum Energy Density ?_vac"
session: 0
date: 2025-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [quasar, AGN, vacuum, SCm, jet, neutron-star, magnetar, UQFF]
...
Per-object:
  ?_vac,X = (f_{i\_X} \times E_{i\_X}) / V_object
```
...
$$
\begin{aligned}
  & Ug4 = k4 \times ?_vac,[SCm] \times C_concentration \times Mbh/dg \times exp(-a\times t) \times cos(p\times t?) \times (1+f_feedback) \\
  & ? ?_vac,[SCm] is the SCm-dominated vacuum energy density (global rho_v = 6e-27 kg/m3) \\
...
| Value | ~120 orders above observed | 6e-27 kg/m3 (calibrated) |
...
1. **Calibrating ?_v**: The canonical value 6e-27 kg/m3 sits at the boundary
