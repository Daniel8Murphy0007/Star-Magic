...
```
G·M/r2  = 6.6743e-11 × 9.945e41 / (5.66e20)2
        = 6.636e31 / 3.204e41 = 2.071e-10 m/s2

Hz(z=0.013) = H0·√(0.3·(1.013)3+0.7) = 2.270e-18
(1+Hz·t) = 1 + 2.270e-18 × 1.578e17 = 1.358
factor_sf = 1.03; factor_TRZ = 1.05
g_grav = 2.071e-10 × 1.358 × 1.03 × 1.05 = 3.042e-10 m/s2

v_EM = 1.5×105 m/s (elevated for large spiral):
a_EM = (1.602e-19 × 1.5e5 × 1e-5 / 1.673e-27) × 11e-12
     = (2.403e-19 / 1.673e-27) × 11e-12
     = 1.436e8 × 11e-12 = 1.580e-3 m/s2   (slightly elevated)

Most conservative: use v = 1e5 m/s → a_EM = 1.053e-3 m/s2
g_primary ≈ 1.053×10-3 m/s2  (standard EM ground state)
```
...
```
Over-massive SMBH (10^8.5 MM_sun for σ=180 km/s): U_i/U_m < 1
