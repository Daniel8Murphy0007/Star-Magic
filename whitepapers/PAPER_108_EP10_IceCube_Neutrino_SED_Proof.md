#  "PAPER_{0:D3}" -f [int]# PAPER #108 — Empirical Proof EP-10: IceCube Sub-PeV Neutrino SED — UQFF β_i Calibration
...
.Groups[1].Value  — Empirical Proof EP-10: IceCube Sub-PeV Neutrino SED — UQFF β_i Calibration
