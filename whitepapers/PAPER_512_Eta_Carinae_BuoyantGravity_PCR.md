---
paper_id: PAPER_512
title: "Eta Carinae LBV Binary — Buoyant Gravity with PCR Envelope"
session: 0
date: 2026-03-01
...
$$
g_\text{base} = \frac{6.674\times10^{-11}\times 130\times M_\odot}{(1.5\times 1.496\times10^{11})^2}
\approx 2.04\times10^{-3}\,\text{m/s}^2
$$
...
The 3.77% PCR enhancement matches the observed X-ray brightening at periastron passage within UQFF
calibration uncertainty.

---

## 4. Validation
- C++ term: `SOURCE179::EtaCarinae_{BuoyantPCR\_Term}` $\to$ `EtaCarinae_BuoyantGravityPCR`
...
| Massive object (Eta Carinae/TON618/NGC1277) luminosity X-ray + optical | UQFF MUGE g_total $\to$ L_X via Stefan-Boltzmann + buoyancy flux: L_X $\approx$ g_total $\times$ M_env | L_X M_BH ~ 109–1010 `M_{M\_sun}` | Chandra/HST | PASS Consistent order of magnitude |
