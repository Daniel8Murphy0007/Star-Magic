...
$$R_i = l_s \cdot [SSq]^{i+11}, \quad i = 1, \ldots, 15$$
...
$$\kappa_{11}^2 = \frac{l_s^9}{2} \cdot \frac{1}{\rho_{\text{vac,SCm}} \cdot S_{26}^{(3)} \cdot \Phi_{\text{res}}}$$

$$= \frac{(1/T)^{9/2}}{2 \times 8.66 \times 10^{-11}} = \frac{(1.15 \times 10^{10})^{9/2}}{1.73 \times 10^{-10}}$$
...
| Type IIB | T-dual of IIA | $R_{11} \to l_s^2/R_{11}$ |
| Type I | orientifold of IIB | $g_s \to 1/g_s$ |
| Heterotic E8$\times$E8 | $R_{11} \to [SSq]^{26} l_s$ | Left-movers |
| Heterotic SO(32) | $g_s \to (1-[SSq]) l_s$ | T-dual Het |
...
where $\omega_3^{\text{SCm}}$ is the SCm vacuum 3-form.
...
$$F_{U,Bi,i} = \int_0^\infty \left(-F_0 + \frac{GM}{r^2} + \rho_{\text{vac,SCm}} U_{UA} \cos(\pi t_n)\right) dr = \ln Z_{M}$$
...
- $R_{\text{CY}} = [SSq]^{11\text{ to }26} l_s$
