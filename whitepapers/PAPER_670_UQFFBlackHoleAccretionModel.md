---
paper_id: PAPER_670
title: "UQFF Black Hole Accretion Model"
session: 0
date: 2026-04-02
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [accretion, Hawking, vacuum, SCm, black-hole, UQFF]
sm_anchor: "CVW v2.0.0 — G6 SM Anchor Gate compliant"
---

# PAPER_670: UQFF Black Hole Accretion Model
**Author:** Daniel T. Murphy
**Subtitle:** Bondi accretion with UQFF vacuum field corrections: aether density boost, f_TRZ
enhancement, and U_m impedance. M(t) evolution.
...
## Abstract
We derive a UQFF-modified Bondi accretion rate and simulate black hole mass evolution M(t). UQFF
aether density adds an effective contribution to the ambient density, while f_TRZ and U_m further
modulate the accretion flow.

## 1. Standard Bondi Accretion
$$\dot{M}_{Bondi} = 4\pi\lambda_B\frac{(GM)^2\rho_infty}{c_s^3}$$

$c_s = \sqrt{\gamma_{ad} k_B T_\infty / m_p}$, $\lambda_B = 1/4$ (adiabatic, $\gamma$=5/3).

## 2. UQFF Modifications

### Effective Density
$$\rho_{eff} = \rho_infty + \rho_{UA} - \rho_{SCm}$$

### S_TRZ Boost
$$S_{TRZ} = 1 + f_{TRZ} = 1.1$$

### U_m Impedance
$$S_{U\_m} = 1 - \exp\!\left(-\frac{U_m}{k_B T_\infty}\right)$$

## 3. UQFF Accretion Rate
$$\dot{M}_{UQFF} = \dot{M}_{Bondi} \cdot \frac{\rho_{eff}}{\rho_infty} \cdot S_{TRZ} \cdot S_{U\_m}$$
...
Euler integration; Sgr A* context: M(t) nearly constant (evasion of both Hawking and super-Eddington
accretion).
