...
$$
\begin{aligned}
  & L_SCm = E_net,SCm\cdot V\cdot S26 \\
  & \delta S/\delta\phi_SCm = 0
\end{aligned}
$$
...
| DVP prime | $p_k \in$ {2,3,...,113} | $p_{\mathrm{DVP}} = 61$ | PASS Super-threshold |
