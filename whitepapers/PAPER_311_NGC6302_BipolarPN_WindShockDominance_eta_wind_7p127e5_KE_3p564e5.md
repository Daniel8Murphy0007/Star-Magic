---
paper_id: PAPER_311
title: "NGC 6302 Bipolar Planetary Nebula — UQFF Wind Shock Gravitational Dominance"
session: 89
date: 2026-03-17
...
**Module:** `NGC6302_{UQFF\_MODULE}.cpp` (31st C++ UQFF module)  
**WOLFRAM_TERM:** `NGC6302_{WIND\_SHOCK}`  
**UQFF First:** FIRST UQFF explicit bipolar planetary nebula wind shock gravitational dominance
analysis
...
This formulation is dimensionally consistent: [m2/s2] / [m] = [m/s2], representing the kinematic
gradient of the wind momentum deposition over the PN lobe scale length.
...
gravitational binding by ~6 orders of magnitude at the 1 ly lobe scale.
