...
\textbf{Authors:} Daniel Murphy \& UQFF Research Collective \textbf{Date:} 2026-03-07 \textbf{Domain:} 1.1 --- Gravitational Waves --- Core LIGO/Virgo Events \textbf{Primary Validation File:} \verb|validate_{gw170817\_chirp}.py| \textbf{Calibration constants:} $\kappa$ = 0.0005/day, [SSq] = 0.57
...
\textbf{Validator:} \verb|validate_{gw170817\_chirp}.py| --- PASSED (3/3 checks)
