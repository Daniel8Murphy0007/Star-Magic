...
UQFF numerical result from `validate_{sterile\_neutrino\_uqff}.py` RGE integration:
...
[SSq]^n to GUT-proximate scale; full numerical result from `validate_{sterile\_neutrino\_uqff}.py`).
...
**Validator:** `validate_{sterile\_neutrino\_uqff}.py`  PASSED (22/22)  
