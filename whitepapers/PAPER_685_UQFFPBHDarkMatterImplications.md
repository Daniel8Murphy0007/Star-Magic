...
status: production
cvw: "v2.0.0"
tags: [AGN, dark-matter, cosmology, SCm, black-hole, UQFF]
...
$$
M_{\text{crit,UQFF}} = \frac{M_{\text{crit,std}}}{\tau_{\text{ratio}}^{1/3}}, \quad
f_{\text{PBH,UQFF}} = f_{\text{PBH,GR}} \cdot \tau_{\text{ratio}}^{2/3}
$$
...
$$p_{\mathrm{DVP}} = 101, \quad n_{\mathrm{channel}} = 10/26$$
