...
|------|------------|---------|
| $\text{Ug1}_i$ | $Q_i\cdot GM/r^2$ | Newtonian gravity |
| $\text{Ug2}_i$ | $(1-[\text{SSq}])Q_i\cdot GM/r^2\times0.1$ | Charge-reactivity |
| $\text{Ug3}_i$ | $[\text{SSq}]\,Q_i\cdot GM/r^2\times0.05\sin i$ | String rotation |
