...
quantum amplitude array of size `PI_DIGITS_COUNT \times 1` via iterative phase accumulation. Each element
...
```cpp
constexpr int PI_DIGITS_COUNT = 728;   // 26 \times 28 (next sacred integral multiple)
