...
$$n_\text{cross} = \operatorname{argmin}_{n} \bigl| W_\text{prog}(n) - \Pi_text{prog}(n) \cdot F_{U\_Bi}(x) \bigr|$$
...
scale separation between Wolfram, $\pi$, and F_{U\_Bi\_i} progressions.
