---
paper_id: PAPER_871
title: "Universal Speed Range c26\cdoti-26 and Cosmic Photon Deceleration"
session: 204
date: 2026-04-07
...
$$
\begin{aligned}
  & State n: \rho_vac(n) = \rho_base \cdot (0.1)^n \cdot exp(-[SSq]\cdot n/26) \cdot exp(-(\pi-t)) \\
  & v(n) = c^{26-n+1}
\end{aligned}
$$
...
The standalone module `scm_{superconductivity\_axiom}.py` encodes this in:
...
```bash
python scm_{superconductivity\_axiom}.py        # Full report (includes speed range)
