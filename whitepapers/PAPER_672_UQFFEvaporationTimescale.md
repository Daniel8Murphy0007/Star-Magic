---
paper_id: PAPER_672
title: "UQFF Evaporation Timescale"
session: 0
date: 2026-04-02
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [Hubble, Hawking, DPM, SCm, BEC, black-hole, UQFF]
sm_anchor: "CVW v2.0.0 — G6 SM Anchor Gate compliant"
---

# PAPER_672: UQFF Evaporation Timescale
**Author:** Daniel T. Murphy
**Subtitle:** Full UQFF evaporation timescale formula, mass boundary calculations for universe-age
crossings, and U_m sensitivity sweep.
...
| U_m/`k_{BT\_H}` | $\tau$ factor over $\tau$_std |
|-------------|---------------------|
| 0 | 11.1 |
| 1 | 30.2 |
| 2 | 82 |
...
$$p_{\mathrm{DVP}} = 41, \quad n_{\mathrm{channel}} = 23/26$$
