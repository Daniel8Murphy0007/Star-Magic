...
12.5-year X-ray/radio flaring cycle, yielding F_U_Bi_i  -8.32$\times$107 N.
...
component:
$$F_\perp = F_U_Bi_i \cdot \sin\alpha = F_U_Bi_i \cdot \sin(12) \approx 0.208 \cdot F_U_Bi_i$$
...
Centaurus A's much smaller BH mass (5.5$\times$107 M? vs M87's 6.5$\times$10? M?) yet similar F_U_Bi_i value
...
- **vs. PAPER_346 (M87):** Same F_U_Bi_i magnitude but different activation period (12.5 yr vs. 1 day) and different BH mass (5.5$\times$107 vs. 6.5$\times$10? M?).
