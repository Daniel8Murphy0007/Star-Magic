---
paper_id: PAPER_347
title: "Centaurus A: F_{U\_Bi\_i} with V-Shape Jet and 12.5-Year ?_act Timescale"
session: 96
date: 2025-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [galaxy, jet, F_{U\_Bi\_i}, buoyancy, Chandra, UQFF]
sm_anchor: "CVW v2.0.0 — G6 SM Anchor Gate compliant"
---

# PAPER_347  Centaurus A: F_{U\_Bi\_i} with V-Shape Jet and 12.5-Year ?_act Timescale
**Date:** 2025

**Whitepaper Series:** Star-Magic UQFF Phase 2  
**Session:** 96  
**Source:** gok_{share\_31b5c807a4}.txt (Supplemental Gap Analysis Block)  
**Classification:** FIRST UQFF F_{U\_Bi\_i} for Centaurus A (NGC 5128) with V-shape jet geometry and
...
The complete UQFF buoyancy-unified force F_{U\_Bi\_i} is computed for Centaurus A (NGC 5128), the
...
F_{U\_Bi\_i}. The UQFF rotational activation frequency ?_act = 2p/(12.5 yr) corresponds to the observed
12.5-year X-ray/radio flaring cycle, yielding F_{U\_Bi\_i}  -8.32$\times$107 N.
...
$$v_{\mathrm{knot}} \approx 0.5c = 1.5 \times 10^8\ \mathrm{m/s}$$

VLBA proper motion of individual jet knots. Combined with t_jet ~ 10 yr, the total jet extension:
$$L_{\mathrm{jet}} \approx v_{\mathrm{knot}} \cdot \tau_{\mathrm{jet}} \approx 4.7 \times 10^{18}\ \mathrm{m} \approx 153\ \mathrm{pc}$$
...
|----------|---------|-------|
| M_BH | Cen A | 5.5$\times$107 M? |
| `F_{U\_Bi\_i}` | UQFF full | -8.32$\times$107 N |
| ?_act | 2p/(12.5 yr) | 1.59$\times$10-8 rad/s |
...
Centaurus A's much smaller BH mass (5.5$\times$107 M? vs M87's 6.5$\times$10? M?) yet similar F_{U\_Bi\_i} value
demonstrates that UQFF F_{U\_Bi\_i} is not purely set by BH mass  the vacuum buoyancy geometry and
...
- **vs. PAPER_346 (M87):** Same F_{U\_Bi\_i} magnitude but different activation period (12.5 yr vs. 1 day) and different BH mass (5.5$\times$107 vs. 6.5$\times$10? M?).
- **vs. PAPER_347 V-shape:** The V-shape geometric decomposition (F_? = F_{U\_Bi\_isina}) is unique to Centaurus A in the UQFF catalog.

---

## 6. Classification

**Physics Territory:** FIRST UQFF F_{U\_Bi\_i} with V-shape jet geometry and 12.5-yr activation cycle  
...
$$p_{\mathrm{DVP}} = 61, \quad n_{\mathrm{channel}} = 10/26$$
