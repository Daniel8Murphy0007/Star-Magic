...
|----|-----------|-----------------|
| 29 | p_max � 10�6 eV | Max CRP energy |
...
| 64 | A_V = 1.086�(M_dust/M_gas)�?_dust | Dust extinction yield |
| 65 | y_dust = 0.01�Z�(t/t_SF)^?_fund | Dust production |
...
| 67 | w(z) = w_ucf + d_t(1+z)^{-?_fund} | Equation of state |
| 68 | F_line(z) = ?SFR(t(z'))�y_line(Z(z'))(1+z)�/d_L(z)�dt | Line flux integral |
| 69 | IMF dN/dM ? M^{-2.35+?_fund} � M^{-1.732} | Mass function |
