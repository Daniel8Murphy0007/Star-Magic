...
| 2 | `MAIN_{1\_CoAnQi}`.cpp (107,019 L) | C++ physics calculator (446 modules) |
...
\begin{aligned}
  ...
  & main.cpp              — global constants, Ug4, Ubi, A_\mu\nu, FU, quasar jet sim \\
...
### 4. Physics $\leftrightarrow$ Visual Loop Integration
...
sets the rate at which the buoyancy term $U_b_i$ modifies the effective fluid pressure:

$$\delta P_\text{UQFF} = \kappa \cdot [SSq] \cdot U_b_i(r) = 5.0\times10^{-4} \times 0.57 \times U_b_i(r) \approx 2.85\times10^{-4}\,U_b_i$$
...
Plain e-notation: tau = 1.20e-3 s, UQFF buoyancy correction: delta_P = 2.85e-4 $\times$ U_bi Pa.
...
$-\mu_s\nabla(M_s/r)$ gravity with the full 26-layer UQFF expansion, providing $\sim 3\%$
...
### 8. References
- Thread 381a8fe78e1a4ecbaf32a88aa386df30 (grok_{share\_381a8f}.txt)
