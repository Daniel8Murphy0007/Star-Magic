---
paper_id: PAPER_781
title: "M74 Phantom Galaxy — UQFF Grand Design Spiral Reference"
session: 181
date: 2026-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [galaxy, Hubble, merger, JWST, UQFF]
...
M74's nearly perfect face-on orientation (inclination ~5°) makes it an ideal case for tracing spiral
structure and measuring the undisturbed rotation curve. JWST MIRI imaging in 2022 revealed
star-forming clumps, dust filaments, and HII regions threading the symmetric spiral arms at
previously unresolved spatial scales. The symmetric spiral structure indicates a stable, long-lived
disk without major recent mergers. UQFF captures M74's regular disk rotation through standard v =
105 m/s coupling, with moderate M_sf = 0.045 reflecting its ~1.5 MM_sun/yr SFR averaged over 5 Gyr of
evolution.
...
$$
g_M74(r, t) = (G \times M) / r2 \times (1 + H(z)\times t) \times (1 + M_sf) \times (1 + f_TRZ) + a_EM
$$
...
$$
H(z) = 2.269e-18 s-1; H(z)\times t = 2.269e-18 \times 1.578e17 = 0.358; factor = 1.358
$$
