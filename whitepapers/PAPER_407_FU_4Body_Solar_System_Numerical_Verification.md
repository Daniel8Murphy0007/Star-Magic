...
This paper presents a UQFF analysis of FU: Complete 4-Body Solar System Numerical Verification
...
Every body showing **identical** $U_{g4} = 4.219\times10^{-10}$ m/s2 confirms:
...
The Ug4 scale invariance at $4.219\times10^{-10}$ m/s2 is comparable to the
