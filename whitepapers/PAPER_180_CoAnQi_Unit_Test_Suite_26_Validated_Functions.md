...
| 6 | `compressed_cosm` | Λ=1.1e-52 | Λ×c²/3 ≈ 3.3e-37 |
| 7 | `compressed_quantum` | ℏ=1.0546e-34, Δxp=1e-68, ψ=2.176e-18, tH=4.35e17 | (ℏ/Δxp)×ψ×(2π/tH) |
| 8 | `compressed_fluid` | ρ=1e-15, V=4.189e12, g=10 | 4.189e-2 |
| 9 | `compressed_perturbation` | M=2.984e30, δρ=0.01, r=1e4 | large value |
...
|------|----------|------------------------|----------|
| 11 | `aDPM` | I=1e21, A=3.142e8, ω1=1e-3 → FDPM=3.142e26; ×fDPM×Evac_neb×c_res×Vsys | ≈ 3.545e-42 |
...
#### aDPM verification
```
I=1e21 kg·m², A=3.142e8 m², (ω1-ω2)=1e-3 rad/s
