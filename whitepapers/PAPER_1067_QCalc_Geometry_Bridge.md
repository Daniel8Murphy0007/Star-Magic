---
paper_id: PAPER_1067
title: "QCalc Geometry Bridge -- Python Solver UQFF Integration"
session: 204
date: 2026-04-13
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: ['QCalc', 'geometry', 'bridge', 'solver', 'integration', 'Python']
crosslinks: [PAPER_1066]
sm_anchor: "CVW v2.0.0 -- G6 SM Anchor Gate compliant"
---

# PAPER_1067: QCalc Geometry Bridge — Python Solver UQFF Integration
...
- $g_{\text{Ug,sum}} = \sum_{i=1}^{4} U_{g,i} \cdot \beta_i = 276.8$ m/s$^2$ (Sun)
- QCalc-UQFF agreement: $1.0\%$ for solar surface gravity
...
CondensedPhysics2.py, class QCalcGeometryBridgeCalculator.
...
**Sector:** computational (solver bridge)
...
PAPER_877 axioms -> SCm vacuum -> phonon $\omega_{\text{SCm}}$ -> computational (solver bridge) -> phonon coupling -> UQFF prediction -> $F_{U,Bi\_i}$ unified force -> observational prediction
