...
are analyzed with the UQFF F_UBii virial-ICM buoyancy formula. The virx variant predicts F_{UBii\_virx}
...
$$F_{\mathrm{UBii,virx}} = -F_{\mathrm{rel}} \cdot \frac{3\sigma_X^2 r_h}{G \cdot E_{\mathrm{LEP}}} \cdot Q_{\mathrm{wave}} \cdot \sigma_X$$
...
### 2.2 F_{UBii\_virx} Calculation

$$F_{\mathrm{virx}}^{Perseus} = -10^{-10} \times \frac{3 \times (1.3\times10^6)^2 \times 2.5\times10^{22}}{6.674\times10^{-11} \times 1.22\times10^{-19}} \times 1.3\times10^6$$
...
$$\boxed{F_{\mathrm{UBii,virx}}^{Perseus} = -2.024 \times 10^{60} \text{ N}}$$
...
$$F_{\mathrm{lobe}}^{Perseus} = 10^{-10} \times \frac{10^{-13} \times 2.4\times10^{61}}{1.22\times10^{-19}} \times 10^3 \times \frac{500\times10^3}{3\times10^8} = 10^{-10} \times 1.97\times10^{67} \times 10^3 \times 1.67\times10^{-3} \approx 3.3\times10^{57} \text{ N}$$
...
### 3.2 F_{UBii\_virx} Calculation

$$F_{\mathrm{virx}}^{Coma} = -10^{-10} \times \frac{3 \times (10^6)^2 \times 6.8\times10^{22}}{6.674\times10^{-11} \times 1.22\times10^{-19}} \times 10^6$$
...
$$\boxed{F_{\mathrm{UBii,virx}}^{Coma} \approx -2.5 \times 10^{60} \text{ N}}$$
...
$$F_{\mathrm{whim}}^{Coma} = 10^{-10} \times \frac{1.381\times10^{-23} \times 2\times10^6}{1.22\times10^{-19}} \times 10^{-12} \times 6.65\times10^{-29} \times 1.54\times10^{23} \times \sqrt{\frac{2\times10^6}{6\times10^6}}$$
...
### 4.2 F_{UBii\_virx} Calculation

$$F_{\mathrm{virx}}^{Virgo} = -10^{-10} \times \frac{3 \times (6\times10^5)^2 \times 4.6\times10^{22}}{6.674\times10^{-11} \times 1.22\times10^{-19}} \times 6\times10^5$$
...
$$\boxed{F_{\mathrm{UBii,virx}}^{Virgo} \approx -3.7{-}7.2 \times 10^{59} \text{ N}}$$
...
$$F_{\mathrm{lobe}}^{Virgo} = 10^{-10} \times \frac{10^{-13} \times 10^{60}}{1.22\times10^{-19}} \times 10^3 \times \frac{10^5}{3\times10^8} = 2.7\times10^{51} \text{ N}$$

---

## 5. Comparison Table

| Cluster | s_X (km/s) | r_h (Mpc) | T_ICM (keV) | M_500 (M?) | `F_{UBii\_virx}` (N) |
|---------|-----------|-----------|------------|-----------|----------------|
...
$$F_{\mathrm{UBii,virx}} = -\frac{G M_{\mathrm{vir}}^2}{r_h^2} \cdot \frac{F_{\mathrm{rel}}}{G \cdot E_{\mathrm{LEP}}} \cdot Q_{\mathrm{wave}}$$
...
$$M_{\mathrm{vir}}^{\mathrm{UQFF}} = \sqrt{\frac{|F_{\mathrm{UBii,virx}}| \cdot E_{\mathrm{LEP}} \cdot r_h}{F_{\mathrm{rel}}}}$$
...
*Validator: `BuoyancyProofVariants.py` ? Perseus `F_{UBii\_virx}` = -2.024$\times$106 N ? | $\kappa$ = 0.0005/day |
[SSq] = 0.57*
