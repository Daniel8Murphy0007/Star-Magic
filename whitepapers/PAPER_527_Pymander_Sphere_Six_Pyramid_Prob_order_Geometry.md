---
paper_id: PAPER_527
title: "Pymander Sphere Six-Pyramid Prob_order Geometry"
session: 142
date: 2026-03-25
...
This paper presents a UQFF analysis of Pymander Sphere Six-Pyramid Prob_order Geometry, deriving
...
$$\theta_text{pyramid} = \arccos!\left(\frac{1}{\sqrt{3}}\right) \approx 54.74°$$
...
| $\theta_text{pyramid} = \arccos(1/\sqrt{3})$ | Pyramid opening half-angle |
...
# result['Z_partition']     — VDS partition function \approx 0.570
