...
Derives the phonon-corrected neutron star spindown rate: Omega_{dot\_NS}^phonon = Omega_{dot\_NS} * (1 +
...
|-----------|---------|-------------|
| `Omega_{dot\_NS}` | -4.2e-15 | Base spindown (rad/s^2) |
...
| `Omega_{dot\_NS}` | Correction | Enhancement |
|--------------|------------|-------------|
...
- WSTP expression #31: Omega_{dot\_NS}^phonon
