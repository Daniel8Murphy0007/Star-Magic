---
paper_id: PAPER_353
title: "Double-Exponential Vacuum Decay Rate: \rho_SCm/\rho_UA Ratio with Near-Threshold Behavior"
session: 96
date: 2025-01-01
...
$$\rho_{\mathrm{ratio}} = \frac{\rho_{\mathrm{SCm}}}{\rho_{\mathrm{UA}}} = 0.1$$
...
vacuum oscillations do not diverge as t approaches the half-period. The outer `exp(−(\pi−t))` factor
...
**CP Implementation:** `DecayRateVacuumRhoRatioDoubleExpCalculator` (CondensedPhysics3.py, Session
96)
