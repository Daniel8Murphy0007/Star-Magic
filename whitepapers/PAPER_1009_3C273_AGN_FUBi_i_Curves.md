---
paper_id: PAPER_1009
title: "3C273 AGN F_{U\_Bi\_i} Curves — 3.1x Jet Modulation at Gamma = 0.05 THz"
session: 220
date: 2026-04-14
...
# PAPER_1009: 3C273 AGN F_{U\_Bi\_i} Curves — 3.1x Jet Modulation

## Abstract

We compute numerical F_{U\_Bi\_i} curves for the archetypal quasar 3C273 (z = 0.158, M_BH = 8.86 x 10^8
...
## 2. F_{U\_Bi\_i} Curve Construction

For each Gamma in the sweep, the unified buoyancy field is:

F_{U\_Bi\_i}(Gamma) = [Ug1 + Ug2 + Ug3(Gamma) + Ug4] * M_jet(Gamma) * (1 + BETA_I * S26_3)
...
File: `fubi_{i\_curves\_agn\_ns\_qgp}.py`, class `ThreeCTwoSevenThreeAGNCurvesCalc`. CP4 class #593.
Tests: 8/8 pass.
...
8. Schmidt, M. (1963). *3C 273: A star-like object with large red-shift.* Nature **197**, 1040 — doi:10.1038/1971040a0
9. Richards, G.T. et al. (2006). *The Sloan Digital Sky Survey Quasar Survey.* AJS **166**, 470 — arXiv:astro-ph/0601434 — doi:10.1086/506525
10. Goldstein, A. et al. (Fermi GBM, 2017). *An Ordinary Short GRB with Extraordinary Implications: Fermi-GBM Detection of GRB 170817A.* ApJL **848**, L14 — arXiv:1710.05446 — doi:10.3847/2041-8213/aa8f41
11. Kouveliotou, C. et al. (1993). *Identification of two classes of gamma-ray bursts.* ApJL **413**, L101 — doi:10.1086/186969
