...
**Source:** grok_{share\_c020496d9e}.txt — 26-layer resonance framework (lines 168–237, Session 114
...
- `compute_{rho\_transition}(i, rho_{UA\_prime}, rho_SCm, rho_UA, SSq, t_n)` $\to$ transition density
- `compute_{full\_R}(t, params)` $\to$ full 26-layer resonance sum $R(t)$
...
*Extracted from grok_{share\_c020496d9e}.txt lines 168–237 (Session 114). The 26D layer table provides
