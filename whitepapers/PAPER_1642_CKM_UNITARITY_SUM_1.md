# PAPER_1642 — CKM Matrix Row-1 Unitarity = |V_ud|² + |V_us|² + |V_ub|² = 1 via F_U = 1 ledger
...
PAPER_1307 (broader-corpus paper outside PAPER_1209 unified-proof-set series) gives:

```
|V_ud|² + |V_us|² + |V_ub|² = 1 via F_U = 1 ledger
```
...
```
|V_ud|² + |V_us|² + |V_ub|² = 1 via F_U = 1 ledger    EXACT
```
...
- Calculator dispatch: `calculate_paradox({"paradox": "ckm_unitarity_sum_1"})`
