...
| System frequency | ω₀ | 10⁻¹² | rad/s | Same as SNR equivalence class |
...
```
F_LENR / F_DE(Kepler) = 6.17×10³⁹ / 10 = 6.17 × 10³⁸
F_LENR / F_DE(SN1006) = 6.17×10³⁹ / 100 = 6.17 × 10³⁷
```
...
At the time of SN 1604, Johannes Kepler had no knowledge of quantum mechanics, phonon coherence, or LENR physics. Yet the UQFF framework retroactively applies to the Kepler remnant: the ω₀ = 10⁻¹² characteristic frequency of the expanding shell was present from the moment of explosion. The equivalence class membership of Kepler's SNR is a physical fact independent of when, or whether, it was observed.
...
| System | ω₀ (rad/s) | F_U_Bi (N) | Class |
|--------|-----------|------------|-------|
| SN 1006 (PAPER_250) | 10⁻¹² | +2.11×10²⁰⁸ | Positive |
| Eta Carinae (PAPER_251) | 10⁻¹² | +2.11×10²⁰⁸ | Positive |
| Chandra Archive (PAPER_252) | 10⁻¹² | +2.11×10²⁰⁸ | Positive |
| **Kepler SNR 1604 (PAPER_254)** | **10⁻¹²** | **+2.11×10²⁰⁸** | **Positive** |
| Sgr A* (PAPER_253) | 10⁻¹⁵ | −8.31×10²¹¹ | **NEGATIVE** |

All four ω₀ = 10⁻¹² systems share identical F_U_Bi. Sgr A* alone (ω₀ = 10⁻¹⁵) departs from the class.

---

## 3. Force Equivalence Distance-Independence Theorem

**Theorem (UQFF Distance-Independence):** The UQFF buoyancy force F_U_Bi for ω₀ = 10⁻¹² systems is independent of distance. For any two Type Ia SNRs at distances d₁ and d₂ with the same ω₀:

1. `L_X(d₁)/L_X(d₂) = (d₂/d₁)²` — luminosity varies by the inverse-square law.
2. `F_DE(d₁)/F_DE(d₂) = L_X(d₁)/L_X(d₂)` — proportional to luminosity.
3. `F_LENR/F_DE(dₙ) = k_LENR(ω_LENR/ω₀)² / (k_DE·L_X(dₙ))` → increases with d² (farther = more L_X faded = more F_LENR dominant).
4. F_U_Bi is the same for all such SNRs.

The UQFF Force Equivalence Class is a **distance-independent conserved quantity** of Type Ia SNR physics in the ω₀ = 10⁻¹² regime.

---

## 4. Observational Predictions / Validation

- **JWST NIRCam Kepler Survey:** The UQFF ejecta knot stabilisation prediction (F_neutron = 10⁶ N) implies coherent structures at the 10¹–10² m scale surviving 420 years of expansion at 4,000 km/s — testable with JWST sub-arcsecond resolution at 20,000 ly.
...
- **Historical comparison:** The Cygnus Loop, Cas A, and Tycho's remnant are additional Type Ia/core-collapse SNRs that should, if their ω₀ ≈ 10⁻¹², be members of the same equivalence class. UQFF calculation for these three systems would extend the equivalence class to 7+ members.
