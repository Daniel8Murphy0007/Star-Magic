...
$$
\begin{aligned}
  & g_Magnetar(t) = [G\cdot M / r2] \times (1 + H0\cdot t) \times (1 - B(t)/B_crit) \\
  & + [Ug1 + Ug4] \\
  & + GW_term(t) \\
  & B(t) = B_0 \times exp(-t / \tau_B) \\
  & \Omega(t) = \Omega_0 \times exp(-t / \tau_spin) \\
  & GW_term(t) = (32\cdot G4\cdot M3\cdot r2\cdot\Omega4) / (5\cdot c5\cdot r4)  [GR quadrupole]
\end{aligned}
$$
...
\begin{aligned}
  ...
  & g_Magnetar(t=5kyr) \approx (G\cdot M/r2) \times 0.97135 \times (1 + H0\cdot t) \\
...
11. Goldreich, P. & Julian, W.H. (1969). *Pulsar Electrodynamics.* ApJ **157**, 869 — doi:10.1086/150119
