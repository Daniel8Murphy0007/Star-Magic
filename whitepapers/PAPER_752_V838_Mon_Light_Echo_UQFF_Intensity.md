---
paper_id: PAPER_752
title: "V838 Mon Light Echo — UQFF Intensity Propagation"
session: 181
date: 2026-01-01
...
$$
\begin{aligned}
  & I_echo(r, t) = [L_outburst / (4\pi\cdot(c\cdot t)2)] \\
  & \times \sigma_scatter \\
  & \times \rho_dust(r, t) \\
  & \times (1 + f_TRZ) \\
...
\begin{aligned}
  ...
  & Ug1(r, t) = G\cdot M_star / r2  \times (1 + \mu_J\cdot B2/(\rho\cdot c2))
\end{aligned}
$$
