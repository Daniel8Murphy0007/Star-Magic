# PAPER_1260 — Sgr A* Flares via DPM Grinding Cycle on Event Horizon
...
DPM Grinding Cycle on Event Horizon

The closure helper `_l96_uqff_axiom_sgr_a_star_flares_closure()` evaluates this derivation. Output dict carries:
...
result = u.calculate_paradox({"paradox": "sgra_flares"})['value']
```
...
- Closure location: `uqff_pure_calculator.py` → `_l96_uqff_axiom_sgr_a_star_flares_closure`
- Dispatch: `PARADOX_TO_CLOSURE["sgra_flares"]`
