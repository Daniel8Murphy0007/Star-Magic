...
result = calc.compute()
# result['YM_{mass\_gap\_GeV2}']      — Yang-Mills mass gap (GeV2)
# result['YM_{lattice\_ratio}']      — UQFF / Lattice QCD ratio
# result['Riemann_{t1\_approx}']     — Estimated first zero Im(\rho₁)
# result['PneNP_separation']      — 2^26 / 26^4 ratio
# result['NS_{DPM\_Hbound}']         — NS H1 DPM regularity bound
