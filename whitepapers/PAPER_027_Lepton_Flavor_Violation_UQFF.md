...
$$
A non-zero a_τ deviation from the SM would signal partial DPM activation — a non-zero vacuum
...
ready for integration into the MAIN_1_CoAnQi.cpp validation pipeline.
