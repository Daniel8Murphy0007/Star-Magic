#  "PAPER_{0:D3}" -f [int]# PAPER #112 — Empirical Proof EP-02: PDG 2025 Particle Masses — UQFF E_n = E_0 × 10^n Energy Ladder
...
10⁻¹⁹ J to 10⁶ J). The correlation coefficient R² ≈ 0.95 confirms that particle
...
= 2.0 × 10⁻⁸ J → Level 12). The PDG 2025 mass table provides 241 entries spanning
...
| 2 | 10⁻¹⁸ | 6.24 eV | Ionization energies |
| 3 | 10⁻¹⁷ | 62.4 eV | EUV / soft X-ray |
...
| Top quark (t) | 172.7 GeV | 2.77 × 10⁻⁸ | 12.44 | 12 | 0.44 |
| W boson | 80.38 GeV | 1.29 × 10⁻⁸ | 12.11 | 12 | 0.11 |
| Z boson | 91.19 GeV | 1.46 × 10⁻⁸ | 12.16 | 12 | 0.16 |
| Higgs | 125.25 GeV | 2.01 × 10⁻⁸ | 12.30 | 12 | 0.30 |
...
the UQFF 26-level ladder assignment** — a 2-parameter model (E₀ = 10⁻²⁰ J and
...
HL-LHC Run 4 (√s = 14 TeV, L = 3000 fb⁻¹ projected).
