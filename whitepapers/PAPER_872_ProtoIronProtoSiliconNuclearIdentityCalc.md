...
Maps proto-atomic nuclei to their heavier-element identity via DPM proportions. Proto-hydrogen
nucleus = proto-iron (Z_identity=26, SM_magnetic, durable strong-force shell). Proto-helium nucleus
= proto-silicon (Z_identity=14, SM_non-magnetic). Odd Z -> SM_magnetic; even Z -> SM_non-magnetic.
