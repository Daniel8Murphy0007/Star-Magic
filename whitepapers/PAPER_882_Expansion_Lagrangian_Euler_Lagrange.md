...
**Significance:** Variational formulation of the expansion engine. The Lagrangian approach provides not just equations of motion but also conserved quantities (Noether currents), stability analysis (second variation), and natural coupling to other fields — essential for the complete UQFF field theory.
...
This paper maps to **expansion-variational sector** of the 9-sector UQFF Lagrangian (see `uqff_lagrangian_derivation.py`).
