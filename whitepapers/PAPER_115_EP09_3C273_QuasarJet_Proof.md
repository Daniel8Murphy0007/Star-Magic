#  "PAPER_{0:D3}" -f [int]# PAPER #115 — Empirical Proof EP-09: 3C 273 Quasar Jet Brightness Asymmetry — UQFF Ub_i Buoyancy
...
cos(ωt_n) sign reversal, the 3C 273 case requires multiple sequential t_n reversals
...
contrast. Cross-validation with relativistic Doppler beaming (Γ ~ 8–10 from VLBI)
...
| Black hole mass | M_BH ≈ 6–9 × 10⁸ M☉ | GRAVITY (2018) |
| Bolometric luminosity | ~4.7 × 10³⁸ W | Courvoisier (1998) |
| VLBI jet Lorentz factor | Γ ≈ 8–12 | Jorstad et al. (2017) |
| Viewing angle θ_jet | 5–10° | MOJAVE VLBI monitoring |
...
| Apparent superluminal motion | β_app ≈ 12c (knots) | Unwin et al. (1985) |
...
| Mechanism | cos(ωt_n) sign change | [SSq]^n amplification |
| Γ factor | ~1–2 (non-relativistic) | ~8–12 (relativistic) |
...
For random phase sampling with ⟨|cos(ωt_k)|⟩ ≈ 2/π ≈ 0.637:
...
through each of the N = 12 reversal events over the ~2 × 10⁸ yr jet lifetime.
...
For Γ = 10, θ = 5°, spectral index α = 0.7:
...
magnitude, requiring either low Γ or large θ. The UQFF model provides the physical
...
| Phase sampling σ=0.2 | 13 | 102–168 | > 100 | ✅ PASS |
...
At κ = 0.0005/day = 0.1825/yr, the e-fold time is τ = 1/κ ≈ 5.5 yr.

The t_n reversal period >> τ, confirming each reversal represents a fully-evolved
...
| 3 | $U_{b,i}(65\text{ kpc})$ | 6.14 × 10⁻¹⁴ N/m² | 3C273 jet scale |
| 4 | $R_{Doppler}$ (Γ=10, θ=5°) | ~2 × 10⁷ | Beaming reference |
| 5 | UQFF floor R < Doppler | 130 << 2×10⁷ | Physical minimum |
| 6 | $\Delta t_n$ reversal period | 2.3 × 10⁴ yr | Jet t_n cadence |
...
4. The mechanism is independent of Lorentz factor Γ — it comes from cumulative
