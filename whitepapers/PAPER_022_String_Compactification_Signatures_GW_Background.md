...
**Primary Validation File:** `validate_{string\_compact\_uqff}.py`
...
**Validation file:** `validate_{string\_compact\_uqff}.py`
**C++ Sources:** `source27.cpp`, `source28.cpp`, `MAIN_{1\_CoAnQi}.cpp` (SOURCE4 namespace)
