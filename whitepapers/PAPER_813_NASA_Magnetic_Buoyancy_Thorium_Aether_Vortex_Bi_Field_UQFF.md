...
This represents a 16.7% weight reduction (5/6 compensation → 1/6 uncompensated, yielding net $g_{eff} = g - 1.35 = 8.46$ m/s2). The magnetic bubble acceleration:
...
Numerical estimate (at r = 6.371×106 m, Earth surface):
- $g_{UQFF}$ ≈ 9.81 m/s2
- $Thorium\_effect$ ≈ 5×102 m/s2 (at high neutron flux)
- $Magnetic\_buoyancy$ ≈ 1.35 m/s2
- $g_{aether}$ ≈ 10-13 m/s2 (background)
- $g_{Bifield}$ ≈ 10-10 m/s2 (at rest)
