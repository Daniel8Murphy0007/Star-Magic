...
Resonance Zone (TRZ) emission. Batch 21 of MAIN_1_CoAnQi.cpp implements the `NeutrinoSEDModule`
...
$$\Phi_nu^{\rm UQFF}(E_\nu) = \Phi_nu^{\rm SM}(E_\nu) \times (1 + f_{\rm TRZ}) = 1.01 \times \Phi_nu^{\rm SM}(E_\nu)$$
...
$$\Delta \Phi_nu^{Ug4}(E_\nu) = f_{Ug4} \cdot \Phi_nu^{\rm SM} \cdot \frac{U_{g4}}{U_{g4,\rm ref}}$$
...
$$(\nu_e : \nu_mu : \nu_tau)_{\rm UQFF} = (1 : 1 : 1) \times (1 + 0.001 \, f_{\rm TRZ})$$
...
*Source: `MAIN_1_CoAnQi`.cpp Batch 21 (NeutrinoSEDModule) | validate_phase3.py | f_TRZ = 0.01 |
IceCube constraints*
