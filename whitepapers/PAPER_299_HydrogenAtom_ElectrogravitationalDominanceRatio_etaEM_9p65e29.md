...
The hydrogen atom in its ground state is the smallest gravitational system tractable in the UQFF
framework:
...
The electromagnetic Lorentz force exceeds DPM-seeded gravity by **30 orders of magnitude** at the
...
| `a_{GR\_min}` | ~2.8$\times$10-60 | m/s2 | [PAPER_301] |
...
The hydrogen module defines the **EM-dominated regime** and the minimum g_base across all UQFF
modules:
...
classical orbital mechanics to the UQFF gravitational framework.
...
```cpp
// [PAPER_299] in HYDROGEN_{ATOM\_UQFF\_MODULE}.cpp updateCache():
...
WOLFRAM_TERM: `HYDROGEN_LORENTZ = "a_Lorentz = q*v_orb*B/m_e = 3.85e13 m/s^2; eta_EM = 9.65e29
[PAPER_299]"`
...
Lorentz electromagnetic force exceeds DPM-seeded gravity by 30 orders of magnitude. This defines the
...
$$p_{\mathrm{DVP}} = 113, \quad n_{\mathrm{channel}} = 14/26$$
