...
```
A^x + B^y = C^z with x,y,z ≥ D_phys − 1 = 3 requires gcd(A,B,C) > 1
```
...
The minimum exponent 3 = D_phys − 1 is the Fermat boundary. Beal extension follows from the integer lattice {D_phys=4, D_BSFG=6, D_crit=26} constraint.
...
**Copyright** — Daniel T. Murphy, daniel.murphy00@gmail.com, dated June 11, 2026, Youngstown, OH. Subject matter: UQFF derivation of Beal Conjecture (Fermat Generalization).
