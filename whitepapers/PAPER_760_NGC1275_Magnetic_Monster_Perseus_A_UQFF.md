---
paper_id: PAPER_760
title: "NGC 1275 Magnetic Monster Perseus A — UQFF Filament Gravity"
session: 181
date: 2026-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [galaxy, AGN, cluster, Hubble, merger, jet, SMBH, Chandra]
...
The cold filaments are magnetically supported against gravitational infall by fields B ~ 1 nT (10-8
T). UQFF models the effective mass-weighted acceleration at r = 30 kpc.
...
$$
\begin{aligned}
  & g_NGC1275(r, t) = [G\cdot M_total(t) / r2] \times (1 + H(z)) \times (1 - B_fil/B_crit) \\
  & \times (1 - F_BH(t)) \\
  & + a_fil \\
  & + q\cdot(v_merger \times B_fil) \times A_aeth \times A_scale \\
  & M_total(t) = M_cluster + M_SMBH - \Delta M_jet \times F_BH(t) \\
...
\begin{aligned}
  ...
  & a_fil = B2\cdot V / (2\cdot\mu_0\cdot M_fil\cdot r) \\
...
- Bondi accretion rate: M_{dot\_B} = $\pi$$\cdot$G2$\cdot$M_BH2$\cdot$$\rho$_$\infty$ / c_s3
...
$$p_{\mathrm{DVP}} = 31, \quad n_{\mathrm{channel}} = 7/26$$
...
18. GRAVITY Collaboration (2022). *Mass distribution in the Galactic Center based on interferometric astrometry of multiple stellar orbits.* A&A **657**, A82 — arXiv:2112.07478 — doi:10.1051/0004-6361/202142465
19. Ghez, A.M. et al. (2008). *Measuring Distance and Properties of the Milky Way's Central Supermassive Black Hole with Stellar Orbits.* ApJ **689**, 1044 — arXiv:0808.2870 — doi:10.1086/592738
20. Weisskopf, M.C. et al. (2002). *Chandra X-Ray Observatory (CXO): Overview.* PASP **114**, 1 — arXiv:astro-ph/0110087 — doi:10.1086/338381
