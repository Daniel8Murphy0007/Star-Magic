...
| `M_{chirp\_solar}` | 1.188 M_sun | Chirp mass |
...
$$\boxed{{\mathrm{SNR}}_{\mathrm{UQFF}} = {\mathrm{SNR}}_{\mathrm{GR}} \cdot (1 - D_{\mathrm{phonon}})}$$
...
$$p_{\mathrm{DVP}} = 5, \quad n_{\mathrm{channel}} = 22/26$$
...
| DVP prime | $p_k \in$ {2,3,...,113} | $p_{\mathrm{DVP}} = 5$ | PASS Lattice-consistent |
