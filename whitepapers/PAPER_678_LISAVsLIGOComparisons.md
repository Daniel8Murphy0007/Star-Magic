...
$$
R_{\text{supp}}(f) = (1-f_{\text{TRZ}}) \cdot S_{\text{SCm}} \cdot \min(S_{U\_m}, S_{\text{UA,LISA}})
$$
...
$$p_{\mathrm{DVP}} = 67, \quad n_{\mathrm{channel}} = 3/26$$
