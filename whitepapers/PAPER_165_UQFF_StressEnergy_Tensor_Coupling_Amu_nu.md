...
| η         | 1×10-22                 | UQFF coupling constant [m2/(J·s2)]       |
| T_s00     | 1.27×103 + 1.11×107     | Combined plasma/SCm stress energy [Pa]   |
...
- T_plasma = 1.27×103 Pa: Coronal plasma pressure at T~106 K, ρ~10-12 kg/m3
- T_SCm = 1.11×107 Pa: SCm magnetic pressure = B2/(2μ₀) at B~5T
...
This is ~4 orders of magnitude above the wormhole term (PAPER_159: 7.09×10-36) but
~1043 orders smaller than F_U(Sun) = −2.064×1059, making it a **fine-structure correction**.
...
1. **Plasma-gravity feedback**: High-temperature plasma (T_s00 via T_plasma) warps local
   spacetime through the UQFF coupling, beyond standard GR (where ρ~10-12 kg/m3 is negligible)
