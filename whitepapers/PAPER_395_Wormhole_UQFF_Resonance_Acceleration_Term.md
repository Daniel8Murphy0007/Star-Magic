---
paper_id: PAPER_395
title: "Wormhole UQFF Acceleration: 13th Resonance Term a_worm = f_worm\cdotE_{vac\_neb}/(b2+r2)"
session: 107
date: 2025-01-01
...
# PAPER_395 — Wormhole UQFF Acceleration: 13th Resonance Term a_worm = f_worm$\cdot$E_{vac\_neb}/(b2+r2)
**Author:** Daniel T. Murphy
**Date:** 2025

**Source:** grok_{share\_cfdcad2f5}.txt, lines ~900–1300 (C++ unit tests + MUGE.h)  
...
f_worm$\cdot$E_{vac\_neb}/(b2+r2), deriving compressed field equations and observational predictions within
...
The formula appears in the C++ `compute_{a\_wormhole}()` function and its unit test, both
explicitly in the grok_{share\_cfdcad2f5} thread.
