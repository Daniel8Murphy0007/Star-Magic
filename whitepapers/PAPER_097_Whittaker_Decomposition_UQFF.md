...
reproducing the full UQFF field F_U. `validate_drawings_models.py` implements
`WHITTAKER_MODEL.validate_Whittaker_model()`, which confirms the decomposition is complete (?f_k +
