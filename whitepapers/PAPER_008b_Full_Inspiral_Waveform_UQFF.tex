...
\begin{enumerate}
  ...
  \item \verb|validate_{gw170817\_full}.py| --- UQFF inspiral waveform simulation, 1000-step, 100s
\end{enumerate}

\noindent\rule{\textwidth}{0.4pt}

\textbf{Validator:} \verb|validate_{gw170817\_full}.py| --- \textbf{TEST PASSED} (7/7 checks) *Peak GR = 5.8791e-17, Peak UQFF = 1.9596e-17; Combined damping = 0.333 (TRZ=0.90 $\times$ String=0.37); SNR: 32.4 ? 10.8; Phase lag: 2310.8 rad = 367.8 cycles; GW cycles: 3677; $\kappa$ = 0.0005/day, [SSq] = 0.57*
