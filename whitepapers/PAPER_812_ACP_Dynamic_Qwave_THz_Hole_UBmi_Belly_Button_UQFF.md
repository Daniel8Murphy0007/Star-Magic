...
**Source**: grok_share_0d888ea9-50be.txt (June 13, 2025 02:03 AM)
...
where:
- $k_{Ub}$ = buoyancy coupling constant ≈ 10-113 (see [SSq] calibration)
- $f_{UB,mi}$ = UB_mi resonance frequency = 1.25×1012 Hz (same as THz PI hole)
