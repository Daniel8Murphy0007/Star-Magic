...
$$UB_{mi} = \left[(-UA_{THz,hole}) + \text{"belly\_button(static*\_SMBH\_dark)"}\right]$$
...
where:
- $k_{Ub}$ = buoyancy coupling constant ≈ 10⁻¹¹³ (see [SSq] calibration)
- $f_{UB,mi}$ = UB_mi resonance frequency = 1.25×10¹² Hz (same as THz PI hole)
...
**New term registered**: $UB_{mi}$ belly button = $-3.08 \times 10^{-18}$ J/m³
