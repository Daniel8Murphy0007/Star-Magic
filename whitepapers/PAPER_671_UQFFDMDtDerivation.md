---
paper_id: PAPER_671
title: "UQFF dM/dt Derivation"
session: 0
date: 2026-04-02
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [TDE, Hawking, SCm, black-hole, UQFF]
sm_anchor: "CVW v2.0.0 — G6 SM Anchor Gate compliant"
---

# PAPER_671: UQFF dM/dt Derivation
**Author:** Daniel T. Murphy
**Subtitle:** Full step-by-step derivation of the UQFF-modified mass loss rate, with analytic M(t)
approximation and Euler simulation.
...
## Abstract
We present the complete three-step UQFF derivation of the modified black hole mass loss rate dM/dt,
showing a ~33× suppression relative to standard Hawking emission.
...
Suppression factor: 0.9 × 0.1 × e-1 ≈ **0.033**  (evaporation ~30× slower).

## 6. Analytic Approximation
$$M(t) \approx \left(M_0^3 - 3A\,t\right)^{1/3}$$

where A = |dM/dt|_UQFF × M₀2.
