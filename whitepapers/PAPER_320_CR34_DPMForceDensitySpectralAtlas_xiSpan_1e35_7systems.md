---
paper_id: PAPER_320
title: "CR34: 7-System DPM Force Density Spectral Atlas (\xi-Span = 1035)"
session: 92
date: 2026-03-18
...
$$
\begin{aligned}
  & \text{WOLFRAM\_TERM\_CR34\_DPM\_SPECTRAL\_ATLAS}: \\
...
- **PAPER_321**: V_{f\_crossover}=5.43e28 m3/Hz — uses same CR34 systems
- **PAPER_322**: Orion/Lagoon THz differential (uses A_{vort\_34}/A_{vort\_30} — same table)
...
$$p_{\mathrm{DVP}} = 73, \quad n_{\mathrm{channel}} = 9/26$$
