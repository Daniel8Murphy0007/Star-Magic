...
**Source**: grok_{share\_0d888ea9}-50be.txt (June 13, 2025 04:45 PM);
"Accessing_{a\_New\_Population\_of\_Supermassive\_Black\_H}.pdf" (ApJ May 2025)
...
| Source | $\log M_\bullet/M_\odot$ | $D$ (Mpc) | $\theta_{ring}$ (\muas) | $f_{Edd}$ |
|--------|-------------------------|-----------|----------------------|----------|
...
- **ngEHT**: ~15 G$\lambda$ at 1.3 mm (EHT $\times$5 baselines), resolves $\theta \geq$  a few \muas
- **BHEX**: Space-based, planned 350+ G$\lambda$, resolves 0.1 \muas class structures
