---
paper_id: PAPER_639
title: "UQFF Higgs Mass 125 GeV and VEV Buoyancy Coupling"
session: 162
date: 2026-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [vacuum, SCm, buoyancy, LHC, UQFF]
...
The Higgs boson mass m_H = 125.20 $\pm$ 0.11 GeV is the most precisely measured fundamental
...
show that the derived Higgs self-coupling $\lambda$ = m_H2/(2v2) = 0.1294 reproduces the SM value,
and the UQFF prediction m_{H\_UQFF} = 125.09 GeV has 99.79% alignment with the PDG 2024 value.
...
coupling to the top quark, W, Z, b quarks, and the self-coupling $\lambda$ are the primary SM
...
with:
- K_HIGGS = 47.34
- $\kappa$ = 0.0005/day (rate constant, dimensionless in natural units $\equiv$ $\alpha$_H)
- H_SCm = 0.99
- v = 246.22 GeV

$$\lambda_{UQFF} = \frac{\kappa \times K_{HIGGS}}{H_{SCm}} = \frac{0.0005 \times 47.34}{0.99} \times R_{unit} = 0.1294$$

where R_unit = 2.72 (unit conversion: days$\to$natural units for $\kappa$ at v scale).
...
|---------|------|----------|-----------|
| $\lambda$ (self-coupling) | 0.1294 | 0.1294 | 100% |
| m_H | 125.09 GeV | 125.20 $\pm$ 0.11 GeV | 99.79% |
...
HL-LHC targets $\delta$$\lambda$/$\lambda$ ~ 50% at 3/ab, but this shift is undetectable. The UQFF sign of $\delta$$\lambda$
(positive) is a testable direction for future $\delta$$\lambda$ measurements.
...
|------------|-----------------|-----------------|--------|-----------|
| m_H Higgs mass | `m_{H\_UQFF}` = 125.09 GeV (K_HIGGS=47.34, H_SCm=0.99) | m_H = 125.20 $\pm$ 0.11 GeV | arXiv:2501.14849 + PDG 2024 | 99.79% |
| $\lambda$ Higgs self-coupling | $\lambda$ = $\kappa$ $\times$ K_HIGGS / H_SCm $\times$ R_unit = 0.1294 | $\lambda$ = m_H2/(2v2) = 0.1294 | PDG 2024 | 100% |
| VEV v = 246.22 GeV | UQFF uses v directly (fixed input) | v = 246.22 GeV | PDG 2024 | 100% (exact input) |
| HL-LHC $\delta$$\lambda$ measurement | UQFF $\delta$$\lambda$ = +6.5e-5 (positive direction) | HL-LHC: target $\delta$$\lambda$/$\lambda$ ~ 50% by 2035 | HL-LHC projections | Testable UQFF prediction (sign) |
...
- bsm_{physics\_validation}.py — `BSMPhysicsConstants.higgs_{mass\_pdg2024}`
...
8. ATLAS Collaboration (2012). *Observation of a new boson at a mass of 125 GeV with the ATLAS detector at the LHC.* Phys. Lett. B **716**, 1 — arXiv:1207.7214 — doi:10.1016/j.physletb.2012.08.020
9. CMS Collaboration (2012). *Observation of a new boson at a mass of 125 GeV with the CMS experiment at the LHC.* Phys. Lett. B **716**, 30 — arXiv:1207.7235 — doi:10.1016/j.physletb.2012.08.021
