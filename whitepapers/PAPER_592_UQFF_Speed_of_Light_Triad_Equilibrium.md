...
methods: (1) pre-mass triad equilibrium, (2) F_U_Bi_i Gaussian BH26 anchor, and
...
## §3 Method 2 — F_U_Bi_i Gaussian BH26 Anchor (μ = 92 GHz)

The F_U_Bi_i Gaussian (PAPER_583 Form 6) is anchored at $\mu = 92\text{ GHz}$ (BH26 bin 1)
...
|--------|-------------|--------|
| Triad Equilibrium | $c = \sqrt{g \cdot SCm/UA}$ | $3\times10^8$ m/s ✓ |
| BH26 Gaussian Anchor | $c = \sqrt{g\sigma/\mu}$ (calibrated) | $3\times10^8$ m/s ✓ |
| Resonant $\omega$-scale | $c = r\omega\sqrt{26}/\kappa$ | $3\times10^8$ m/s ✓ |
