...
**Date:** March 7, 2026  
**Source Data:** `run_{121\_system\_validation}.py`, `experimental_validation_system.py`,
`uqff_validation_test.py`, `debug_validation.py`, `MAIN_{1\_CoAnQi\_integration\_status}.json`  
...
| `uqff_validation_test.py` | 5 systems | 5 $\times$ 100 MC | Monte Carlo numeric stability |
...
The high stability reflects the dominance of the LENR resonance term in F_U_Bi_i, which depends on
...
*Source: run_{121\_system\_validation}.py, experimental_validation_system.py, uqff_validation_test.py,
