...
| Cosmological | 3 | CMB ΛCDM, Hubble tension | Buoyant |
...
| RDR-004 | Net Energy (%) | 15.0 | 12.3 | 18.0% | ⚠️ |
...
| GC-OMEGA-001 | ω Cen v_disp | 18.7 km/s | 18.2 km/s | 2.75% | ✅ |
| GC-OMEGA-002 | ω Cen M_BH | 4.2×10⁴ M☉ | 4.0×10⁴ M☉ | 5.00% | ✅ |
| 26D-L13-001 | Layer 13 [SCm] | 7.09e-37 J/m³ | 6.95e-37 J/m³ | 2.01% | ✅ |
| 26D-L18-001 | Higgs mass | 125.09 GeV | 125.35 GeV | 0.21% | ✅ |
| 26D-L26-001 | Layer 26 Λ | 5.4e-10 J/m³ | 5.96e-10 J/m³ | 9.40% | ✅ |
...
| Helix Nebula | −2.30×10¹⁹⁴ | ~6.9×10¹⁹² | **~0.97** | 100 | ✓ STABLE |
...
The high stability reflects the dominance of the LENR resonance term in F_U_Bi_i, which depends on ω_LENR/ω_0 — a ratio of fixed frequencies, unaffected by M, r, L_X, B0 noise.
...
| Time-varying | M_sun at AU, t=10¹⁰ yr | δg > 10⁻¹² | — | ✅ |
...
| Volume breathing | t=10⁹ yr change | δF/F > 10⁻⁶ | ✅ |
| Magnitude | |F| | 10¹⁰ < |F| < 10⁵⁰ ✅ |
...
*Source: run_121_system_validation.py, experimental_validation_system.py, uqff_validation_test.py, debug_validation.py | κ = 0.0005/day | [SSq] = 0.57*
