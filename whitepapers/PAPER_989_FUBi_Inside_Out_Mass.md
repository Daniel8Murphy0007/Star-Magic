...
The buoyancy ratio measures what fraction of the gravitational-buoyancy system is dominated by
outward buoyancy:
...
**Sector:** SCm-phonon (vacuum phonon coupling)
...
PAPER_877 axioms $\to$ SCm vacuum $\to$ phonon $\omega_{\text{SCm}}$ $\to$ vacuum phonon coupling $\to$ $F_{U,Bi\_i}$ unified force $\to$ observational prediction
