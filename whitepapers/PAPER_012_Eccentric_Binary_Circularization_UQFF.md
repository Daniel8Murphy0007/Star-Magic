...
(D$\kappa$_total < 1) slows circularization timescales. For typical BNS systems entering LIGO band with e0
...
**de/dt = -(304/15) (G/c5) (m1m2M_tot)/(a4(1-e)^(5/2))  e  (1 + 121/304 e)  D$\kappa$_total**
...
UQFF reduces GW energy loss by factor D$\kappa$_total = 0.111 for BNS (0.333), extending circularization
...
**Validator:** `validate_{eccentric\_binary}.py` (see `source27.cpp` Eccentric BNS module)
...
Key findings:
1. **Circularization timescale:** 9 longer (106 ? 9$\times$106 yr for BNS)
...
**Forward link (this paper):** Eccentric remnants ring down through the same channel as quasi-circular remnants. PAPER_1175 (P11) ringdown spectral ratio test applies to the residual-eccentricity prediction e$_f$ derived here; PAPER_1174 (P6, sub-mm Yukawa L$_{KK}^* = 20$-$90$ $\mu$m) provides an orthogonal lab test of the KK tower that contributes to the circularization rate.
