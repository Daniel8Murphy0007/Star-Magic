...
For filament volume V ~ 1048 mณ (100 pc ื 1 pc ื 1 pc):
...
For small erosion |E_0 t| ซ 1, this produces a time-dependent weakening consistent with filament aging observations.
...
| F_mag | BฒV/(2ต0) | 3.98ื104ณ N (filament volume) |
| F_U_Bi_i | UQFF full | -8.32ื10ฒน7 N |
...
**UQFF computed:** Eddington luminosity UQFF correction = 1 - [SSq]ืexp(-?ื?t) = 1 - 5.7e-1 ื exp(-2.9e-4) = 4.3e-1; F_U at event horizon = 2.0e+18 m/sฒ.