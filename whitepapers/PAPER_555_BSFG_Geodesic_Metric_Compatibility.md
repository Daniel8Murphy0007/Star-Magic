...
with orbital velocity correction $v^2_{\rm orbit} = \mu_s\nabla(M_s/r) + r\,c^2\,\varepsilon'(r)/2$. At $r = R_\odot$: $|\Delta g_r| \approx 2.73 \times 10^{-11}\ {\rm m/s}^2 \approx 10^{-13}\,g_{
