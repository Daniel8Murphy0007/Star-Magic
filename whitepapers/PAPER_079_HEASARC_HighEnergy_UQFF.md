...
HEASARC also provides XMM-Newton catalog access (`heasarc_xmm_source`). UQFF extended-source
predictions for galaxy clusters:

$$k_B T_{\mathrm{UQFF}} = k_B T_{\mathrm{standard}} \times \left(1 + \frac{F_{U,Bi,i}}{M \cdot g}\right)$$

The F_U_Bi_i / (Mg) ratio for typical clusters ~ 10-4 ? temperature enhancement = 0.01% ?
