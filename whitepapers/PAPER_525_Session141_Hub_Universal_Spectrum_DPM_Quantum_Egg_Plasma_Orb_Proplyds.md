...
| Buoyancy Harmonics | $U_{g2} = \sum H_m(1-e^{-[SSq]\cdot m})\cos(\omega t_n)$ | $Resonance_\text{harm} \left\rightarrow Buoy_\text{grad}$ harmonic correspondence; same damping in $US_\text{egg}$ integral |
