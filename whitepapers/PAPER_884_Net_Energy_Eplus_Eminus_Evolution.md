...
**Significance:** The E_net identity unifies expansion and erosion into a single master equation. This is conceptually analogous to combining F_gravitational and F_buoyancy in fluid mechanics — but here the 'fluid' is the SCm vacuum and the buoyancy ratio R replaces the Archimedes condition.
...
This paper maps to **net-energy sector** of the 9-sector UQFF Lagrangian (see `uqff_lagrangian_derivation.py`).
...
|-----------|----------------|------------|--------|
| VDS ratio | $\rho_{\rm SCm}/\rho_{\rm UA} = 1.894$ | Local sub-ratio = 0.15 | ✓ Threshold-consistent |
