---
paper_id: PAPER_314
title: "NGC6302 Bipolar PN Lobe DPM Macro-Antenna Force: F_DPM = 1.267\times105 N (13-Order PN-to-Compact
Amplification)"
session: 0
date: 2026-03-17
...
**WOLFRAM_TERM:** NGC6302_{RES\_DPM\_LOBE}  
...
| `E_{vac\_neb}` | 7.09 $\times$ 10?6 J/m | plasmotic vacuum |
...
The NGC 6302 bipolar lobe structure (r ~ 1.5 ly) acts as a **macroscopic DPM resonance antenna**
with cross-section 26 orders of magnitude larger than neutron-star-scale compact objects. The I_wind
...
$$p_{\mathrm{DVP}} = 47, \quad n_{\mathrm{channel}} = 3/26$$
