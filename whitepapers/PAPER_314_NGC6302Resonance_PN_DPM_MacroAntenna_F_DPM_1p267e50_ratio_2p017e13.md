...
|-----------|-------|-------|
| r (lobe half-span) | 1.42 × 10¹⁶ m | ~1.5 ly |
| A_area (lobe cross-section) | π r² = 6.333 × 10³² m² | DPM antenna area |
| I_wind (wind current proxy) | 1 × 10²⁰ A | bipolar wind driven |
| ω₁ − ω₂ = Δω | 2 × 10⁻³ rad/s | DPM frequency spread |
| f_DPM | 1 × 10¹² Hz | wind-aligned, 1e12 class |
| E_vac_neb | 7.09 × 10⁻³⁶ J/m³ | plasmotic vacuum |
| V_sys | (4/3)π r³ = 1.199 × 10⁴⁹ m³ | lobe sphere |
...
Comparing to PAPER_293 (systems 18-24, r ~ 10⁶ m):
...
versus compact object area (~π×(10⁶)² ≈ 3.14×10¹² m²): ratio ≈ 2×10²⁰ in area but partially offset by V_sys (ratio ≈ 10³⁰) and the velocity spread Δω, giving net 13 orders.
...
- **FIRST UQFF DPM force at planetary nebula lobe scale** (r ~ ly, F_DPM ~ 10⁵⁰ N)
- **FIRST 13-order DPM amplification** between compact (PAPER_293) and extended PN geometry
- Establishes **DPM macro-antenna scaling law**: F_DPM ∝ A_area ∝ r² at fixed I_wind, Δω
...
|--------|-------|-----------|--------|
| Compact (systems 18-24) | ~1×10⁶ | 6.284×10³⁶ | PAPER_293 |
| NGC 6302 PN lobe (this) | 1.42×10¹⁶ | **1.267×10⁵⁰** | **PAPER_314** |
