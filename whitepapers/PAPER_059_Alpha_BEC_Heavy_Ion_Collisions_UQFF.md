...
status: production
cvw: "v2.0.0"
tags: [cluster, F_U_Bi_i, BEC, buoyancy, LENR, UQFF]
...
UQFF framework interprets these clustering events via a negative buoyancy force (F_U_Bi_i = -4.8$\times$106
...
Total: **10 UQFF-computed channels** (verified by `alpha_clustering_lenr_module.py`: `ikeda_channels
= 10`)
...
The negative F_U_Bi_i acts against thermal fragmentation. The UQFF vacuum medium [SCm] provides a
...
*Validator: `alpha_clustering_lenr_module.py`  AlphaClusteringCalculator(`Ca40_{Ca40\_35MeV}`) | $\kappa$ =
0.0005/day | [SSq] = 0.57*
