...
UQFF framework interprets these clustering events via a negative buoyancy force (F_U_Bi_i = -4.8×106
...
This collision system is alpha-conjugate: 40 = 10 × 4, so 4Ca has the maximum alpha-clustering
potential.
...
*Validator: `a`lpha_clustering_lenr_module`.py`  AlphaClusteringCalculator(`Ca40_Ca40_35MeV`) | κ =
0.0005/day | [SSq] = 0.57*
