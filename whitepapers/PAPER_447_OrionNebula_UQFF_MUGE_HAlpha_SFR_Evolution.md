...
**Source:** grok_{share\_5fa36e4e035}.txt (Doc 34 — OrionUQFFModule)  
...
$$g_{\mathrm{UQFF}}(r,t) = \frac{GM_{\mathrm{sf}}(t)}{r^2}(1 + H_z t)(1 - B/B_{\mathrm{crit}}) + \sum U_{gi} + \frac{\Lambda c^2}{3} + g_{\mathrm{quantum}} + g_{\mathrm{fluid}} + g_{\mathrm{res}} + g_{\mathrm{DM}} + W_{\mathrm{stellar}} + P_{\mathrm{rad}}$$

Where:
$$M_{\mathrm{sf}}(t) = M_0\left(1 + \frac{\mathrm{SFR \cdot t_{\mathrm{yr}}}}{M_0}\right)$$
...
$$g_{\mathrm{res}}(t) = 2A\cos(kx)\cos(\omega t) + \frac{2\pi}{13.8} A \cdot \text{Re}\!\left[e^{i(kx - \omega t)}\right]$$
...
$$P_{\mathrm{rad}} = \frac{L_{\mathrm{Trap}}}{4\pi r^2 c} \cdot \frac{\rho_{\mathrm{fluid}}}{m_H}$$

$$P_{\mathrm{rad}} = \frac{1.53 \times 10^{32}}{4\pi (1.18 \times 10^{17})^2 \times 3 \times 10^8} \cdot \frac{10^{-20}}{1.67 \times 10^{-27}} \approx 2.06 \times 10^{-9}\ \mathrm{m}/s^2$$
...
$$W_{\mathrm{stellar}}(t) = v_{\mathrm{wind}}^2 \left(1 + \frac{t}{t_{\mathrm{age}}}\right) = (8 \times 10^3)^2 \left(1 + \frac{t}{3 \times 10^5\ {\mathrm{yr}}}\right)$$

At t=1 Myr: $W_{\mathrm{stellar}} = 6.4 \times 10^7 \times (1 + 3.33) = 2.77 \times 10^8$ m2/s2

### 2.6 Hubble Expansion at z=0.0004

$$H(t,z) = H_0 \sqrt{\Omega_m(1+z)^3 + \Omega_Lambda} = 70\sqrt{0.3(1.0004)^3 + 0.7} \approx 70.0\ \mathrm{km}/s/Mpc$$
