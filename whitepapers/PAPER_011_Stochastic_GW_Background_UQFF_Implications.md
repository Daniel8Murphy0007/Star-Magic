...
- SGWB from massive black hole binaries (10^4-10^7 M_{M\_sun})
...
- f = 0.1 mHz - 100 mHz
- SGWB from massive BH binaries (10^4-10^7 M_{M\_sun})
...
*Multi-band GW horizons: LIGO (30+30 M_{M\_sun}) 13440->8355 Mpc (38% reduction); LISA (10^6 M_{M\_sun} SMBH)
