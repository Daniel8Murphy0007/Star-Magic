...
### 3.1 Bose Occupancy Fit (bose_{occupancy\_validation}.py)
...
### 3.3 BEC Nuclear Calculator (bose_{nuclear\_calculator}.py)
...
9. `bose_{nuclear\_calculator}.py`  Star-Magic codebase, added Jan 28, 2026 (Batch 23).
10. `bose_{occupancy\_validation}.py`  Star-Magic codebase, ?/dof=0.051, ALL PASS.
