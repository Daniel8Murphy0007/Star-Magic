---
paper_id: PAPER_535
title: "VDS-DVP-BH Number Systems Unified Catalogue Hub"
session: 143
date: 2026-03-26
...
$$Z \approx [SSq] + \frac{[SSq]^2}{2^{26}} + \cdot s \approx [SSq]\!\left(1 + 10^{-8}\right) \approx 0.5700$$
...
| CentripetalUQFFEncompassmentCalculator | #129 | $\Delta_text{res}$ | $0.0$ (exact) |
...
| $\Delta_text{res} = 0$ | Centripetal eigenproof |
...
8. Mayor, M. & Queloz, D. (1995). *A Jupiter-mass companion to a solar-type star.* Nature **378**, 355 — doi:10.1038/378355a0
9. Borucki, W.J. et al. (2010). *Kepler Planet-Detection Mission: Introduction and First Results.* Science **327**, 977 — arXiv:1006.0336 — doi:10.1126/science.1185402
