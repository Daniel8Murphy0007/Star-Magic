...
| Rings of Relativity Lens luminosity Optical/IR lensing | UQFF MUGE g_total → L_X via Stefan-Boltzmann + buoyancy flux: L_X ≈ g_total × M_env | L_X Einstein radius θ_E ~ 1" | HST / JWST | PASS Consistent order of magnitude |
