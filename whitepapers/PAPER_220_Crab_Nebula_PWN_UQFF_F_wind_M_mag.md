...
spindown ram pressure `F_wind = E_sd/(c·4pr2)` and magnetic moment dipole dilution `M_mag =
µ0·m/(4pr3)`. This combination — spindown luminosity converted to ram pressure plus magnetic moment
...
context. Additionally, the Crab PWN uses a TIME-DEPENDENT RADIUS `r(t) = r0 + v_exp·t` reflecting
