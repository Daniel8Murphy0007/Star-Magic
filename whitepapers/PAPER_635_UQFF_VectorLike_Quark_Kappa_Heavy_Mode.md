---
paper_id: PAPER_635
title: "UQFF Vector-Like Quarks and \kappa Heavy-Mode Excitations"
session: 162
date: 2026-01-01
...
| VLQ mass gap $\Delta$M_VLQ | $\Delta$M = m_W $\times$ $\sqrt{k}$_$\eta$_VLQ = 29.8 GeV | LHC Run 4 (HL-LHC): spectroscopy testable | HL-LHC 2027+ | Testable UQFF prediction |
...
- bsm_{physics\_validation}.py — `BSMPhysicsConstants.atlas_{vlq\_kappa\_min}/max`
