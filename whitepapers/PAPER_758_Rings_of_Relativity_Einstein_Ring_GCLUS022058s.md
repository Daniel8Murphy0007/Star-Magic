---
paper_id: PAPER_758
title: "Rings of Relativity — Einstein Ring GAL-CLUS-022058s UQFF Lensing"
session: 181
date: 2026-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [Hubble, cluster, UQFF]
...
Strong gravitational lensing by massive clusters provides a direct measurement of projected mass
within the Einstein radius. For GAL-CLUS-022058s the Einstein radius corresponds to a physical scale
...
$$
\begin{aligned}
  & g_Rings(r_E, t) = [G\cdot M_cluster / r_E2] \times (1 + H(z)) \times (1 - B/B_crit) \\
  & \times (1 + L(t)) \\
  ...
  & L(t) = [G\cdot M / (c2\cdot r_E)] \times (D_LS / D_S) \\
...
```
\theta_E = sqrt(4GM / (c2 \times D_eff))    [Einstein angle]
    D_eff = D_L \times D_S / D_LS
