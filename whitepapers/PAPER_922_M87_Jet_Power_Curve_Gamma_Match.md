...
$$\boxed{P_{\rm jet}(\Gamma) = P_{\rm BZ}(1 + M_{\rm jet}\frac{E_{\rm net}}{E_{\rm BZ}} e^{-\sigma_T^2/2\Gamma^2})}$$
...
$$p_{\rm DVP} = 17, \quad n_{\rm channel} = 22/26$$
...
| DVP prime | $p_k \in$ {2,3,...,113} | $p_{\rm DVP} = 17$ | PASS Lattice-consistent |
