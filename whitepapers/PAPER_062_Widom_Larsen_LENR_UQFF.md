...
"heavy electrons" (m* enhanced by factors of 2×10) that enable ultra-low-momentum neutron production
...
3×10 cm?/s (enhanced), Q(6Li + 2n ? 24He) = 26.9 MeV, Um = 1.71×1086 Tpm, k_eta = k_? = 10?
...
| Um oscillation field | Um | **1.71×1086 Tpm** |
...
The solar corona LENR rate (7×10? cm?/s) is 16 orders of magnitude smaller than metallic hydride
