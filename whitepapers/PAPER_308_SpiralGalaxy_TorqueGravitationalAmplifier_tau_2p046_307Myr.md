---
paper_id: PAPER_308
title: "Spiral Arm Torque Gravitational Amplifier"
session: 0
date: 2025-01-01
...
The spiral arm torque amplifier in UQFF 2.0 is defined as a dimensionless running accumulation of
pattern momentum:

$$\tau_{\mathrm{spiral}}(t) = \frac{M_{\mathrm{gas}}}{M} \cdot \Omega_p \cdot t$$
...
$$\tau_{\mathrm{spiral}}(10\,{\mathrm{Gyr}}) = 0.01 \times 6.483\times10^{-16} \times 3.156\times10^{17} = \boxed{2.046}$$

### 3.2 Gravity Amplification

The UQFF 2.0 pipeline applies $\tau$ as a multiplicative stage:

$$g_{\mathrm{pipeline}}(t) = \underbrace{\frac{GM}{r^2}}_{\mu_s\nabla(M_s/r)} \cdot \underbrace{(1 + H_z\,t)}_{\text{Hubble}} \cdot \underbrace{(1 + \tau_{\mathrm{spiral}})}_{\text{torque}} \cdot \underbrace{(1 - B/B_{\mathrm{crit}})}_{\text{SC}} \cdot \underbrace{(1 + f_{\mathrm{TRZ}})}_{\mathrm{TRZ}}$$

At t = 10 Gyr, z = 0:

$$g_{\mathrm{amp}} = 1 + \tau_{\mathrm{spiral}} = 1 + 2.046 = \boxed{3.046}$$
...
$$T_{\mathrm{pattern}} = \frac{2\pi}{\Omega_p} = \frac{2\pi}{6.483\times10^{-16}} = 9.692\times10^{15}\,{\mathrm{s}} = \boxed{307 \text{ Myr}}$$

A spiral arm completes one full rotation pattern in 307 Myr — consistent with observed grand-design
spiral arm lifetimes.

### 3.4 Torque Rate vs Hubble Rate

$$\frac{d\tau}{dt} = f_{\mathrm{gas}} \cdot \Omega_p = 6.483\times10^{-18}\,{\mathrm{s}}^{-1}$$

$$H_{0,\mathrm{SH0ES}} = \frac{73.0 \times 10^3}{3.086\times10^{22}} = 2.366\times10^{-18}\,{\mathrm{s}}^{-1}$$
...
The spiral arm torque factor captures how non-axisymmetric mass flows (gas infall, density wave
...
- MAIN_{1\_CoAnQi}.cpp SOURCE4 (lines 25623–26026) — UQFF/MUGE framework
- Session 88 — SPIRAL_{SUPERNOVAE\_UQFF\_MODULE}.cpp (UQFF 2.0 implementation)
...
$$p_{\mathrm{DVP}} = 23, \quad n_{\mathrm{channel}} = 23/26$$
