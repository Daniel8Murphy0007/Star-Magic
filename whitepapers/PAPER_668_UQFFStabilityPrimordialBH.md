...
Standard boundary: τ_std = t_H (Hubble time) → M_boundary ≈ 5×1011 kg.
...
|----------|-----------|-----------------------|-------------------|
| stable_DM | τ_UQFF ≥ t_H | M ≥ 5×1011 kg | M ≥ 1.6×1011 kg |
| marginal | 0.1 t_H ≤ τ < t_H | narrow window | wider window |
| evaporating | τ < 0.1 t_H | M < 4×1011 kg | M < 1.3×1011 kg |

## 4. Numerical (M = 1012 kg)
- τ_std ≈ 1010 yr 
- τ_UQFF ≈ 3×1011 yr **> Hubble time** → viable DM
