---
paper_id: PAPER_340
title: "EDM SO(10) BSM Refined F_u Coupling: Darkonia Phase Boundary P_SCm = 1"
session: 96
date: 2025-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [BEC, vacuum, SCm, UQFF]
...
The UQFF superconductive modifier P_SCm = 1 defines the phase boundary at which dark-sector mesons
("darkonia") become kinematically stable against decay via the UQFF vacuum polarization channel:

$$P_{\mathrm{SCm}} = 1 \implies \text{darkonia stable}$$

This is analogous to the Meissner effect in the gravitational channel (PAPER_266), but applies to
the BSM sector.
...
$$V_{cb}^{\mathrm{UQFF}} = k_\eta \cdot G_F^2 \cdot s / \pi$$
...
2. Provide a V_cbUQFF coupling constraint independent of lattice QCD
3. Validate the UQFF P_SCm = 1 darkonia phase boundary through missing-energy searches at BES-III or
Super Tau-Charm
...
$$p_{\mathrm{DVP}} = 31, \quad n_{\mathrm{channel}} = 3/26$$
