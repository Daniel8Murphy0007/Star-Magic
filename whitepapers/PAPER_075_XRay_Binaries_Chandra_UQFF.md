...
$$\eta_{\mathrm{Eddington}} = 0.1 \times \frac{L_X}{L_{\mathrm{Edd}}}$$ 
### UQFF-Enhanced Efficiency 
$$\eta_{\mathrm{UQFF}} = \eta_{\mathrm{Edd}} \times (1 + [SCm]) = \eta_{\mathrm{Edd}} \times 1.99$$ 
...
| Source | Type | d (kpc) | `L_{X\_obs}` (L?) | `L_{X\_Edd}` (L?) | `L_{X\_UQFF}` (L?) | L_obs/L_UQFF | 
|--------|------|---------|--------------|---------------|----------------|--------------| 
| Cygnus X-1 | BH-HMXB | 1.86 | 2.5\times10-7 | 2.0\times10-8 | 2.8\times10-7 | 0.89 | 
| Her X-1 | NS-LMXB | 6.6 | 1.0\times10-7 | 1.3\times10-8 | 1.3\times10-7 | 0.77 | 
| Sco X-1 | NS-LMXB | 2.8 | 2.3\times10-8 | 1.8\times10-8 | 2.0\times10-8 | 1.15 | 
| GRS 1915+105 | BH | 8.6 | 6.0\times10-8 | 7.4\times10-8 | 7.5\times10-8 | 0.80 | 
| X-1 ULX (NGC 5907) | NS-ULX | 17,000 | 1.0\times104 | 2.0\times10? | 4.0\times10? | 25 | 
...
$$\Delta HR_{\mathrm{UQFF}} = [UA] \times \frac{n_{\mathrm{vac}}}{n_{\mathrm{ISM}}} \times HR_{\mathrm{standard}} = 0.0001 \times 10^{-6} \times HR = \text{negligible}$$
...
| ULX luminosity | 1$\times$10 Edd | 2 Edd + beaming | Requires beaming |
| Typical XRB L_X | Eddington | 1525% | < 2s agreement |

*Source: QCalc_validation.py CHANDRA_DATA + HEASARC_XRAY endpoints | $\kappa$ = 0.0005/day | [SSq] = 0.57*
