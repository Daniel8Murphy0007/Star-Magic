...
where:
- ρ_SCm = superconducting medium density [kg/m³]
- v_SCm = SCm velocity [m/s]
- ρ_A = ambient density [kg/m³]
- κ = 0.0005/day = 5.787×10⁻⁹ s⁻¹ (UQFF canonical)
...
| Luminosity     | ~10⁴⁷ erg/s    | Typical quasar AGN luminosity      |
| Jet velocity   | ~0.99c         | VLBI proper motion + UQFF fit      |
| ρ_SCm          | 1×10¹⁵ kg/m³  | AGN accretion disk SCm density     |
| ρ_A            | 1.67×10⁻²⁷    | H gas ambient density              |
