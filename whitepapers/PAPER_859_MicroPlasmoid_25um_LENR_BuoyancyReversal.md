...
70% of the total duration. This reversal is modeled by the F_U_Bi / F_U_g ratio exceeding unity when
...
`EULER_LAGRANGE_NEW_TERM_MAPPINGS["micro_plasmoid_reversal"]`
