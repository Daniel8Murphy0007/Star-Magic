...
status: production
cvw: "v2.0.0"
tags: [AGN, cluster, vacuum, cosmology, F_{U\_Bi\_i}, buoyancy, UQFF]
...
$$700\ M_\odot/\mathrm{yr} = \rho_{\mathrm{gas}}(r_{\mathrm{cool}}) \cdot v_{\mathrm{turbulence}} \cdot f_{\mathrm{TRZ}}$$
...
$$M_{\mathrm{cl}} = 7.32 \times 10^{14}\ M_\odot = 7.32 \times 10^{14} \times 1.989\times 10^{30}\ \mathrm{kg} = 1.46 \times 10^{45}\ \mathrm{kg}$$
...
$$\mathcal{L}_{\mathrm{sector}} = \frac{1}{2}(\partial_mu \phi_{\mathrm{cl}})(\partial^\mu \phi_{\mathrm{cl}}) - V(\phi_{\mathrm{cl}}) + \mathcal{L}_{\mathrm{cosmo}}$$

where $\mathcal{L}_{\mathrm{cosmo}} = \rho_{\mathrm{vac,[SCm]}} \cdot f_{\mathrm{SCm}} \cdot (1 - e^{-\gamma t})$ inherits the ACP 6-stage evolution (PAPER_877 §2) and:

$$V(\phi_{\mathrm{cl}}) = \frac{1}{2} m^2 \phi_{\mathrm{cl}}^2 + \frac{\lambda}{4!} \phi_{\mathrm{cl}}^4 + \kappa \cdot \rho_{\mathrm{vac,[SCm]}} \cdot \phi_{\mathrm{cl}}$$

### §A.3 Euler-Lagrange Equation of Motion

$$\boxed{\frac{\delta S}{\delta \phi_{\mathrm{cl}}} = \sigma_v^2 \nabla^2 \phi_{\mathrm{cl}} + 4\pi G \rho_{\mathrm{cl}} + \rho_{\mathrm{vac,[SCm]}} \cdot r_{\mathrm{tidal}} = 0}$$
