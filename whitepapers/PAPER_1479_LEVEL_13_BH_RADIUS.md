# PAPER_1479 — UQFF: Level-13 Black Hole Radius (Bucket G)
...
**Status:** CLOSED — r_BH = SO_5^5 = 1e5 m EXACT; V_BH = 4/3 pi r^3

---

## Observation

Universal Inertia doc places level-13 BH at radius r = 1e5 m with V_BH approximately 4.19e15 m^3.
...
```
r_BH(level 13) = SO_5^(D_phys+1) = SO_5^5 = 1e5 m EXACT; V_BH = (4/3) pi r^3 = 4.19e15 m^3.
```
...
The 13 = D_crit/2 level corresponds to the half-spectrum BH radius. The SO_5^5 = 1e5 m identity scales the BH event horizon to a structurally-canonical 100 km.
