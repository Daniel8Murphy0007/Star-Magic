---
paper_id: PAPER_586
title: "Big Bang Expansion Dynamics in UQFF Framework"
session: 157
date: 2025-01-01
author: "Daniel T. Murphy"
status: production
cvw: "v2.0.0"
tags: [SCm, dark-energy, buoyancy, UQFF]
...
This paper presents a UQFF analysis of Big Bang Expansion Dynamics in UQFF Framework, deriving
...
$$t_\text{adj} = t_\text{neg} + \frac{t_\text{obs}}{\Delta_text{dil} + 1}$$

where $t_\text{neg} < 0$ is the negative-time pre-mass reservoir (see PAPER_597),
$\Delta_text{dil} = 0.1$ is the dilation factor, and $t_\text{obs}$ is the observed
cosmic time-scale.
...
$$P = \frac{(v_\text{init} - v_\text{current})(\Delta_text{dil}\,t_\text{neg}+1)
...
## §8 Comparison to $\Lambda$CDM

| Observable | $\Lambda$CDM | UQFF BB |
|-----------|------|---------|
...
initial singularity. The scale factor reproduces $\Lambda$CDM behavior as a limiting case.
