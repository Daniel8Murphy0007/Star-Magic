...
status: production
cvw: "v2.0.0"
tags: [Hubble, F_{U\_Bi\_i}, exoplanet, UQFF]
...
expansion and superconductive modifier, and the full F_{U\_Bi\_i}. TOI-1227b provides a benchmark for
...
### 2.3 UQFF F_{U\_Bi\_i} (Planetary Scale)

$$F_{U\_Bi\_i}^{\mathrm{planet}} = F_{U\_Bi\_i}(M_{\mathrm{planet}}, r_{\mathrm{orbit}}, \omega_{\mathrm{act}})$$
