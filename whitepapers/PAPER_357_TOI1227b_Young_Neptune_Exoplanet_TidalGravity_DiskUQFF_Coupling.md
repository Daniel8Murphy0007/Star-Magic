...
at the orbital radius, a disk-UQFF force F_disk = ρ_disk·v_disk2·(1+H₀t)·SC_m incorporating Hubble
...
For M_star ≈ 0.17 MM_sun (M-dwarf), P_orb = 11 d:
...
| F_disk | ρ_disk·v2·SC_m | disk-epoch force |
...
- **Unique:** Disk coupling F_disk = ρ_disk·v2·(1+H₀t)·SC_m is unique to young-planet UQFF.
