...
double step3_{g\_muB\_B0} = g_H * mu_B * B0;   // 1.252e46 \times 9.274e-28 = 1.16e19

// Step 2: ħ \times \omega₀  
double step4_{h\_omega0} = h_planck * omega_{0\_base};  // 1.0546e-34 \times 1e-12 = 1.054e-46
...
- Eta Carinae: F_{U\_Bi\_i} = 2.11$\times$10208 N (catalogue benchmark)
