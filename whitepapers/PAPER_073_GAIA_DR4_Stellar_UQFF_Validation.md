#  "PAPER_{0:D3}" -f [int]# PAPER #73 ó Stellar Parameter Validation: GAIA DR4 vs UQFF
...
**Index Slot:** ß1.10 Database Integration & Multi-Wavelength Astrophysics,  
    $n = [int]# PAPER #73 ó Stellar Parameter Validation: GAIA DR4 vs UQFF
...
|-----------|------|------|-----------------|------------------|-------------|
| Sun (G2V) | 1.00 | 1.00 | 274 | 281 ◊ 10?π∞ | calibration |
| Sirius A (A1V) | 2.06 | 1.71 | 367 | 373 ◊ 10?π∞ | 1.016 |
| Betelgeuse (M2I) | 11.6 | 764 | 0.00053 | 0.00054 ◊ 10?π∞ | 1.019 |
| White dwarf (0.6 M?) | 0.60 | 0.012 | 3.51◊108 | 3.57◊10?≤ | 1.017 |
| Brown dwarf (0.07 M?) | 0.07 | 0.10 | 193 | 197 ◊ 10?π∞ | 1.021 |
...
For solar-type stars (?_? = 2.87◊10?6 rad/s): v_osc = 3.48◊10?π≤ m/s ó negligible vs thermal velocities (km/s). GAIA proper motion precision (~1ñ10 µas/yr = 0.1ñ1 mm/s at d=10 pc) does not constrain this term, as expected.
...
For Solar analogs (logg ò 4.44):
- GAIA DR4 GSP-Phot uncertainty: ±0.1ñ0.3 dex
...
| White dwarf log g | 7.9ñ8.4 | +0.015 correction | Compatible |
| UQFF/Newton ratio | ó | 1.019 (◊[SSq]) | Self-consistent |
| Proper motion UQFF osc | ó | <mm/s (negligible) | Not constrained |
...
*Source: QCalc_validation.py GAIA_TAP endpoint | ? = 0.0005/day | [SSq] = 0.57*
.Groups[1].Value  ó Stellar Parameter Validation: GAIA DR4 vs UQFF
...
**Source Data:** QCalc_validation.py (DataSourceURLs: GAIA_DR4), validate_phase3.py  
**Index Slot:** ß1.10 Database Integration & Multi-Wavelength Astrophysics,  
    $n = [int]#  "PAPER_{0:D3}" -f [int]# PAPER #73 ó Stellar Parameter Validation: GAIA DR4 vs UQFF
...
**Date:** March 7, 2026  
**Source Data:** QCalc_validation.py (DataSourceURLs: GAIA_DR4), validate_phase3.py  
**Index Slot:** ß1.10 Database Integration & Multi-Wavelength Astrophysics,  "PAPER_{0:D3}" -f [int]# PAPER #73 ó Stellar Parameter Validation: GAIA DR4 vs UQFF
