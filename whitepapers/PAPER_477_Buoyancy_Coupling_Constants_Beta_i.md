...
At solar conditions: U_{g,1} $\approx$ G M_{M\_sun} / r_{M\_sun2} = 274 m/s2 (surface gravity).
...
**Class:** `BuoyancyCouplingModule` | **Source:** `g`rok_{share\_b0a3dc1d}`.txt` L2082–2276  
