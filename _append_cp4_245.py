"""
_append_cp4_245.py  —  Session 172
Appends CP4 entry #245: UQFFPBHDarkMatterCalculator
Paper: PAPER_661
...
DIVIDER = (
    "\n\n# " + "=" * 74 + "\n"
    "# CP4 #245 \x97 UQFFPBHDarkMatterCalculator\n"
...
def main():
    ...
    with open(CP4, "ab") as f:
        f.write(encoded)
    print(f"CP4 #245 appended: UQFFPBHDarkMatterCalculator")
    # Verify
    with open(CP4, "rb") as f:
        tail = f.read()[-800:]
    if b"UQFFPBHDarkMatterCalculator" in tail:
