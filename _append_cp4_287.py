"""
CP4 Appender for PAPER_703 -- NGC1275MagneticMonsterUQFF (CP4 #287)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NGC1275MagneticMonsterUQFF"
    if marker in content:
        print(f"SKIP: NGC1275MagneticMonsterUQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NGC1275MagneticMonsterUQFF (PAPER_703, CP4 #287)")
