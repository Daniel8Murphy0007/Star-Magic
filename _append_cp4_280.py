"""
CP4 Appender for PAPER_696 â€” AntennaeMergerNGC4038NGC4039 (CP4 #280)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class AntennaeMergerNGC4038NGC4039"
    if marker in content:
        print(f"SKIP: AntennaeMergerNGC4038NGC4039 already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended AntennaeMergerNGC4038NGC4039 (PAPER_696, CP4 #280)")
