"""
gen_muge_hudf.py — Generator for HUDFGalaxies.h
Module 16: Hubble Ultra Deep Field (HUDF) galaxy ensemble.
Key physics: cosmic scale z_avg=3.5 with full H(z) correction,
             ensemble mass averaging over ~10,000 faint galaxies.

Run:  python gen_muge_hudf.py
Output: HUDFGalaxies.h
"""
import os

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "HUDFGalaxies.h")
 ...
 *              UQFF simulations — cosmic-scale deep field galaxy population.
 *
 * Unique Terms:
...
def main():
    print("gen_muge_hudf.py — Generating HUDFGalaxies.h ...")
    content = get_content()
