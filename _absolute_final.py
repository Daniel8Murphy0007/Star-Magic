#!/usr/bin/env python3
"""Absolute final: protection keys without LaTeX-special chars"""
...
# === PROTECT ALL MATH/EQUATION BLOCKS ===
# Use keys that won't conflict with LaTeX
protected = {}
counter = 0

def protect(m):
    global counter
    key = f'PROTMARK{counter}ENDMARK'
    protected[key] = m.group(0)
    counter += 1
    return key

# Protect equation blocks FIRST
...
# Add title
content = '# Rossi E-Cat Variants: Unified SCm Analysis\n\n' + content

with open('whitepapers/SCm_Rossi_ECat_Variants_Unified.md', 'w', encoding='utf-8') as f:
    f.write(content)

print('[ABSOLUTE FINAL] Conversion complete with safe protection keys')
