"""
CP4 Appender for PAPER_700 â€” UQFFEquationMathematicalDerivation (CP4 #284)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class UQFFEquationMathematicalDerivation"
    if marker in content:
        print(f"SKIP: UQFFEquationMathematicalDerivation already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended UQFFEquationMathematicalDerivation (PAPER_700, CP4 #284)")
