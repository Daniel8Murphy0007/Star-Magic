class Source91UQFFModule {
    ...
    // Compute 26 sphere centers distributed on unit sphere using Fibonacci spiral
    computeSphereCenters() {
        const n = Math.floor(this.variables.get('num_states'));
        const centers = [];
        const r_sphere = this.variables.get('r');

        // Distribute centers on unit sphere using Fibonacci spiral for better uniformity
...
module.exports = { Source91UQFFModule };