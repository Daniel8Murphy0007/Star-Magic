"""
CP4 Appender for PAPER_699 â€” FornaxConstellationUHDF (CP4 #283)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class FornaxConstellationUHDF"
    if marker in content:
        print(f"SKIP: FornaxConstellationUHDF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended FornaxConstellationUHDF (PAPER_699, CP4 #283)")
