...
check("R5 WORST RESIDUAL IS LAMBDA — H0 route SUPERSEDED PAPER_2093 -> PAPER_1573 (A_5+SO_5=70 km/s/Mpc EXACT integer-primitive identity, 0.065 pct residual, 47.6x TIGHTER than PAPER_2093's 3.08 pct); worst residual is now Lambda PAPER_2094 (0.90 pct, pure-primitive H_0-independent, held per coupling-discovery decision — Friedmann Λ=(18/5)SSq*H0^2/c^2 would overshoot to +6 pct with tightened H_0). PAPER_2125 'Hubble tension IS the physics' doctrine REVISED: framework does derive H_0 to sub-0.1 pct via integer-sum identity (PAPER_2144).", _r5 and 0.85 < _r5.get("worst_residual_pct", 0.0) < 0.95)
