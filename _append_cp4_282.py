"""
CP4 Appender for PAPER_698 â€” EinsteinRingGALCLUS022058s (CP4 #282)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class EinsteinRingGALCLUS022058s"
    if marker in content:
        print(f"SKIP: EinsteinRingGALCLUS022058s already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended EinsteinRingGALCLUS022058s (PAPER_698, CP4 #282)")
