"""
CP4 Appender for PAPER_692 â€” M51WhirlpoolTidalInteraction (CP4 #276)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class M51WhirlpoolTidalInteraction"
    if marker in content:
        print(f"SKIP: M51WhirlpoolTidalInteraction already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended M51WhirlpoolTidalInteraction (PAPER_692, CP4 #276)")
