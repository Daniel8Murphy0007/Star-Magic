"""
CP4 Appender for PAPER_709 -- Westerlund2StarClusterUQFF (CP4 #293)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class Westerlund2StarClusterUQFF"
    if marker in content:
        print(f"SKIP: Westerlund2StarClusterUQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended Westerlund2StarClusterUQFF (PAPER_709, CP4 #293)")
