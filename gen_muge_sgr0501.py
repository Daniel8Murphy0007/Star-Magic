"""
gen_muge_sgr0501.py — Generator for MagnetarSGR0501_4516.h
Module 2 in MUGE series: SGR 0501+4516 magnetar gravity evolution.
Unique physics: B(t)=B0*exp(-t/tau_B), Omega(t) spin decay, f_sc superconductivity,
                quantum uncertainty, fluid, DM perturbation, oscillatory.

Run:  python gen_muge_sgr0501.py
Output: MagnetarSGR0501_4516.h
"""
import os

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "MagnetarSGR0501_4516.h")
...
def main():
    print("gen_muge_sgr0501.py — Generating MagnetarSGR0501_4516.h ...")
    content = get_content()
