...
Unique physics: GROWING expansion term E(t)=E_0*(1-exp(-t/tau_exp))
                applied as (1-E) on Ug (expanding shell reduces effective gravity).

Run:  python gen_muge_bubble.py
Output: BubbleNebula.h
"""
import os

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "BubbleNebula.h")
...
def main():
    print("gen_muge_bubble.py — Generating BubbleNebula.h ...")
    content = get_content()
