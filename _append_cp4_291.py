"""
CP4 Appender for PAPER_707 -- NGC2525BarredSpiral2UQFF (CP4 #291)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NGC2525BarredSpiral2UQFF"
    if marker in content:
        print(f"SKIP: NGC2525BarredSpiral2UQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NGC2525BarredSpiral2UQFF (PAPER_707, CP4 #291)")
