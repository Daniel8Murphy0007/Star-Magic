"""
CP4 Appender for PAPER_695 â€” NGC7635BubbleNebula (CP4 #279)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NGC7635BubbleNebula"
    if marker in content:
        print(f"SKIP: NGC7635BubbleNebula already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NGC7635BubbleNebula (PAPER_695, CP4 #279)")
