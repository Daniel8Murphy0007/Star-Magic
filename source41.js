class UniverseDiameterUQFFModule {
    constructor() {
        ...
        this.variables.set("M", 1e53 * M_sun_val);              // Total mass kg (est. observable universe)
        this.variables.set("M_visible", 0.73 * this.variables.get("M")); // Baryonic fraction ~4.9%, but incl. stars/galaxies
        this.variables.set("M_DM", 0.27 * this.variables.get("M"));      // Dark matter fraction
        ...
        this.variables.set("t", this.variables.get("t_Hubble")); // Default t=13.8 Gyr s

        // Cosmic dynamics
        this.variables.set("rho_fluid", 8.6e-27);               // kg/m^3 (critical density)
        this.variables.set("V", 1e3);                           // m^3 (arbitrary, scaled irrelevant)
        this.variables.set("v_exp", this.variables.get("H0") * 1e3 / this.variables.get("Mpc_to_m") * this.variables.get("r"));  // Hubble flow v
        ...
        this.variables.set("B", 1e-15);                         // T (cosmic magnetic field est.)
        this.variables.set("B_crit", 1e11);                     // T

        // Quantum terms
        this.variables.set("Delta_x", 1e-10);                   // m (fundamental scale proxy)
        ...
        this.variables.set("k", 1e20);                          // m^-1 (short wavelength proxy)
    ...
    computeG(t) {
        ...
        const em_base = this.variables.get("q") * this.variables.get("v_exp") * this.variables.get("B") / 1.673e-27;
...
module.exports = UniverseDiameterUQFFModule;