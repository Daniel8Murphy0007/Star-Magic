...
- **Whitepaper Suite:** 645/1,000 whitepapers in progress (PAPER_001–645 total, 64.5% of target; updated March 31, 2026) — includes §1.13 Millennium Prize papers (Navier-Stokes, Yang-Mills, Riemann, P≠NP); G1–G6 CVW gate compliance enforced across all papers (all 645 fully CVW v2.0.0 compliant); 663 PDFs in canonical pdf/
