...
// Design & Structure
// ------------------
// - Implements a modular class for the Master Unified Field Equation tailored to M87 Jet relativistic jet evolution.
// - Uses std::map<std::string, std::complex<double>> for dynamic variable management, supporting both real and imaginary components.
// - Constructor initializes all relevant physical constants and jet - specific parameters.
//
// Functionality
// ------------ -
