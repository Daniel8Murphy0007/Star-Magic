...
MagneticStringModule::MagneticStringModule() {
    ...
    variables["gamma"] = 5e-5 / (86400.0);          // day^-1 to s^-1 (γ=5e-5 /day)
    variables["t_n"] = 0.0;                         // s
...
void MagneticStringModule::printStringContributions(int j, double t) {
    ...
    std::cout << "μ_j / r_j = " << mu_over_rj << " T m^2\n";
...
// Sample: r_1=1.496e13 m (100 AU); μ/r ≈2.26e10; U_m=0 at t=0; Ug3≈1.8e49 J/m³.
// Watermark: Copyright - Daniel T. Murphy, analyzed Oct 10, 2025.

Distance from the Galactic Center.docx
File
