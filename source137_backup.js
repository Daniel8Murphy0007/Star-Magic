// CrabNebulaUQFFModule.js
// JavaScript implementation of the full Master Unified Field Equation for Crab Nebula Supernova Remnant.
// Uses complex numbers: {re, im} objects for all variables
// Variables: M=1e31 kg, r=4.73e16 m, L_X=1e27 W, B0=3e-8 T, ω_0=1e-12 s^-1, t=3.06e10 s, x2=-3.40e172
...
class CrabNebulaUQFFModule {
  constructor() {
    ...
    this.variables.set("M", {re: 1e31, im: 0.0});
    this.variables.set("r", {re: 4.73e16, im: 0.0});
    this.variables.set("L_X", {re: 1e27, im: 0.0});
    this.variables.set("B0", {re: 3e-8, im: 0.0});
    this.variables.set("omega0", {re: 1e-12, im: 0.0});
    this.variables.set("theta", {re: pi_val / 4, im: 0.0});
    this.variables.set("t", {re: 3.06e10, im: 0.0});
  ...
  getEquationText() { return "Crab Nebula: M=1e31 kg, r=4.73e16 m, t=3.06e10 s (~970 years), x2=-3.40e172; Supernova remnant with pulsar"; }
