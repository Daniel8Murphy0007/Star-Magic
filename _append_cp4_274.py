"""
CP4 Appender for PAPER_690 â€” FornaxClusterGravitational (CP4 #274)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class FornaxClusterGravitational"
    if marker in content:
        print(f"SKIP: FornaxClusterGravitational already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended FornaxClusterGravitational (PAPER_690, CP4 #274)")
