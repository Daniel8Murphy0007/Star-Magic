"""
CP4 Appender for PAPER_702 -- SaturnRingSystemUQFF (CP4 #286)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class SaturnRingSystemUQFF"
    if marker in content:
        print(f"SKIP: SaturnRingSystemUQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended SaturnRingSystemUQFF (PAPER_702, CP4 #286)")
