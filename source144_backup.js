// LagoonNebulaUQFFModule144.js (duplicate source144 - likely C++ copy issue, preserving exact code)
// JavaScript implementation of the full Master Unified Field Equation for Lagoon Nebula (M8) - source144 variant.
// Uses complex numbers: {re, im} objects for all variables
// Variables: M=1e36 kg, r=2.36e17 m, L_X=1e32 W, B0=1e-5 T, ω_0=1e-12 s^-1, t=1e13 s, V=1e4 m/s, x2=-3.40e172
...
class LagoonNebulaUQFFModule144 {
  constructor() {
    ...
    this.variables.set("M", {re: 1e36, im: 0.0});
    this.variables.set("r", {re: 2.36e17, im: 0.0});
    this.variables.set("L_X", {re: 1e32, im: 0.0});
    this.variables.set("B0", {re: 1e-5, im: 0.0});
    this.variables.set("omega0", {re: 1e-12, im: 0.0});
    this.variables.set("theta", {re: pi_val / 4, im: 0.0});
    this.variables.set("t", {re: 1e13, im: 0.0});
    this.variables.set("rho_gas", {re: 1e-21, im: 0.0});
    this.variables.set("V", {re: 1e4, im: 0.0});
  ...
  getEquationText() { return "Lagoon Nebula (M8) 144: M=1e36 kg, r=2.36e17 m, t=1e13 s, V=10 km/s, x2=-3.40e172; Emission nebula (source144 variant)"; }
...
module.exports = LagoonNebulaUQFFModule144;
