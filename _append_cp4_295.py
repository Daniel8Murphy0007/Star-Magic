"""
CP4 Appender for PAPER_711 -- NGC2014NGC2020Variant2UQFF (CP4 #295)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NGC2014NGC2020Variant2UQFF"
    if marker in content:
        print(f"SKIP: NGC2014NGC2020Variant2UQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NGC2014NGC2020Variant2UQFF (PAPER_711, CP4 #295)")
