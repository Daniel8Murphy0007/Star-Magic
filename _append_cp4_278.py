"""
CP4 Appender for PAPER_694 â€” CrabNebulaPWNUQFF (CP4 #278)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class CrabNebulaPWNUQFF"
    if marker in content:
        print(f"SKIP: CrabNebulaPWNUQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended CrabNebulaPWNUQFF (PAPER_694, CP4 #278)")
