"""
CP4 Appender for PAPER_705 -- NGC3603StarCluster2UQFF (CP4 #289)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class NGC3603StarCluster2UQFF"
    if marker in content:
        print(f"SKIP: NGC3603StarCluster2UQFF already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended NGC3603StarCluster2UQFF (PAPER_705, CP4 #289)")
