...
if __name__ == "__main__":
    ...
    print("  G18 (Omega_b * h^2)         -- CLOSED (Session 258, _matter_density_closures.py): Omega_b*h^2 = sqrt(5)*F_TRZ^2 = sqrt(5)/100 (0.042%); sqrt(5) from icosahedral A_5")
    print("  G19 (Omega_DM * h^2)        -- CLOSED (Session 258, _matter_density_closures.py): Omega_DM*h^2 = F_TRZ/Phi_res = 6/50 = 0.12 (exact, 0.000%)")
    print("  G20 (H_0 emergent)          -- CLOSED (Session 258, _matter_density_closures.py): H_0 = 100*sqrt((Ob+ODM)*h^2/Om) = 67.12 km/s/Mpc (0.42% vs Planck); NOT a 4th anchor")
    print("  G21 (t_0 * H_0 and t_0)     -- CLOSED (Session 258, _matter_density_closures.py): t_0*H_0 = 1 - F_TRZ*(F_TRZ+Phi)/2 (0.07%); t_0=13.89 Gyr (0.66%)")
    print()
    print("ALL 21 LAGRANGIAN/COSMOLOGICAL/HUBBLE GAPS CLOSED (Sessions 246-258).")
    print("Cumulative reduction: 13+ originally free numerical inputs reduced to")
    ...
    print("H_0 is EMERGENT (not anchored): the 3 SI anchors {E_0, f_THz, v_F}")
    print("plus the structural primitives derive H_0 = 67.12 km/s/Mpc directly,")
    print("naturally on the CMB/Planck side of the H_0 tension.")
