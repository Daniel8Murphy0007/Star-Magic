"""
_append_cp4_244.py  —  Session 172
Appends CP4 entry #244: WhiteHoleRadiationUQFFCalculator
Paper: PAPER_660
...
DIVIDER = (
    "\n\n# " + "=" * 74 + "\n"
    "# CP4 #244 \x97 WhiteHoleRadiationUQFFCalculator\n"
...
def main():
    ...
    with open(CP4, "ab") as f:
        f.write(encoded)
    print(f"CP4 #244 appended: WhiteHoleRadiationUQFFCalculator")
    # Verify
    with open(CP4, "rb") as f:
        tail = f.read()[-800:]
    if b"WhiteHoleRadiationUQFFCalculator" in tail:
