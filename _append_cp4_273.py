"""
CP4 Appender for PAPER_689 â€” AGNJetDynamicsBlandfordZnajek (CP4 #273)
...
def _append():
    ...
    with open(CP4, "r", encoding="latin-1") as f:
        content = f.read()
    marker = "class AGNJetDynamicsBlandfordZnajek"
    if marker in content:
        print(f"SKIP: AGNJetDynamicsBlandfordZnajek already present in CondensedPhysics4.py")
        return
    with open(CP4, "a", encoding="utf-8") as f:
        f.write(ENTRY)
    print(f"OK: Appended AGNJetDynamicsBlandfordZnajek (PAPER_689, CP4 #273)")
