...
std::string MUGEModule::getEquationText_compressed() {
    ...
    return "Compressed MUGE for " + sys_name + ":\n"
           ...
           "2 A cos(k x) cos(ω t) + (2π/13.8) A Re[exp(i (k x - ω t))] + (M_vis + M_DM) (δρ/ρ + 3 G M / r^3) + SysTerm\n"
           "SysTerm: e.g., for Magnetar: G M_BH / r_BH^2; for Sgr A*: (G M^2 / c^4 r) (dΩ/dt)^2 sin(30); for Starbirth: ρ v_wind^2\n"
