...
────────────────────────────────────────────────────────────────────────────────
Session 218 (original) + Session 220 upgrade combined:
...
GAMMA_SWEEP    = [0.01, 0.05, 0.10, 0.30, 0.50, 1.0, 5.0, 10.0]  # THz (Session 220, 8-point)
GAMMA_SWEEP_V0 = [0.01, 0.05, 0.1, 0.5, 1.0, 5.0, 10.0]  # THz (Session 218, 7-point)
...
def _run_tests() -> bool:
    ...
    print(f"\n{'='*60}")
    print(f"  99system_wstp_gamma.py (Session 218+220): {passed}/8 tests passed")
    print(f"{'='*60}")
    return ok
