"""Session 275 raw derivative-function dump.

For every entry in _PA_S275_CLOSURE_REGISTRY whose form() is a real callable
(not None), print the verbatim form() source line and the actual numeric value.
"""
...
def main() -> None:
    ...
    print(f"Session 275 transcribed lambdas: {len(transcribed)} / {len(reg)} entries")
