...
Unique physics: stellar wind feedback rho_wind*v_wind^2/rho_fluid,
                M_dot_factor=gas_mass/M_initial, SFR mass growth M(t).

Run:  python gen_muge_tapestry.py
Output: StarbirthTapestry.h
"""
import os

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "StarbirthTapestry.h")
...
def main():
    print("gen_muge_tapestry.py — Generating StarbirthTapestry.h ...")
    content = get_content()
