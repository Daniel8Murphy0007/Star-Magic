"""
_append_cp4_255.py  —  Session 172
Appends CP4 entry #255: UQFFDMDtDerivationCalculator
Paper: PAPER_671
...
DIVIDER = (
    "\n\n# " + "=" * 74 + "\n"
    "# CP4 #255 \x97 UQFFDMDtDerivationCalculator\n"
...
def main():
    ...
    with open(CP4, "ab") as f:
        f.write(encoded)
    print(f"CP4 #255 appended: UQFFDMDtDerivationCalculator")
    # Verify
    with open(CP4, "rb") as f:
        tail = f.read()[-800:]
    if b"UQFFDMDtDerivationCalculator" in tail:
